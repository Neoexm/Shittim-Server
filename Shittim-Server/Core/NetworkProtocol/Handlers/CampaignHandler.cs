...
public class CampaignHandler : ProtocolHandlerBase
{
        ...
        CampaignRetreatResponse response)
    {
        ...
        // Retreating ends the run. Leaving the save open would have ContentSave_Get keep offering it back - the client treats anything it gets from there as a mission still in progress.
