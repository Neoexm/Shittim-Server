...
namespace BlueArchiveAPI.Services
{
    public class ResourceService
    {
        ...
        public static async Task LoadResources()
        {
            ...
            if (File.Exists(versionTxtPath) && File.ReadAllText(versionTxtPath) == Config.Instance.ServerConfiguration.VersionId)
            {
                Console.WriteLine("Resources are already up to date.");
                return;
            }

            Console.WriteLine("Resources version mismatch, downloading...");
