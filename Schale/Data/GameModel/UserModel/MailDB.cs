...
namespace Schale.Data.GameModel
{
    ...
    public static class MailDBServerExtensions
    {
        ...
        /// <summary>
        /// The mailbox as the client sees it: unclaimed and not past its expiry.
        /// Official's Mail_Check count and Mail_List contents both cover exactly this set - the count drops to 0 (omitted) and MailDBs disappears once the mail is claimed.
        /// </summary>
