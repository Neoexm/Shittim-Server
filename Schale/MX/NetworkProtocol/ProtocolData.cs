...
namespace Schale.MX.NetworkProtocol
{
    public enum Protocol : int
    {
        ...
        Cafe_PresetDetail = 20021,
        Cafe_UpdateCopyPresetFurniture = 20022,
        Craft_List = 21000,
        ...
        Craft_SavePreset = 21015,
        Craft_SavePresetName = 21016,
        ...
        EventContent_ConcentrationGetInfo = 30047,
        EventContent_ConcentrationFlipCard = 30048,
        EventContent_ConcentrationRoundComplete = 30049,
        EventContent_ConcentrationRoundSkip = 30050,
        EventContent_ClueSearchGetInfo = 30051,
        EventContent_ClueSearchSubmit = 30052,
        EventContent_ClueSearchRoundComplete = 30053,
        TTS_GetFile = 31000,
        TTS_GetKana = 31001,
        ...
        WorldRaid_UpdateCarrierSkill = 40005,
        ...
        DailyRecord_Reward = 52000,
        Option_Save = 53000,
        PermanentRaid_Lobby = 54000,
        PermanentRaid_EnterBattle = 54001,
        PermanentRaid_EndBattle = 54002,
        PermanentRaid_GiveUp = 54003,
    }
    ...
    public enum WebAPIErrorCode : int
    {
        ...
        EventContentConcentrationRequestSameIndex = 36019,
        EventContentConcentrationAlreadyMatchedIndex = 36020,
        EventContentConcentrationCannotCompleteRound = 36021,
        EventContentConcentrationCannotSkipRound = 36022,
        EventContentClueSearchCannotSubmit = 36023,
        EventContentClueSearchCannotCompleteRound = 36024,
        ...
        PermanentRaidNotOpen = 52000,
        PermanentRaidDataNotFound = 52001,
    }
