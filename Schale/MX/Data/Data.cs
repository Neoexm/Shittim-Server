...
namespace Schale.MX.Data
{
    public class AttendanceBookReward
    {
        ...
        // Official emits this on every book (1 on the basic book, 3 on the Event20Days book); the generated AttendanceExcel model has no such column, so it is inferred from Type.
