...
public struct ConquestGroupBuffExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.ConquestGroupBuffExcel> CreateConquestGroupBuffExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.ConquestGroupBuffExcel> EndConquestGroupBuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ConquestGroupBuffExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ConquestGroupBuffExcel> Pack(FlatBufferBuilder builder, ConquestGroupBuffExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ConquestGroupBuffExcel>);
