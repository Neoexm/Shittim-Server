...
public struct FieldKeywordExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.FieldKeywordExcel> CreateFieldKeywordExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long SeasonId = 0,
  ...
  public static Offset<Schale.FlatData.FieldKeywordExcel> EndFieldKeywordExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.FieldKeywordExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.FieldKeywordExcel> Pack(FlatBufferBuilder builder, FieldKeywordExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.FieldKeywordExcel>);
