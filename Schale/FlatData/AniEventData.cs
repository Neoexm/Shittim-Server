...
public struct AniEventData : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.AniEventData> CreateAniEventData(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.AniEventData> EndAniEventData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.AniEventData>(o);
  }
  ...
  public static Offset<Schale.FlatData.AniEventData> Pack(FlatBufferBuilder builder, AniEventDataT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.AniEventData>);
