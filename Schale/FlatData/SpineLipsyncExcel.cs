...
public struct SpineLipsyncExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.SpineLipsyncExcel> EndSpineLipsyncExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.SpineLipsyncExcel>(o);
  }
