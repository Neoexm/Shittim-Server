...
public struct EventContentBoxGachaElementExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.EventContentBoxGachaElementExcel> CreateEventContentBoxGachaElementExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.EventContentBoxGachaElementExcel> EndEventContentBoxGachaElementExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentBoxGachaElementExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.EventContentBoxGachaElementExcel> Pack(FlatBufferBuilder builder, EventContentBoxGachaElementExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EventContentBoxGachaElementExcel>);
