...
public struct AcademyTicketExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.AcademyTicketExcel> CreateAcademyTicketExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.AcademyTicketExcel> EndAcademyTicketExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.AcademyTicketExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.AcademyTicketExcel> Pack(FlatBufferBuilder builder, AcademyTicketExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.AcademyTicketExcel>);
