...
public struct CombatEmojiExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.EmojiEvent EmojiEvent { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.EmojiEvent)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.EmojiEvent.EnterConver; } }
  ...
  public static Offset<Schale.FlatData.CombatEmojiExcel> CreateCombatEmojiExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      Schale.FlatData.EmojiEvent EmojiEvent = Schale.FlatData.EmojiEvent.EnterConver,
  ...
  public static void AddEmojiEvent(FlatBufferBuilder builder, Schale.FlatData.EmojiEvent emojiEvent) { builder.AddInt(1, (int)emojiEvent, 0); }
  ...
  public static Offset<Schale.FlatData.CombatEmojiExcel> EndCombatEmojiExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CombatEmojiExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.CombatEmojiExcel> Pack(FlatBufferBuilder builder, CombatEmojiExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.CombatEmojiExcel>);
...
public class CombatEmojiExcelT
{
  ...
  public Schale.FlatData.EmojiEvent EmojiEvent { get; set; }
  ...
  public CombatEmojiExcelT() {
    this.UniqueId = 0;
    this.EmojiEvent = Schale.FlatData.EmojiEvent.EnterConver;
...
static public class CombatEmojiExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*EmojiEvent*/, 4 /*Schale.FlatData.EmojiEvent*/, 4, false)
