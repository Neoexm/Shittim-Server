...
public struct CafeInteractionExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.BubbleType BubbleType(int j) { int o = __p.__offset(12); return o != 0 ? (Schale.FlatData.BubbleType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.BubbleType)0; }
  public int BubbleTypeLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.BubbleType> GetBubbleTypeBytes() { return __p.__vector_as_span<Schale.FlatData.BubbleType>(12, 4); }
#else
  public ArraySegment<byte>? GetBubbleTypeBytes() { return __p.__vector_as_arraysegment(12); }
#endif
  public Schale.FlatData.BubbleType[] GetBubbleTypeArray() { int o = __p.__offset(12); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.BubbleType[] a = new Schale.FlatData.BubbleType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.BubbleType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Schale.FlatData.ParcelType FavorEmoticonRewardParcelType { get { int o = __p.__offset(16); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.CafeInteractionExcel> CreateCafeInteractionExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
      ...
      Schale.FlatData.ParcelType FavorEmoticonRewardParcelType = Schale.FlatData.ParcelType.None,
  ...
  public static VectorOffset CreateBubbleTypeVector(FlatBufferBuilder builder, Schale.FlatData.BubbleType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateBubbleTypeVectorBlock(FlatBufferBuilder builder, Schale.FlatData.BubbleType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateBubbleTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.BubbleType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateBubbleTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.BubbleType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddFavorEmoticonRewardParcelType(FlatBufferBuilder builder, Schale.FlatData.ParcelType favorEmoticonRewardParcelType) { builder.AddInt(6, (int)favorEmoticonRewardParcelType, 0); }
  ...
  public static Offset<Schale.FlatData.CafeInteractionExcel> EndCafeInteractionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CafeInteractionExcel>(o);
  }
  ...
  public void UnPackTo(CafeInteractionExcelT _o) {
    ...
    _o.BubbleType = new List<Schale.FlatData.BubbleType>();
  ...
  public static Offset<Schale.FlatData.CafeInteractionExcel> Pack(FlatBufferBuilder builder, CafeInteractionExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.CafeInteractionExcel>);
...
public class CafeInteractionExcelT
{
  ...
  public List<Schale.FlatData.BubbleType> BubbleType { get; set; }
  public List<long> BubbleDuration { get; set; }
  public Schale.FlatData.ParcelType FavorEmoticonRewardParcelType { get; set; }
  ...
  public CafeInteractionExcelT() {
    ...
    this.FavorEmoticonRewardParcelType = Schale.FlatData.ParcelType.None;
...
static public class CafeInteractionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 12 /*BubbleType*/, 4 /*Schale.FlatData.BubbleType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 14 /*BubbleDuration*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 16 /*FavorEmoticonRewardParcelType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
