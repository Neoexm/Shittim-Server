...
public struct RaidRankingRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.RaidRankingRewardExcel> CreateRaidRankingRewardExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.RaidRankingRewardExcel> EndRaidRankingRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.RaidRankingRewardExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.RaidRankingRewardExcel> Pack(FlatBufferBuilder builder, RaidRankingRewardExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.RaidRankingRewardExcel>);
...
static public class RaidRankingRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 38 /*RewardParcelAmount*/, 8 /*long*/, false)
