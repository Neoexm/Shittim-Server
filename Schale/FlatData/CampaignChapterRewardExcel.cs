...
public struct CampaignChapterRewardExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ParcelType ChapterRewardParcelType(int j) { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.ParcelType)0; }
  public int ChapterRewardParcelTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.ParcelType> GetChapterRewardParcelTypeBytes() { return __p.__vector_as_span<Schale.FlatData.ParcelType>(8, 4); }
#else
  public ArraySegment<byte>? GetChapterRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public Schale.FlatData.ParcelType[] GetChapterRewardParcelTypeArray() { int o = __p.__offset(8); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.ParcelType[] a = new Schale.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.CampaignChapterRewardExcel> CreateCampaignChapterRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static VectorOffset CreateChapterRewardParcelTypeVector(FlatBufferBuilder builder, Schale.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateChapterRewardParcelTypeVectorBlock(FlatBufferBuilder builder, Schale.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateChapterRewardParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateChapterRewardParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Schale.FlatData.CampaignChapterRewardExcel> EndCampaignChapterRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CampaignChapterRewardExcel>(o);
  }
  ...
  public void UnPackTo(CampaignChapterRewardExcelT _o) {
    ...
    _o.ChapterRewardParcelType = new List<Schale.FlatData.ParcelType>();
  ...
  public static Offset<Schale.FlatData.CampaignChapterRewardExcel> Pack(FlatBufferBuilder builder, CampaignChapterRewardExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.CampaignChapterRewardExcel>);
...
public class CampaignChapterRewardExcelT
{
  ...
  public List<Schale.FlatData.ParcelType> ChapterRewardParcelType { get; set; }
...
static public class CampaignChapterRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 8 /*ChapterRewardParcelType*/, 4 /*Schale.FlatData.ParcelType*/, false)
