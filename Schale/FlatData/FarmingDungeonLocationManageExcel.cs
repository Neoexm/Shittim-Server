...
public struct FarmingDungeonLocationManageExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.WeekDungeonType WeekDungeonType { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.WeekDungeonType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.WeekDungeonType.None; } }
  public Schale.FlatData.SchoolDungeonType SchoolDungeonType { get { int o = __p.__offset(10); return o != 0 ? (Schale.FlatData.SchoolDungeonType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.SchoolDungeonType.SchoolA; } }
  ...
  public static Offset<Schale.FlatData.FarmingDungeonLocationManageExcel> CreateFarmingDungeonLocationManageExcel(FlatBufferBuilder builder,
      ...
      Schale.FlatData.SchoolDungeonType SchoolDungeonType = Schale.FlatData.SchoolDungeonType.SchoolA,
      long Order = 0,
  ...
  public static void AddWeekDungeonType(FlatBufferBuilder builder, Schale.FlatData.WeekDungeonType weekDungeonType) { builder.AddInt(2, (int)weekDungeonType, 0); }
  public static void AddSchoolDungeonType(FlatBufferBuilder builder, Schale.FlatData.SchoolDungeonType schoolDungeonType) { builder.AddInt(3, (int)schoolDungeonType, 0); }
  ...
  public static Offset<Schale.FlatData.FarmingDungeonLocationManageExcel> EndFarmingDungeonLocationManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.FarmingDungeonLocationManageExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.FarmingDungeonLocationManageExcel> Pack(FlatBufferBuilder builder, FarmingDungeonLocationManageExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.FarmingDungeonLocationManageExcel>);
...
public class FarmingDungeonLocationManageExcelT
{
  ...
  public Schale.FlatData.SchoolDungeonType SchoolDungeonType { get; set; }
  ...
  public FarmingDungeonLocationManageExcelT() {
    ...
    this.SchoolDungeonType = Schale.FlatData.SchoolDungeonType.SchoolA;
    this.Order = 0;
...
static public class FarmingDungeonLocationManageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*WeekDungeonType*/, 4 /*Schale.FlatData.WeekDungeonType*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*SchoolDungeonType*/, 4 /*Schale.FlatData.SchoolDungeonType*/, 4, false)
