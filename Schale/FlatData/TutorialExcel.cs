...
public struct TutorialExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.TutorialExcel> CreateTutorialExcel(FlatBufferBuilder builder,
      long ID = 0,
  ...
  public static Offset<Schale.FlatData.TutorialExcel> EndTutorialExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.TutorialExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.TutorialExcel> Pack(FlatBufferBuilder builder, TutorialExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.TutorialExcel>);
