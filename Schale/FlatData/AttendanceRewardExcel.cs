...
public struct AttendanceRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.AttendanceRewardExcel> CreateAttendanceRewardExcel(FlatBufferBuilder builder,
      long AttendanceId = 0,
      long Day = 0,
  ...
  public static Offset<Schale.FlatData.AttendanceRewardExcel> EndAttendanceRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.AttendanceRewardExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.AttendanceRewardExcel> Pack(FlatBufferBuilder builder, AttendanceRewardExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.AttendanceRewardExcel>);
