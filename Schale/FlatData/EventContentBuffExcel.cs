...
public struct EventContentBuffExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.Tag CharacterTag { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.Tag)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.Tag.A; } }
  public Schale.FlatData.EventContentBuffFindRule EnumType { get { int o = __p.__offset(10); return o != 0 ? (Schale.FlatData.EventContentBuffFindRule)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.EventContentBuffFindRule.None; } }
  ...
  public static Offset<Schale.FlatData.EventContentBuffExcel> CreateEventContentBuffExcel(FlatBufferBuilder builder,
  ...
  public static void AddCharacterTag(FlatBufferBuilder builder, Schale.FlatData.Tag characterTag) { builder.AddInt(2, (int)characterTag, 0); }
  public static void AddEnumType(FlatBufferBuilder builder, Schale.FlatData.EventContentBuffFindRule enumType) { builder.AddInt(3, (int)enumType, 0); }
  ...
  public static Offset<Schale.FlatData.EventContentBuffExcel> EndEventContentBuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentBuffExcel>(o);
  }
...
public class EventContentBuffExcelT
{
  ...
  public Schale.FlatData.Tag CharacterTag { get; set; }
  public Schale.FlatData.EventContentBuffFindRule EnumType { get; set; }
  ...
  public EventContentBuffExcelT() {
    ...
    this.IsBuff = false;
    this.CharacterTag = Schale.FlatData.Tag.A;
    this.EnumType = Schale.FlatData.EventContentBuffFindRule.None;
...
static public class EventContentBuffExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CharacterTag*/, 4 /*Schale.FlatData.Tag*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*EnumType*/, 4 /*Schale.FlatData.EventContentBuffFindRule*/, 4, false)
