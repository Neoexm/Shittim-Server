...
public struct MiniGameDreamReplayScenarioExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.MiniGameDreamReplayScenarioExcel> CreateMiniGameDreamReplayScenarioExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.MiniGameDreamReplayScenarioExcel> EndMiniGameDreamReplayScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MiniGameDreamReplayScenarioExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MiniGameDreamReplayScenarioExcel> Pack(FlatBufferBuilder builder, MiniGameDreamReplayScenarioExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MiniGameDreamReplayScenarioExcel>);
