...
public struct EventContentShopExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ShopCategoryType CategoryType { get { int o = __p.__offset(10); return o != 0 ? (Schale.FlatData.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ShopCategoryType.General; } }
  ...
  public static Offset<Schale.FlatData.EventContentShopExcel> CreateEventContentShopExcel(FlatBufferBuilder builder,
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, Schale.FlatData.ShopCategoryType categoryType) { builder.AddInt(3, (int)categoryType, 0); }
  ...
  public static Offset<Schale.FlatData.EventContentShopExcel> EndEventContentShopExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentShopExcel>(o);
  }
...
static public class EventContentShopExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*CategoryType*/, 4 /*Schale.FlatData.ShopCategoryType*/, 4, false)
