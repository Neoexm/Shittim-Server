...
public struct EventContentMissionExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.MissionCompleteConditionType CompleteConditionType { get { int o = __p.__offset(36); return o != 0 ? (Schale.FlatData.MissionCompleteConditionType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.MissionCompleteConditionType.None; } }
  ...
  public Schale.FlatData.Tag CompleteConditionParameterTag(int j) { int o = __p.__offset(44); return o != 0 ? (Schale.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.Tag)0; }
  public int CompleteConditionParameterTagLength { get { int o = __p.__offset(44); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.Tag> GetCompleteConditionParameterTagBytes() { return __p.__vector_as_span<Schale.FlatData.Tag>(44, 4); }
#else
  public ArraySegment<byte>? GetCompleteConditionParameterTagBytes() { return __p.__vector_as_arraysegment(44); }
#endif
  public Schale.FlatData.Tag[] GetCompleteConditionParameterTagArray() { int o = __p.__offset(44); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.Tag[] a = new Schale.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Schale.FlatData.ParcelType MissionRewardParcelType(int j) { int o = __p.__offset(52); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.ParcelType)0; }
  public int MissionRewardParcelTypeLength { get { int o = __p.__offset(52); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.ParcelType> GetMissionRewardParcelTypeBytes() { return __p.__vector_as_span<Schale.FlatData.ParcelType>(52, 4); }
#else
  public ArraySegment<byte>? GetMissionRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(52); }
#endif
  public Schale.FlatData.ParcelType[] GetMissionRewardParcelTypeArray() { int o = __p.__offset(52); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.ParcelType[] a = new Schale.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Schale.FlatData.ParcelType ConditionRewardParcelType(int j) { int o = __p.__offset(58); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.ParcelType)0; }
  public int ConditionRewardParcelTypeLength { get { int o = __p.__offset(58); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.ParcelType> GetConditionRewardParcelTypeBytes() { return __p.__vector_as_span<Schale.FlatData.ParcelType>(58, 4); }
#else
  public ArraySegment<byte>? GetConditionRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(58); }
#endif
  public Schale.FlatData.ParcelType[] GetConditionRewardParcelTypeArray() { int o = __p.__offset(58); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.ParcelType[] a = new Schale.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.EventContentMissionExcel> CreateEventContentMissionExcel(FlatBufferBuilder builder,
      long Id = 0,
    ...
    EventContentMissionExcel.AddTargetGroup(builder, TargetGroup);
  ...
  public static void AddCompleteConditionType(FlatBufferBuilder builder, Schale.FlatData.MissionCompleteConditionType completeConditionType) { builder.AddInt(16, (int)completeConditionType, 0); }
  ...
  public static Offset<Schale.FlatData.EventContentMissionExcel> EndEventContentMissionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentMissionExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.EventContentMissionExcel> Pack(FlatBufferBuilder builder, EventContentMissionExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EventContentMissionExcel>);
...
static public class EventContentMissionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 36 /*CompleteConditionType*/, 4 /*Schale.FlatData.MissionCompleteConditionType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 44 /*CompleteConditionParameterTag*/, 4 /*Schale.FlatData.Tag*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 52 /*MissionRewardParcelType*/, 4 /*Schale.FlatData.ParcelType*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 58 /*ConditionRewardParcelType*/, 4 /*Schale.FlatData.ParcelType*/, false)
