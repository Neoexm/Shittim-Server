...
public struct PersonalityExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.PersonalityExcel> CreatePersonalityExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Schale.FlatData.PersonalityExcel> EndPersonalityExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.PersonalityExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.PersonalityExcel> Pack(FlatBufferBuilder builder, PersonalityExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.PersonalityExcel>);
