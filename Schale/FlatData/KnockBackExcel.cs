...
public struct KnockBackExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.KnockBackExcel> CreateKnockBackExcel(FlatBufferBuilder builder,
      long Index = 0,
      float Dist = 0.0f,
      float Speed = 0.0f) {
  ...
  public static Offset<Schale.FlatData.KnockBackExcel> EndKnockBackExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.KnockBackExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.KnockBackExcel> Pack(FlatBufferBuilder builder, KnockBackExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.KnockBackExcel>);
