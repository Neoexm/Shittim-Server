...
public struct InformationStrategyObjectExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.InformationStrategyObjectExcel> CreateInformationStrategyObjectExcel(FlatBufferBuilder builder,
      long Id = 0,
      long StageId = 0,
  ...
  public static Offset<Schale.FlatData.InformationStrategyObjectExcel> EndInformationStrategyObjectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.InformationStrategyObjectExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.InformationStrategyObjectExcel> Pack(FlatBufferBuilder builder, InformationStrategyObjectExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.InformationStrategyObjectExcel>);
