...
public struct ClearDeckRuleExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.ClearDeckRuleExcel> CreateClearDeckRuleExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.ClearDeckRuleExcel> EndClearDeckRuleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ClearDeckRuleExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ClearDeckRuleExcel> Pack(FlatBufferBuilder builder, ClearDeckRuleExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ClearDeckRuleExcel>);
