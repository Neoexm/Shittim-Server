...
public struct ConstAudioExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.ConstAudioExcel> CreateConstAudioExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.ConstAudioExcel> EndConstAudioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ConstAudioExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ConstAudioExcel> Pack(FlatBufferBuilder builder, ConstAudioExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ConstAudioExcel>);
