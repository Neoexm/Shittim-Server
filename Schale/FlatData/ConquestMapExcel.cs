...
public struct ConquestMapExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.StageDifficulty MapDifficulty { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.StageDifficulty)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.StageDifficulty.None; } }
  ...
  public Schale.FlatData.ConquestConditionType StepOpenConditionType(int j) { int o = __p.__offset(16); return o != 0 ? (Schale.FlatData.ConquestConditionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.ConquestConditionType)0; }
  public int StepOpenConditionTypeLength { get { int o = __p.__offset(16); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.ConquestConditionType> GetStepOpenConditionTypeBytes() { return __p.__vector_as_span<Schale.FlatData.ConquestConditionType>(16, 4); }
#else
  ...
  public static Offset<Schale.FlatData.ConquestMapExcel> CreateConquestMapExcel(FlatBufferBuilder builder,
  ...
  public static void AddMapDifficulty(FlatBufferBuilder builder, Schale.FlatData.StageDifficulty mapDifficulty) { builder.AddInt(2, (int)mapDifficulty, 0); }
  ...
  public static VectorOffset CreateStepOpenConditionTypeVector(FlatBufferBuilder builder, Schale.FlatData.ConquestConditionType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateStepOpenConditionTypeVectorBlock(FlatBufferBuilder builder, Schale.FlatData.ConquestConditionType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStepOpenConditionTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.ConquestConditionType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStepOpenConditionTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.ConquestConditionType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Schale.FlatData.ConquestMapExcel> EndConquestMapExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ConquestMapExcel>(o);
  }
  ...
  public void UnPackTo(ConquestMapExcelT _o) {
    ...
    _o.StepOpenConditionType = new List<Schale.FlatData.ConquestConditionType>();
  ...
  public static Offset<Schale.FlatData.ConquestMapExcel> Pack(FlatBufferBuilder builder, ConquestMapExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ConquestMapExcel>);
...
public class ConquestMapExcelT
{
  ...
  public List<Schale.FlatData.ConquestConditionType> StepOpenConditionType { get; set; }
...
static public class ConquestMapExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*MapDifficulty*/, 4 /*Schale.FlatData.StageDifficulty*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 16 /*StepOpenConditionType*/, 4 /*Schale.FlatData.ConquestConditionType*/, false)
