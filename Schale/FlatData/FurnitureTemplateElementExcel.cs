...
public struct FurnitureTemplateElementExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.FurnitureLocation Location { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.FurnitureLocation)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.FurnitureLocation.None; } }
  ...
  public static Offset<Schale.FlatData.FurnitureTemplateElementExcel> CreateFurnitureTemplateElementExcel(FlatBufferBuilder builder,
  ...
  public static void AddLocation(FlatBufferBuilder builder, Schale.FlatData.FurnitureLocation location) { builder.AddInt(2, (int)location, 0); }
  ...
  public static Offset<Schale.FlatData.FurnitureTemplateElementExcel> EndFurnitureTemplateElementExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.FurnitureTemplateElementExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.FurnitureTemplateElementExcel> Pack(FlatBufferBuilder builder, FurnitureTemplateElementExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.FurnitureTemplateElementExcel>);
...
static public class FurnitureTemplateElementExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*Location*/, 4 /*Schale.FlatData.FurnitureLocation*/, 4, false)
