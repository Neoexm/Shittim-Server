...
public struct EventContentTreasureRoundExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.EventContentTreasureRoundExcel> CreateEventContentTreasureRoundExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.EventContentTreasureRoundExcel> EndEventContentTreasureRoundExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentTreasureRoundExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.EventContentTreasureRoundExcel> Pack(FlatBufferBuilder builder, EventContentTreasureRoundExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EventContentTreasureRoundExcel>);
