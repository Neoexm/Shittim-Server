...
public struct TacticTimeAttackSimulatorConfigExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.TacticTimeAttackSimulatorConfigExcel> CreateTacticTimeAttackSimulatorConfigExcel(FlatBufferBuilder builder,
      long Order = 0,
      long Repeat = 0,
  ...
  public static Offset<Schale.FlatData.TacticTimeAttackSimulatorConfigExcel> EndTacticTimeAttackSimulatorConfigExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.TacticTimeAttackSimulatorConfigExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.TacticTimeAttackSimulatorConfigExcel> Pack(FlatBufferBuilder builder, TacticTimeAttackSimulatorConfigExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.TacticTimeAttackSimulatorConfigExcel>);
