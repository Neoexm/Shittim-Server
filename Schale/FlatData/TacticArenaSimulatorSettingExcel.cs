...
public struct TacticArenaSimulatorSettingExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ArenaSimulatorServer AttackerFrom { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.ArenaSimulatorServer)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ArenaSimulatorServer.Preset; } }
  ...
  public Schale.FlatData.ArenaSimulatorServer DefenderFrom { get { int o = __p.__offset(20); return o != 0 ? (Schale.FlatData.ArenaSimulatorServer)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ArenaSimulatorServer.Preset; } }
  ...
  public static Offset<Schale.FlatData.TacticArenaSimulatorSettingExcel> CreateTacticArenaSimulatorSettingExcel(FlatBufferBuilder builder,
      long Order = 0,
      long Repeat = 0,
      Schale.FlatData.ArenaSimulatorServer AttackerFrom = Schale.FlatData.ArenaSimulatorServer.Preset,
      ...
      Schale.FlatData.ArenaSimulatorServer DefenderFrom = Schale.FlatData.ArenaSimulatorServer.Preset,
  ...
  public static void AddAttackerFrom(FlatBufferBuilder builder, Schale.FlatData.ArenaSimulatorServer attackerFrom) { builder.AddInt(2, (int)attackerFrom, 0); }
  ...
  public static void AddDefenderFrom(FlatBufferBuilder builder, Schale.FlatData.ArenaSimulatorServer defenderFrom) { builder.AddInt(8, (int)defenderFrom, 0); }
  ...
  public static Offset<Schale.FlatData.TacticArenaSimulatorSettingExcel> EndTacticArenaSimulatorSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.TacticArenaSimulatorSettingExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.TacticArenaSimulatorSettingExcel> Pack(FlatBufferBuilder builder, TacticArenaSimulatorSettingExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.TacticArenaSimulatorSettingExcel>);
...
public class TacticArenaSimulatorSettingExcelT
{
  ...
  public Schale.FlatData.ArenaSimulatorServer AttackerFrom { get; set; }
  ...
  public Schale.FlatData.ArenaSimulatorServer DefenderFrom { get; set; }
  ...
  public TacticArenaSimulatorSettingExcelT() {
    this.Order = 0;
    this.Repeat = 0;
    this.AttackerFrom = Schale.FlatData.ArenaSimulatorServer.Preset;
    ...
    this.DefenderFrom = Schale.FlatData.ArenaSimulatorServer.Preset;
...
static public class TacticArenaSimulatorSettingExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*AttackerFrom*/, 4 /*Schale.FlatData.ArenaSimulatorServer*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 20 /*DefenderFrom*/, 4 /*Schale.FlatData.ArenaSimulatorServer*/, 4, false)
