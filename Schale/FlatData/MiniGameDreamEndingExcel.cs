...
public struct MiniGameDreamEndingExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.DreamMakerEndingType DreamMakerEndingType { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.DreamMakerEndingType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.DreamMakerEndingType.None; } }
  ...
  public Schale.FlatData.DreamMakerEndingCondition EndingCondition(int j) { int o = __p.__offset(14); return o != 0 ? (Schale.FlatData.DreamMakerEndingCondition)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.DreamMakerEndingCondition)0; }
  public int EndingConditionLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.DreamMakerEndingCondition> GetEndingConditionBytes() { return __p.__vector_as_span<Schale.FlatData.DreamMakerEndingCondition>(14, 4); }
#else
  public ArraySegment<byte>? GetEndingConditionBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public Schale.FlatData.DreamMakerEndingCondition[] GetEndingConditionArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.DreamMakerEndingCondition[] a = new Schale.FlatData.DreamMakerEndingCondition[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.DreamMakerEndingCondition)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.MiniGameDreamEndingExcel> CreateMiniGameDreamEndingExcel(FlatBufferBuilder builder,
  ...
  public static void AddDreamMakerEndingType(FlatBufferBuilder builder, Schale.FlatData.DreamMakerEndingType dreamMakerEndingType) { builder.AddInt(2, (int)dreamMakerEndingType, 0); }
  ...
  public static VectorOffset CreateEndingConditionVector(FlatBufferBuilder builder, Schale.FlatData.DreamMakerEndingCondition[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateEndingConditionVectorBlock(FlatBufferBuilder builder, Schale.FlatData.DreamMakerEndingCondition[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEndingConditionVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.DreamMakerEndingCondition> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEndingConditionVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.DreamMakerEndingCondition>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Schale.FlatData.MiniGameDreamEndingExcel> EndMiniGameDreamEndingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MiniGameDreamEndingExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameDreamEndingExcelT _o) {
    ...
    _o.EndingCondition = new List<Schale.FlatData.DreamMakerEndingCondition>();
  ...
  public static Offset<Schale.FlatData.MiniGameDreamEndingExcel> Pack(FlatBufferBuilder builder, MiniGameDreamEndingExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MiniGameDreamEndingExcel>);
...
public class MiniGameDreamEndingExcelT
{
  ...
  public List<Schale.FlatData.DreamMakerEndingCondition> EndingCondition { get; set; }
...
static public class MiniGameDreamEndingExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*DreamMakerEndingType*/, 4 /*Schale.FlatData.DreamMakerEndingType*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*Order*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*ScenarioGroupId*/, 8 /*long*/, 8, false)
      && verifier.VerifyVectorOfData(tablePos, 14 /*EndingCondition*/, 4 /*Schale.FlatData.DreamMakerEndingCondition*/, false)
