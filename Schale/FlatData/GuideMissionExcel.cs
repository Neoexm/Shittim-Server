...
public struct GuideMissionExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.MissionCompleteConditionType CompleteConditionType { get { int o = __p.__offset(24); return o != 0 ? (Schale.FlatData.MissionCompleteConditionType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.MissionCompleteConditionType.None; } }
  ...
  public Schale.FlatData.Tag CompleteConditionParameterTag(int j) { int o = __p.__offset(30); return o != 0 ? (Schale.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.Tag)0; }
  public int CompleteConditionParameterTagLength { get { int o = __p.__offset(30); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.Tag> GetCompleteConditionParameterTagBytes() { return __p.__vector_as_span<Schale.FlatData.Tag>(30, 4); }
#else
  public ArraySegment<byte>? GetCompleteConditionParameterTagBytes() { return __p.__vector_as_arraysegment(30); }
#endif
  public Schale.FlatData.Tag[] GetCompleteConditionParameterTagArray() { int o = __p.__offset(30); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.Tag[] a = new Schale.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  public bool IsAutoClearForScenario { get { int o = __p.__offset(32); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  public Schale.FlatData.ParcelType MissionRewardParcelType(int j) { int o = __p.__offset(34); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.ParcelType)0; }
  public int MissionRewardParcelTypeLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.ParcelType> GetMissionRewardParcelTypeBytes() { return __p.__vector_as_span<Schale.FlatData.ParcelType>(34, 4); }
#else
  public ArraySegment<byte>? GetMissionRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public Schale.FlatData.ParcelType[] GetMissionRewardParcelTypeArray() { int o = __p.__offset(34); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.ParcelType[] a = new Schale.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.GuideMissionExcel> CreateGuideMissionExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
      long Id = 0,
  ...
  public static void AddCompleteConditionType(FlatBufferBuilder builder, Schale.FlatData.MissionCompleteConditionType completeConditionType) { builder.AddInt(10, (int)completeConditionType, 0); }
  ...
  public static Offset<Schale.FlatData.GuideMissionExcel> EndGuideMissionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.GuideMissionExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.GuideMissionExcel> Pack(FlatBufferBuilder builder, GuideMissionExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.GuideMissionExcel>);
...
static public class GuideMissionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 24 /*CompleteConditionType*/, 4 /*Schale.FlatData.MissionCompleteConditionType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 30 /*CompleteConditionParameterTag*/, 4 /*Schale.FlatData.Tag*/, false)
      && verifier.VerifyField(tablePos, 32 /*IsAutoClearForScenario*/, 1 /*bool*/, 1, false)
      && verifier.VerifyVectorOfData(tablePos, 34 /*MissionRewardParcelType*/, 4 /*Schale.FlatData.ParcelType*/, false)
