...
public struct ConstFieldExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.ConstFieldExcel> CreateConstFieldExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.ConstFieldExcel> EndConstFieldExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ConstFieldExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ConstFieldExcel> Pack(FlatBufferBuilder builder, ConstFieldExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ConstFieldExcel>);
