...
public struct EventContentShopRefreshExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ShopCategoryType CategoryType { get { int o = __p.__offset(16); return o != 0 ? (Schale.FlatData.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ShopCategoryType.General; } }
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, Schale.FlatData.ShopCategoryType categoryType) { builder.AddInt(6, (int)categoryType, 0); }
...
static public class EventContentShopRefreshExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*CategoryType*/, 4 /*Schale.FlatData.ShopCategoryType*/, 4, false)
