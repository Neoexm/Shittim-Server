...
public struct VoiceSpineExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.VoiceSpineExcel> CreateVoiceSpineExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      uint Id = 0,
  ...
  public static Offset<Schale.FlatData.VoiceSpineExcel> EndVoiceSpineExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.VoiceSpineExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.VoiceSpineExcel> Pack(FlatBufferBuilder builder, VoiceSpineExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.VoiceSpineExcel>);
