...
public struct ConquestErosionUnitExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.ConquestErosionUnitExcel> CreateConquestErosionUnitExcel(FlatBufferBuilder builder,
      long TilePrefabId = 0,
  ...
  public static Offset<Schale.FlatData.ConquestErosionUnitExcel> EndConquestErosionUnitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ConquestErosionUnitExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ConquestErosionUnitExcel> Pack(FlatBufferBuilder builder, ConquestErosionUnitExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ConquestErosionUnitExcel>);
