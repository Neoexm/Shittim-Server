...
public struct MiniGameDefenseInfoExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ParcelType DefenseBattleParcelType { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.MiniGameDefenseInfoExcel> CreateMiniGameDefenseInfoExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      Schale.FlatData.ParcelType DefenseBattleParcelType = Schale.FlatData.ParcelType.None,
  ...
  public static void AddDefenseBattleParcelType(FlatBufferBuilder builder, Schale.FlatData.ParcelType defenseBattleParcelType) { builder.AddInt(1, (int)defenseBattleParcelType, 0); }
  ...
  public static Offset<Schale.FlatData.MiniGameDefenseInfoExcel> EndMiniGameDefenseInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MiniGameDefenseInfoExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MiniGameDefenseInfoExcel> Pack(FlatBufferBuilder builder, MiniGameDefenseInfoExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MiniGameDefenseInfoExcel>);
...
public class MiniGameDefenseInfoExcelT
{
  ...
  public Schale.FlatData.ParcelType DefenseBattleParcelType { get; set; }
  ...
  public MiniGameDefenseInfoExcelT() {
    ...
    this.DefenseBattleParcelType = Schale.FlatData.ParcelType.None;
...
static public class MiniGameDefenseInfoExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*DefenseBattleParcelType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
