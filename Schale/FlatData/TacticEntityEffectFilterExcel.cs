...
public struct TacticEntityEffectFilterExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.TacticEntityEffectFilterExcel> CreateTacticEntityEffectFilterExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.TacticEntityEffectFilterExcel> EndTacticEntityEffectFilterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.TacticEntityEffectFilterExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.TacticEntityEffectFilterExcel> Pack(FlatBufferBuilder builder, TacticEntityEffectFilterExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.TacticEntityEffectFilterExcel>);
