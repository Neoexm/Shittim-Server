...
public struct FieldEvidenceExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.FieldEvidenceExcel> CreateFieldEvidenceExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long SeasonId = 0,
  ...
  public static Offset<Schale.FlatData.FieldEvidenceExcel> EndFieldEvidenceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.FieldEvidenceExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.FieldEvidenceExcel> Pack(FlatBufferBuilder builder, FieldEvidenceExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.FieldEvidenceExcel>);
