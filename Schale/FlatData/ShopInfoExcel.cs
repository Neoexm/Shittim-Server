...
public struct ShopInfoExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ShopCategoryType CategoryType { get { int o = __p.__offset(4); return o != 0 ? (Schale.FlatData.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ShopCategoryType.General; } }
  ...
  public Schale.FlatData.ShopRefresherType ShopRefresherType { get { int o = __p.__offset(16); return o != 0 ? (Schale.FlatData.ShopRefresherType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ShopRefresherType.None; } }
  public Schale.FlatData.ShopRefreshPeriodType ShopRefreshPeriodType { get { int o = __p.__offset(18); return o != 0 ? (Schale.FlatData.ShopRefreshPeriodType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ShopRefreshPeriodType.None; } }
  ...
  public Schale.FlatData.ParcelType DisplayParcelType { get { int o = __p.__offset(32); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.ShopInfoExcel> CreateShopInfoExcel(FlatBufferBuilder builder,
      ...
      Schale.FlatData.ShopRefresherType ShopRefresherType = Schale.FlatData.ShopRefresherType.None,
      Schale.FlatData.ShopRefreshPeriodType ShopRefreshPeriodType = Schale.FlatData.ShopRefreshPeriodType.None,
      ...
      Schale.FlatData.ParcelType DisplayParcelType = Schale.FlatData.ParcelType.None,
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, Schale.FlatData.ShopCategoryType categoryType) { builder.AddInt(0, (int)categoryType, 0); }
  ...
  public static void AddShopRefresherType(FlatBufferBuilder builder, Schale.FlatData.ShopRefresherType shopRefresherType) { builder.AddInt(6, (int)shopRefresherType, 0); }
  public static void AddShopRefreshPeriodType(FlatBufferBuilder builder, Schale.FlatData.ShopRefreshPeriodType shopRefreshPeriodType) { builder.AddInt(7, (int)shopRefreshPeriodType, 0); }
  ...
  public static void AddDisplayParcelType(FlatBufferBuilder builder, Schale.FlatData.ParcelType displayParcelType) { builder.AddInt(14, (int)displayParcelType, 0); }
  ...
  public static Offset<Schale.FlatData.ShopInfoExcel> EndShopInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ShopInfoExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ShopInfoExcel> Pack(FlatBufferBuilder builder, ShopInfoExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ShopInfoExcel>);
    ...
    var _RefreshPeriodBaseTime = _o.RefreshPeriodBaseTime == null ? default(StringOffset) : builder.CreateString(_o.RefreshPeriodBaseTime);
    ...
    return CreateShopInfoExcel(
      ...
      _o.ShopRefresherType,
      _o.ShopRefreshPeriodType,
      _o.RefreshAbleCount,
      _GoodsId,
      _OpenPeriodFrom,
      _OpenPeriodTo,
...
public class ShopInfoExcelT
{
  ...
  public Schale.FlatData.ShopRefresherType ShopRefresherType { get; set; }
  public Schale.FlatData.ShopRefreshPeriodType ShopRefreshPeriodType { get; set; }
  ...
  public Schale.FlatData.ParcelType DisplayParcelType { get; set; }
  ...
  public ShopInfoExcelT() {
    ...
    this.ShopRefresherType = Schale.FlatData.ShopRefresherType.None;
    this.ShopRefreshPeriodType = Schale.FlatData.ShopRefreshPeriodType.None;
    ...
    this.DisplayParcelType = Schale.FlatData.ParcelType.None;
...
static public class ShopInfoExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*CategoryType*/, 4 /*Schale.FlatData.ShopCategoryType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 16 /*ShopRefresherType*/, 4 /*Schale.FlatData.ShopRefresherType*/, 4, false)
      && verifier.VerifyField(tablePos, 18 /*ShopRefreshPeriodType*/, 4 /*Schale.FlatData.ShopRefreshPeriodType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 32 /*DisplayParcelType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
