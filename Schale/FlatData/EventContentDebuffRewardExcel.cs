...
public struct EventContentDebuffRewardExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.EventContentItemType EventContentItemType { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.EventContentItemType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.EventContentItemType.EventPoint; } }
  public long RewardPercentage { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }

  public static Offset<Schale.FlatData.EventContentDebuffRewardExcel> CreateEventContentDebuffRewardExcel(FlatBufferBuilder builder,
  ...
  public static void AddEventContentItemType(FlatBufferBuilder builder, Schale.FlatData.EventContentItemType eventContentItemType) { builder.AddInt(2, (int)eventContentItemType, 0); }
  ...
  public static Offset<Schale.FlatData.EventContentDebuffRewardExcel> EndEventContentDebuffRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentDebuffRewardExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.EventContentDebuffRewardExcel> Pack(FlatBufferBuilder builder, EventContentDebuffRewardExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EventContentDebuffRewardExcel>);
...
static public class EventContentDebuffRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*EventContentItemType*/, 4 /*Schale.FlatData.EventContentItemType*/, 4, false)
