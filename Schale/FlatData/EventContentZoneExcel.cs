...
public struct EventContentZoneExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.Tag Tags(int j) { int o = __p.__offset(20); return o != 0 ? (Schale.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(20); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.Tag> GetTagsBytes() { return __p.__vector_as_span<Schale.FlatData.Tag>(20, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(20); }
#endif
  public Schale.FlatData.Tag[] GetTagsArray() { int o = __p.__offset(20); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.Tag[] a = new Schale.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  public Schale.FlatData.Tag WhiteListTags(int j) { int o = __p.__offset(22); return o != 0 ? (Schale.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.Tag)0; }
  public int WhiteListTagsLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.Tag> GetWhiteListTagsBytes() { return __p.__vector_as_span<Schale.FlatData.Tag>(22, 4); }
#else
  public ArraySegment<byte>? GetWhiteListTagsBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public Schale.FlatData.Tag[] GetWhiteListTagsArray() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.Tag[] a = new Schale.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }

  public static Offset<Schale.FlatData.EventContentZoneExcel> CreateEventContentZoneExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static VectorOffset CreateWhiteListTagsVector(FlatBufferBuilder builder, Schale.FlatData.Tag[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateWhiteListTagsVectorBlock(FlatBufferBuilder builder, Schale.FlatData.Tag[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateWhiteListTagsVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.Tag> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateWhiteListTagsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.Tag>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartWhiteListTagsVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<Schale.FlatData.EventContentZoneExcel> EndEventContentZoneExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentZoneExcel>(o);
  }
  ...
  public void UnPackTo(EventContentZoneExcelT _o) {
    ...
    _o.WhiteListTags = new List<Schale.FlatData.Tag>();
  ...
  public static Offset<Schale.FlatData.EventContentZoneExcel> Pack(FlatBufferBuilder builder, EventContentZoneExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EventContentZoneExcel>);
...
public class EventContentZoneExcelT
{
  ...
  public List<Schale.FlatData.Tag> WhiteListTags { get; set; }
...
static public class EventContentZoneExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 20 /*Tags*/, 4 /*Schale.FlatData.Tag*/, false)
      && verifier.VerifyVectorOfData(tablePos, 22 /*WhiteListTags*/, 4 /*Schale.FlatData.Tag*/, false)
