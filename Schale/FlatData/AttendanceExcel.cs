...
public struct AttendanceExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.AttendanceType Type { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.AttendanceType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.AttendanceType.Basic; } }
  ...
  public Schale.FlatData.AttendanceCountRule CountRule { get { int o = __p.__offset(20); return o != 0 ? (Schale.FlatData.AttendanceCountRule)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.AttendanceCountRule.Accumulation; } }
  public Schale.FlatData.AttendanceResetType CountReset { get { int o = __p.__offset(22); return o != 0 ? (Schale.FlatData.AttendanceResetType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.AttendanceResetType.User; } }
  ...
  public Schale.FlatData.DialogCategory DialogCategory { get { int o = __p.__offset(36); return o != 0 ? (Schale.FlatData.DialogCategory)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.DialogCategory.Cafe; } }
  ...
  public static Offset<Schale.FlatData.AttendanceExcel> CreateAttendanceExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      Schale.FlatData.AttendanceCountRule CountRule = Schale.FlatData.AttendanceCountRule.Accumulation,
      Schale.FlatData.AttendanceResetType CountReset = Schale.FlatData.AttendanceResetType.User,
      long BookSize = 0,
  ...
  public static void AddCountRule(FlatBufferBuilder builder, Schale.FlatData.AttendanceCountRule countRule) { builder.AddInt(8, (int)countRule, 0); }
  public static void AddCountReset(FlatBufferBuilder builder, Schale.FlatData.AttendanceResetType countReset) { builder.AddInt(9, (int)countReset, 0); }
  ...
  public static void AddDialogCategory(FlatBufferBuilder builder, Schale.FlatData.DialogCategory dialogCategory) { builder.AddInt(16, (int)dialogCategory, 0); }
  ...
  public static Offset<Schale.FlatData.AttendanceExcel> EndAttendanceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.AttendanceExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.AttendanceExcel> Pack(FlatBufferBuilder builder, AttendanceExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.AttendanceExcel>);
...
public class AttendanceExcelT
{
  ...
  public Schale.FlatData.AttendanceCountRule CountRule { get; set; }
  public Schale.FlatData.AttendanceResetType CountReset { get; set; }
  ...
  public AttendanceExcelT() {
    ...
    this.CountRule = Schale.FlatData.AttendanceCountRule.Accumulation;
    this.CountReset = Schale.FlatData.AttendanceResetType.User;
    this.BookSize = 0;
    this.StartDate = null;
...
static public class AttendanceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*CountRule*/, 4 /*Schale.FlatData.AttendanceCountRule*/, 4, false)
      && verifier.VerifyField(tablePos, 22 /*CountReset*/, 4 /*Schale.FlatData.AttendanceResetType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 36 /*DialogCategory*/, 4 /*Schale.FlatData.DialogCategory*/, 4, false)
