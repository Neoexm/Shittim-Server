...
public struct GachaGroupExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.GachaGroupType GroupType { get { int o = __p.__offset(10); return o != 0 ? (Schale.FlatData.GachaGroupType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.GachaGroupType.None; } }

  public static Offset<Schale.FlatData.GachaGroupExcel> CreateGachaGroupExcel(FlatBufferBuilder builder,
      long ID = 0,
      StringOffset NameKrOffset = default(StringOffset),
      bool IsRecursive = false,
      Schale.FlatData.GachaGroupType GroupType = Schale.FlatData.GachaGroupType.None) {
  ...
  public static void AddGroupType(FlatBufferBuilder builder, Schale.FlatData.GachaGroupType groupType) { builder.AddInt(3, (int)groupType, 0); }
  public static Offset<Schale.FlatData.GachaGroupExcel> EndGachaGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.GachaGroupExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.GachaGroupExcel> Pack(FlatBufferBuilder builder, GachaGroupExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.GachaGroupExcel>);
...
public class GachaGroupExcelT
{
  ...
  public Schale.FlatData.GachaGroupType GroupType { get; set; }

  public GachaGroupExcelT() {
    this.ID = 0;
    this.NameKr = null;
    this.IsRecursive = false;
    this.GroupType = Schale.FlatData.GachaGroupType.None;
  }
}
...
static public class GachaGroupExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*GroupType*/, 4 /*Schale.FlatData.GachaGroupType*/, 4, false)
