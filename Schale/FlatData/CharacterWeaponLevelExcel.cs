...
public struct CharacterWeaponLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.CharacterWeaponLevelExcel> CreateCharacterWeaponLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
      long Exp = 0,
      long TotalExp = 0) {
  ...
  public static Offset<Schale.FlatData.CharacterWeaponLevelExcel> EndCharacterWeaponLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CharacterWeaponLevelExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.CharacterWeaponLevelExcel> Pack(FlatBufferBuilder builder, CharacterWeaponLevelExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.CharacterWeaponLevelExcel>);
