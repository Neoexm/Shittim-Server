...
public struct CharacterCalculationLimitExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.BattleCalculationStat CalculationValue { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.BattleCalculationStat)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.BattleCalculationStat.FinalDamage; } }
  ...
  public static Offset<Schale.FlatData.CharacterCalculationLimitExcel> CreateCharacterCalculationLimitExcel(FlatBufferBuilder builder,
      long Id = 0,
      Schale.FlatData.TacticEntityType TacticEntityType = Schale.FlatData.TacticEntityType.None,
      Schale.FlatData.BattleCalculationStat CalculationValue = Schale.FlatData.BattleCalculationStat.FinalDamage,
      long MinValue = 0,
      long MaxValue = 0,
  ...
  public static void AddCalculationValue(FlatBufferBuilder builder, Schale.FlatData.BattleCalculationStat calculationValue) { builder.AddInt(2, (int)calculationValue, 0); }
  ...
  public static Offset<Schale.FlatData.CharacterCalculationLimitExcel> EndCharacterCalculationLimitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CharacterCalculationLimitExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.CharacterCalculationLimitExcel> Pack(FlatBufferBuilder builder, CharacterCalculationLimitExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.CharacterCalculationLimitExcel>);
...
public class CharacterCalculationLimitExcelT
{
  ...
  public Schale.FlatData.BattleCalculationStat CalculationValue { get; set; }
  ...
  public CharacterCalculationLimitExcelT() {
    ...
    this.CalculationValue = Schale.FlatData.BattleCalculationStat.FinalDamage;
    this.MinValue = 0;
    this.MaxValue = 0;
...
static public class CharacterCalculationLimitExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CalculationValue*/, 4 /*Schale.FlatData.BattleCalculationStat*/, 4, false)
