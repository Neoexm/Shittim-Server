...
public struct MinigameTBGThemaExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.TBGThemaType ThemaType { get { int o = __p.__offset(10); return o != 0 ? (Schale.FlatData.TBGThemaType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.TBGThemaType.None; } }
  ...
  public Schale.FlatData.TBGPortalCondition PortalCondition(int j) { int o = __p.__offset(16); return o != 0 ? (Schale.FlatData.TBGPortalCondition)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.TBGPortalCondition)0; }
  public int PortalConditionLength { get { int o = __p.__offset(16); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.TBGPortalCondition> GetPortalConditionBytes() { return __p.__vector_as_span<Schale.FlatData.TBGPortalCondition>(16, 4); }
#else
  public ArraySegment<byte>? GetPortalConditionBytes() { return __p.__vector_as_arraysegment(16); }
#endif
  public Schale.FlatData.TBGPortalCondition[] GetPortalConditionArray() { int o = __p.__offset(16); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.TBGPortalCondition[] a = new Schale.FlatData.TBGPortalCondition[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.TBGPortalCondition)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.MinigameTBGThemaExcel> CreateMinigameTBGThemaExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long UniqueId = 0,
      int ThemaIndex = 0,
      Schale.FlatData.TBGThemaType ThemaType = Schale.FlatData.TBGThemaType.None,
  ...
  public static void AddThemaType(FlatBufferBuilder builder, Schale.FlatData.TBGThemaType themaType) { builder.AddInt(3, (int)themaType, 0); }
  ...
  public static VectorOffset CreatePortalConditionVector(FlatBufferBuilder builder, Schale.FlatData.TBGPortalCondition[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreatePortalConditionVectorBlock(FlatBufferBuilder builder, Schale.FlatData.TBGPortalCondition[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreatePortalConditionVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.TBGPortalCondition> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreatePortalConditionVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.TBGPortalCondition>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Schale.FlatData.MinigameTBGThemaExcel> EndMinigameTBGThemaExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MinigameTBGThemaExcel>(o);
  }
  ...
  public void UnPackTo(MinigameTBGThemaExcelT _o) {
    ...
    _o.PortalCondition = new List<Schale.FlatData.TBGPortalCondition>();
  ...
  public static Offset<Schale.FlatData.MinigameTBGThemaExcel> Pack(FlatBufferBuilder builder, MinigameTBGThemaExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MinigameTBGThemaExcel>);
...
public class MinigameTBGThemaExcelT
{
  ...
  public Schale.FlatData.TBGThemaType ThemaType { get; set; }
  public string ThemaMap { get; set; }
  public string ThemaMapBG { get; set; }
  public List<Schale.FlatData.TBGPortalCondition> PortalCondition { get; set; }
  ...
  public MinigameTBGThemaExcelT() {
    ...
    this.UniqueId = 0;
    this.ThemaIndex = 0;
    this.ThemaType = Schale.FlatData.TBGThemaType.None;
    this.ThemaMap = null;
...
static public class MinigameTBGThemaExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ThemaType*/, 4 /*Schale.FlatData.TBGThemaType*/, 4, false)
      && verifier.VerifyString(tablePos, 12 /*ThemaMap*/, false)
      && verifier.VerifyString(tablePos, 14 /*ThemaMapBG*/, false)
      && verifier.VerifyVectorOfData(tablePos, 16 /*PortalCondition*/, 4 /*Schale.FlatData.TBGPortalCondition*/, false)
