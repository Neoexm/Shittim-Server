...
public struct BossPhaseExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.BossPhaseExcel> CreateBossPhaseExcel(FlatBufferBuilder builder,
      long Id = 0,
      long AIPhase = 0,
  ...
  public static Offset<Schale.FlatData.BossPhaseExcel> EndBossPhaseExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.BossPhaseExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.BossPhaseExcel> Pack(FlatBufferBuilder builder, BossPhaseExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.BossPhaseExcel>);
