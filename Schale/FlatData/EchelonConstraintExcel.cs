...
public struct EchelonConstraintExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.WeaponType WeaponType { get { int o = __p.__offset(12); return o != 0 ? (Schale.FlatData.WeaponType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.WeaponType.None; } }
  public Schale.FlatData.School School { get { int o = __p.__offset(14); return o != 0 ? (Schale.FlatData.School)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.School.None; } }
  public Schale.FlatData.Club Club { get { int o = __p.__offset(16); return o != 0 ? (Schale.FlatData.Club)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.Club.None; } }
  public Schale.FlatData.TacticRole Role { get { int o = __p.__offset(18); return o != 0 ? (Schale.FlatData.TacticRole)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.TacticRole.None; } }
  ...
  public static Offset<Schale.FlatData.EchelonConstraintExcel> CreateEchelonConstraintExcel(FlatBufferBuilder builder,
      ...
      Schale.FlatData.TacticRole Role = Schale.FlatData.TacticRole.None) {
  ...
  public static void AddWeaponType(FlatBufferBuilder builder, Schale.FlatData.WeaponType weaponType) { builder.AddInt(4, (int)weaponType, 0); }
  public static void AddSchool(FlatBufferBuilder builder, Schale.FlatData.School school) { builder.AddInt(5, (int)school, 0); }
  public static void AddClub(FlatBufferBuilder builder, Schale.FlatData.Club club) { builder.AddInt(6, (int)club, 0); }
  public static void AddRole(FlatBufferBuilder builder, Schale.FlatData.TacticRole role) { builder.AddInt(7, (int)role, 0); }
  public static Offset<Schale.FlatData.EchelonConstraintExcel> EndEchelonConstraintExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EchelonConstraintExcel>(o);
  }
...
public class EchelonConstraintExcelT
{
  ...
  public Schale.FlatData.TacticRole Role { get; set; }
  ...
  public EchelonConstraintExcelT() {
    ...
    this.Role = Schale.FlatData.TacticRole.None;
  }
}
...
static public class EchelonConstraintExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*WeaponType*/, 4 /*Schale.FlatData.WeaponType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*School*/, 4 /*Schale.FlatData.School*/, 4, false)
      && verifier.VerifyField(tablePos, 16 /*Club*/, 4 /*Schale.FlatData.Club*/, 4, false)
      && verifier.VerifyField(tablePos, 18 /*Role*/, 4 /*Schale.FlatData.TacticRole*/, 4, false)
