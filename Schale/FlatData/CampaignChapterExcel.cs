...
public struct CampaignChapterExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.CampaignChapterExcel> CreateCampaignChapterExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Schale.FlatData.CampaignChapterExcel> EndCampaignChapterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CampaignChapterExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.CampaignChapterExcel> Pack(FlatBufferBuilder builder, CampaignChapterExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.CampaignChapterExcel>);
