...
public struct EventContentCollectionExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.CollectionUnlockType UnlockConditionType { get { int o = __p.__offset(10); return o != 0 ? (Schale.FlatData.CollectionUnlockType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.CollectionUnlockType.None; } }
  ...
  public Schale.FlatData.MultipleConditionCheckType MultipleConditionCheckType { get { int o = __p.__offset(14); return o != 0 ? (Schale.FlatData.MultipleConditionCheckType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.MultipleConditionCheckType.And; } }
  ...
  public static Offset<Schale.FlatData.EventContentCollectionExcel> CreateEventContentCollectionExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddUnlockConditionType(FlatBufferBuilder builder, Schale.FlatData.CollectionUnlockType unlockConditionType) { builder.AddInt(3, (int)unlockConditionType, 0); }
  ...
  public static void AddMultipleConditionCheckType(FlatBufferBuilder builder, Schale.FlatData.MultipleConditionCheckType multipleConditionCheckType) { builder.AddInt(5, (int)multipleConditionCheckType, 0); }
  ...
  public static Offset<Schale.FlatData.EventContentCollectionExcel> EndEventContentCollectionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentCollectionExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.EventContentCollectionExcel> Pack(FlatBufferBuilder builder, EventContentCollectionExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EventContentCollectionExcel>);
    ...
    var _Decoration = _o.Decoration == null ? default(StringOffset) : builder.CreateString(_o.Decoration);
...
static public class EventContentCollectionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*UnlockConditionType*/, 4 /*Schale.FlatData.CollectionUnlockType*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 12 /*UnlockConditionParameter*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 14 /*MultipleConditionCheckType*/, 4 /*Schale.FlatData.MultipleConditionCheckType*/, 4, false)
