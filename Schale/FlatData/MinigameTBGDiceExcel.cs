...
public struct MinigameTBGDiceExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.TBGProbModifyCondition ProbModifyCondition(int j) { int o = __p.__offset(14); return o != 0 ? (Schale.FlatData.TBGProbModifyCondition)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.TBGProbModifyCondition)0; }
  public int ProbModifyConditionLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.TBGProbModifyCondition> GetProbModifyConditionBytes() { return __p.__vector_as_span<Schale.FlatData.TBGProbModifyCondition>(14, 4); }
#else
  public ArraySegment<byte>? GetProbModifyConditionBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public Schale.FlatData.TBGProbModifyCondition[] GetProbModifyConditionArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.TBGProbModifyCondition[] a = new Schale.FlatData.TBGProbModifyCondition[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.TBGProbModifyCondition)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.MinigameTBGDiceExcel> CreateMinigameTBGDiceExcel(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateProbModifyConditionVector(FlatBufferBuilder builder, Schale.FlatData.TBGProbModifyCondition[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateProbModifyConditionVectorBlock(FlatBufferBuilder builder, Schale.FlatData.TBGProbModifyCondition[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateProbModifyConditionVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.TBGProbModifyCondition> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateProbModifyConditionVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.TBGProbModifyCondition>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Schale.FlatData.MinigameTBGDiceExcel> EndMinigameTBGDiceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MinigameTBGDiceExcel>(o);
  }
  ...
  public void UnPackTo(MinigameTBGDiceExcelT _o) {
    ...
    _o.ProbModifyCondition = new List<Schale.FlatData.TBGProbModifyCondition>();
  ...
  public static Offset<Schale.FlatData.MinigameTBGDiceExcel> Pack(FlatBufferBuilder builder, MinigameTBGDiceExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MinigameTBGDiceExcel>);
...
public class MinigameTBGDiceExcelT
{
  ...
  public List<Schale.FlatData.TBGProbModifyCondition> ProbModifyCondition { get; set; }
...
static public class MinigameTBGDiceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 14 /*ProbModifyCondition*/, 4 /*Schale.FlatData.TBGProbModifyCondition*/, false)
