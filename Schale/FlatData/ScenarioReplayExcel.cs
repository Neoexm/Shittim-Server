...
public struct ScenarioReplayExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ScenarioModeReplayTypes ReplayType { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.ScenarioModeReplayTypes)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ScenarioModeReplayTypes.None; } }
  ...
  public static Offset<Schale.FlatData.ScenarioReplayExcel> CreateScenarioReplayExcel(FlatBufferBuilder builder,
      long ModeId = 0,
      long VolumeId = 0,
      Schale.FlatData.ScenarioModeReplayTypes ReplayType = Schale.FlatData.ScenarioModeReplayTypes.None,
      long ChapterId = 0,
      long EpisodeId = 0,
  ...
  public static void AddReplayType(FlatBufferBuilder builder, Schale.FlatData.ScenarioModeReplayTypes replayType) { builder.AddInt(2, (int)replayType, 0); }
  ...
  public static Offset<Schale.FlatData.ScenarioReplayExcel> EndScenarioReplayExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ScenarioReplayExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ScenarioReplayExcel> Pack(FlatBufferBuilder builder, ScenarioReplayExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ScenarioReplayExcel>);
...
public class ScenarioReplayExcelT
{
  ...
  public Schale.FlatData.ScenarioModeReplayTypes ReplayType { get; set; }
  ...
  public ScenarioReplayExcelT() {
    this.ModeId = 0;
    this.VolumeId = 0;
    this.ReplayType = Schale.FlatData.ScenarioModeReplayTypes.None;
    this.ChapterId = 0;
    this.EpisodeId = 0;
...
static public class ScenarioReplayExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ReplayType*/, 4 /*Schale.FlatData.ScenarioModeReplayTypes*/, 4, false)
