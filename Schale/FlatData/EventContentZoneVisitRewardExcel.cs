...
public struct EventContentZoneVisitRewardExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ParcelType VisitRewardParcelType(int j) { int o = __p.__offset(14); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.ParcelType)0; }
  public int VisitRewardParcelTypeLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.ParcelType> GetVisitRewardParcelTypeBytes() { return __p.__vector_as_span<Schale.FlatData.ParcelType>(14, 4); }
#else
  public ArraySegment<byte>? GetVisitRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public Schale.FlatData.ParcelType[] GetVisitRewardParcelTypeArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.ParcelType[] a = new Schale.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.EventContentZoneVisitRewardExcel> CreateEventContentZoneVisitRewardExcel(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateVisitRewardParcelTypeVector(FlatBufferBuilder builder, Schale.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateVisitRewardParcelTypeVectorBlock(FlatBufferBuilder builder, Schale.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateVisitRewardParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateVisitRewardParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Schale.FlatData.EventContentZoneVisitRewardExcel> EndEventContentZoneVisitRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentZoneVisitRewardExcel>(o);
  }
  ...
  public void UnPackTo(EventContentZoneVisitRewardExcelT _o) {
    ...
    _o.VisitRewardParcelType = new List<Schale.FlatData.ParcelType>();
  ...
  public static Offset<Schale.FlatData.EventContentZoneVisitRewardExcel> Pack(FlatBufferBuilder builder, EventContentZoneVisitRewardExcelT _o) {
...
public class EventContentZoneVisitRewardExcelT
{
  ...
  public List<Schale.FlatData.ParcelType> VisitRewardParcelType { get; set; }
...
static public class EventContentZoneVisitRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 14 /*VisitRewardParcelType*/, 4 /*Schale.FlatData.ParcelType*/, false)
