...
public struct FieldSceneExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.FieldSceneExcel> CreateFieldSceneExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long DateId = 0,
      long GroupId = 0,
  ...
  public static Offset<Schale.FlatData.FieldSceneExcel> EndFieldSceneExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.FieldSceneExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.FieldSceneExcel> Pack(FlatBufferBuilder builder, FieldSceneExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.FieldSceneExcel>);
