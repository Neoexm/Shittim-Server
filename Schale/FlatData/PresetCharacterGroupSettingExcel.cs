...
public struct PresetCharacterGroupSettingExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.PresetCharacterGroupSettingExcel> CreatePresetCharacterGroupSettingExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
  ...
  public static Offset<Schale.FlatData.PresetCharacterGroupSettingExcel> EndPresetCharacterGroupSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.PresetCharacterGroupSettingExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.PresetCharacterGroupSettingExcel> Pack(FlatBufferBuilder builder, PresetCharacterGroupSettingExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.PresetCharacterGroupSettingExcel>);
