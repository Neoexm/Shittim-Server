...
public struct MiniGameDefenseStageExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.EchelonExtensionType EchelonExtensionType { get { int o = __p.__offset(20); return o != 0 ? (Schale.FlatData.EchelonExtensionType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.EchelonExtensionType.Base; } }
  public long BattleDuration { get { int o = __p.__offset(22); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Schale.FlatData.ParcelType StageEnterCostType { get { int o = __p.__offset(24); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public Schale.FlatData.StageTopography StageTopography { get { int o = __p.__offset(36); return o != 0 ? (Schale.FlatData.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.StageTopography.Street; } }
  ...
  public Schale.FlatData.ContentType ContentType { get { int o = __p.__offset(42); return o != 0 ? (Schale.FlatData.ContentType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ContentType.None; } }
  public Schale.FlatData.StarGoalType StarGoal(int j) { int o = __p.__offset(44); return o != 0 ? (Schale.FlatData.StarGoalType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.StarGoalType)0; }
  public int StarGoalLength { get { int o = __p.__offset(44); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.StarGoalType> GetStarGoalBytes() { return __p.__vector_as_span<Schale.FlatData.StarGoalType>(44, 4); }
#else
  public ArraySegment<byte>? GetStarGoalBytes() { return __p.__vector_as_arraysegment(44); }
#endif
  public Schale.FlatData.StarGoalType[] GetStarGoalArray() { int o = __p.__offset(44); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.StarGoalType[] a = new Schale.FlatData.StarGoalType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.StarGoalType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.MiniGameDefenseStageExcel> CreateMiniGameDefenseStageExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddEchelonExtensionType(FlatBufferBuilder builder, Schale.FlatData.EchelonExtensionType echelonExtensionType) { builder.AddInt(8, (int)echelonExtensionType, 0); }
  public static void AddBattleDuration(FlatBufferBuilder builder, long battleDuration) { builder.AddLong(9, battleDuration, 0); }
  public static void AddStageEnterCostType(FlatBufferBuilder builder, Schale.FlatData.ParcelType stageEnterCostType) { builder.AddInt(10, (int)stageEnterCostType, 0); }
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, Schale.FlatData.StageTopography stageTopography) { builder.AddInt(16, (int)stageTopography, 0); }
  ...
  public static void AddContentType(FlatBufferBuilder builder, Schale.FlatData.ContentType contentType) { builder.AddInt(19, (int)contentType, 0); }
  ...
  public static Offset<Schale.FlatData.MiniGameDefenseStageExcel> EndMiniGameDefenseStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MiniGameDefenseStageExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MiniGameDefenseStageExcel> Pack(FlatBufferBuilder builder, MiniGameDefenseStageExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MiniGameDefenseStageExcel>);
...
static public class MiniGameDefenseStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*EchelonExtensionType*/, 4 /*Schale.FlatData.EchelonExtensionType*/, 4, false)
      && verifier.VerifyField(tablePos, 22 /*BattleDuration*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 24 /*StageEnterCostType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 36 /*StageTopography*/, 4 /*Schale.FlatData.StageTopography*/, 4, false)
      && verifier.VerifyField(tablePos, 38 /*RecommandLevel*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 40 /*GroundID*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 42 /*ContentType*/, 4 /*Schale.FlatData.ContentType*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 44 /*StarGoal*/, 4 /*Schale.FlatData.StarGoalType*/, false)
