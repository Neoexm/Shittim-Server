...
public struct TimeAttackDungeonExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.TimeAttackDungeonExcel> CreateTimeAttackDungeonExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Schale.FlatData.TimeAttackDungeonExcel> EndTimeAttackDungeonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.TimeAttackDungeonExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.TimeAttackDungeonExcel> Pack(FlatBufferBuilder builder, TimeAttackDungeonExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.TimeAttackDungeonExcel>);
