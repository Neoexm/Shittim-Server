...
public struct ShopFreeRecruitPeriodExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.ShopFreeRecruitPeriodExcel> CreateShopFreeRecruitPeriodExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.ShopFreeRecruitPeriodExcel> EndShopFreeRecruitPeriodExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ShopFreeRecruitPeriodExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ShopFreeRecruitPeriodExcel> Pack(FlatBufferBuilder builder, ShopFreeRecruitPeriodExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ShopFreeRecruitPeriodExcel>);
