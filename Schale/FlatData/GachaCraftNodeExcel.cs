...
public struct GachaCraftNodeExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.GachaCraftNodeExcel> CreateGachaCraftNodeExcel(FlatBufferBuilder builder,
      long ID = 0,
      long Tier = 0,
  ...
  public static Offset<Schale.FlatData.GachaCraftNodeExcel> EndGachaCraftNodeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.GachaCraftNodeExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.GachaCraftNodeExcel> Pack(FlatBufferBuilder builder, GachaCraftNodeExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.GachaCraftNodeExcel>);
