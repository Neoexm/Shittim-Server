...
public struct RaidStageExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.Difficulty Difficulty { get { int o = __p.__offset(20); return o != 0 ? (Schale.FlatData.Difficulty)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.Difficulty.Normal; } }
  ...
  public Schale.FlatData.RaidBossGroupType RaidBossGroupType { get { int o = __p.__offset(32); return o != 0 ? (Schale.FlatData.RaidBossGroupType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.RaidBossGroupType.None; } }
  ...
  public Schale.FlatData.TacticEnvironment TacticEnvironment { get { int o = __p.__offset(36); return o != 0 ? (Schale.FlatData.TacticEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.TacticEnvironment.None; } }
  ...
  public static Offset<Schale.FlatData.RaidStageExcel> CreateRaidStageExcel(FlatBufferBuilder builder,
      long Id = 0,
    ...
    RaidStageExcel.AddRaidBossGroupType(builder, RaidBossGroupType);
  ...
  public static void AddDifficulty(FlatBufferBuilder builder, Schale.FlatData.Difficulty difficulty) { builder.AddInt(8, (int)difficulty, 0); }
  ...
  public static void AddRaidBossGroupType(FlatBufferBuilder builder, Schale.FlatData.RaidBossGroupType raidBossGroupType) { builder.AddInt(14, (int)raidBossGroupType, 0); }
  ...
  public static void AddTacticEnvironment(FlatBufferBuilder builder, Schale.FlatData.TacticEnvironment tacticEnvironment) { builder.AddInt(16, (int)tacticEnvironment, 0); }
  ...
  public static Offset<Schale.FlatData.RaidStageExcel> EndRaidStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.RaidStageExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.RaidStageExcel> Pack(FlatBufferBuilder builder, RaidStageExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.RaidStageExcel>);
...
static public class RaidStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*Difficulty*/, 4 /*Schale.FlatData.Difficulty*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 32 /*RaidBossGroupType*/, 4 /*Schale.FlatData.RaidBossGroupType*/, 4, false)
      && verifier.VerifyString(tablePos, 34 /*EnterTimeLine*/, false)
      && verifier.VerifyField(tablePos, 36 /*TacticEnvironment*/, 4 /*Schale.FlatData.TacticEnvironment*/, 4, false)
