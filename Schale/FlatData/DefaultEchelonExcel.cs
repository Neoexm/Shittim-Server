...
public struct DefaultEchelonExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.DefaultEchelonExcel> CreateDefaultEchelonExcel(FlatBufferBuilder builder,
      int EchlonId = 0,
      long LeaderId = 0,
  ...
  public static Offset<Schale.FlatData.DefaultEchelonExcel> EndDefaultEchelonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.DefaultEchelonExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.DefaultEchelonExcel> Pack(FlatBufferBuilder builder, DefaultEchelonExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.DefaultEchelonExcel>);
