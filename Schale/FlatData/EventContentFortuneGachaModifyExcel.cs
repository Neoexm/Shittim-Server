...
public struct EventContentFortuneGachaModifyExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.EventContentFortuneGachaModifyExcel> CreateEventContentFortuneGachaModifyExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.EventContentFortuneGachaModifyExcel> EndEventContentFortuneGachaModifyExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentFortuneGachaModifyExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.EventContentFortuneGachaModifyExcel> Pack(FlatBufferBuilder builder, EventContentFortuneGachaModifyExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EventContentFortuneGachaModifyExcel>);
