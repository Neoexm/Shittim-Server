...
public struct FieldTutorialExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.FieldTutorialType TutorialType(int j) { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.FieldTutorialType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.FieldTutorialType)0; }
  public int TutorialTypeLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.FieldTutorialType> GetTutorialTypeBytes() { return __p.__vector_as_span<Schale.FlatData.FieldTutorialType>(6, 4); }
#else
  ...
  public Schale.FlatData.FieldConditionType ConditionType(int j) { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.FieldConditionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.FieldConditionType)0; }
  public int ConditionTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.FieldConditionType> GetConditionTypeBytes() { return __p.__vector_as_span<Schale.FlatData.FieldConditionType>(8, 4); }
#else
  ...
  public static VectorOffset CreateTutorialTypeVector(FlatBufferBuilder builder, Schale.FlatData.FieldTutorialType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateTutorialTypeVectorBlock(FlatBufferBuilder builder, Schale.FlatData.FieldTutorialType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTutorialTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.FieldTutorialType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTutorialTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.FieldTutorialType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Schale.FlatData.FieldTutorialExcel> EndFieldTutorialExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.FieldTutorialExcel>(o);
  }
  ...
  public void UnPackTo(FieldTutorialExcelT _o) {
    ...
    _o.TutorialType = new List<Schale.FlatData.FieldTutorialType>();
  ...
  public static Offset<Schale.FlatData.FieldTutorialExcel> Pack(FlatBufferBuilder builder, FieldTutorialExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.FieldTutorialExcel>);
...
public class FieldTutorialExcelT
{
  ...
  public List<Schale.FlatData.FieldTutorialType> TutorialType { get; set; }
...
static public class FieldTutorialExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*TutorialType*/, 4 /*Schale.FlatData.FieldTutorialType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 8 /*ConditionType*/, 4 /*Schale.FlatData.FieldConditionType*/, false)
