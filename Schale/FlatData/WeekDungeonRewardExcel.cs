...
public struct WeekDungeonRewardExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.WeekDungeonType DungeonType { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.WeekDungeonType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.WeekDungeonType.None; } }
  ...
  public static Offset<Schale.FlatData.WeekDungeonRewardExcel> CreateWeekDungeonRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      Schale.FlatData.WeekDungeonType DungeonType = Schale.FlatData.WeekDungeonType.None,
  ...
  public static void AddDungeonType(FlatBufferBuilder builder, Schale.FlatData.WeekDungeonType dungeonType) { builder.AddInt(1, (int)dungeonType, 0); }
  ...
  public static Offset<Schale.FlatData.WeekDungeonRewardExcel> EndWeekDungeonRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.WeekDungeonRewardExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.WeekDungeonRewardExcel> Pack(FlatBufferBuilder builder, WeekDungeonRewardExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.WeekDungeonRewardExcel>);
...
public class WeekDungeonRewardExcelT
{
  ...
  public Schale.FlatData.WeekDungeonType DungeonType { get; set; }
  ...
  public WeekDungeonRewardExcelT() {
    this.GroupId = 0;
    this.DungeonType = Schale.FlatData.WeekDungeonType.None;
...
static public class WeekDungeonRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*DungeonType*/, 4 /*Schale.FlatData.WeekDungeonType*/, 4, false)
