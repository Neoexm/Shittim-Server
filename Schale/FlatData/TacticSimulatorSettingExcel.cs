...
public struct TacticSimulatorSettingExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.TacticSimulatorSettingExcel> CreateTacticSimulatorSettingExcel(FlatBufferBuilder builder,
      long GroundId = 0,
  ...
  public static Offset<Schale.FlatData.TacticSimulatorSettingExcel> EndTacticSimulatorSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.TacticSimulatorSettingExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.TacticSimulatorSettingExcel> Pack(FlatBufferBuilder builder, TacticSimulatorSettingExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.TacticSimulatorSettingExcel>);
