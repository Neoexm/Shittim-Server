...
public struct WorldRaidConditionExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.MultipleConditionCheckType MultipleConditionCheckType { get { int o = __p.__offset(16); return o != 0 ? (Schale.FlatData.MultipleConditionCheckType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.MultipleConditionCheckType.And; } }
  ...
  public static Offset<Schale.FlatData.WorldRaidConditionExcel> CreateWorldRaidConditionExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddMultipleConditionCheckType(FlatBufferBuilder builder, Schale.FlatData.MultipleConditionCheckType multipleConditionCheckType) { builder.AddInt(6, (int)multipleConditionCheckType, 0); }
  ...
  public static Offset<Schale.FlatData.WorldRaidConditionExcel> EndWorldRaidConditionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.WorldRaidConditionExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.WorldRaidConditionExcel> Pack(FlatBufferBuilder builder, WorldRaidConditionExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.WorldRaidConditionExcel>);
...
static public class WorldRaidConditionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*MultipleConditionCheckType*/, 4 /*Schale.FlatData.MultipleConditionCheckType*/, 4, false)
