...
public struct Position : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.Position> CreatePosition(FlatBufferBuilder builder,
      float X = 0.0f,
      float Z = 0.0f) {
  ...
  public static Offset<Schale.FlatData.Position> EndPosition(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.Position>(o);
  }
  ...
  public static Offset<Schale.FlatData.Position> Pack(FlatBufferBuilder builder, PositionT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.Position>);
