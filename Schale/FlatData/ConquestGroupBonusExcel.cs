...
public struct ConquestGroupBonusExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.School School(int j) { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.School)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.School)0; }
  public int SchoolLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.School> GetSchoolBytes() { return __p.__vector_as_span<Schale.FlatData.School>(6, 4); }
#else
  public ArraySegment<byte>? GetSchoolBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public Schale.FlatData.School[] GetSchoolArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.School[] a = new Schale.FlatData.School[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.School)__p.bb.GetInt(p + i * 4); } return a; }
  public uint RecommandLocalizeEtcId { get { int o = __p.__offset(8); return o != 0 ? __p.bb.GetUint(o + __p.bb_pos) : (uint)0; } }
  public Schale.FlatData.ParcelType BonusParcelType(int j) { int o = __p.__offset(10); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.ParcelType)0; }
  public int BonusParcelTypeLength { get { int o = __p.__offset(10); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.ParcelType> GetBonusParcelTypeBytes() { return __p.__vector_as_span<Schale.FlatData.ParcelType>(10, 4); }
#else
  public ArraySegment<byte>? GetBonusParcelTypeBytes() { return __p.__vector_as_arraysegment(10); }
#endif
  public Schale.FlatData.ParcelType[] GetBonusParcelTypeArray() { int o = __p.__offset(10); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.ParcelType[] a = new Schale.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.ConquestGroupBonusExcel> CreateConquestGroupBonusExcel(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateSchoolVector(FlatBufferBuilder builder, Schale.FlatData.School[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateSchoolVectorBlock(FlatBufferBuilder builder, Schale.FlatData.School[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSchoolVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.School> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSchoolVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.School>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateBonusParcelTypeVector(FlatBufferBuilder builder, Schale.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateBonusParcelTypeVectorBlock(FlatBufferBuilder builder, Schale.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateBonusParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateBonusParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Schale.FlatData.ConquestGroupBonusExcel> EndConquestGroupBonusExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ConquestGroupBonusExcel>(o);
  }
  ...
  public void UnPackTo(ConquestGroupBonusExcelT _o) {
    ...
    _o.School = new List<Schale.FlatData.School>();
    ...
    _o.BonusParcelType = new List<Schale.FlatData.ParcelType>();
  ...
  public static Offset<Schale.FlatData.ConquestGroupBonusExcel> Pack(FlatBufferBuilder builder, ConquestGroupBonusExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ConquestGroupBonusExcel>);
...
public class ConquestGroupBonusExcelT
{
  ...
  public List<Schale.FlatData.School> School { get; set; }
  public uint RecommandLocalizeEtcId { get; set; }
  public List<Schale.FlatData.ParcelType> BonusParcelType { get; set; }
...
static public class ConquestGroupBonusExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*School*/, 4 /*Schale.FlatData.School*/, false)
      && verifier.VerifyField(tablePos, 8 /*RecommandLocalizeEtcId*/, 4 /*uint*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 10 /*BonusParcelType*/, 4 /*Schale.FlatData.ParcelType*/, false)
