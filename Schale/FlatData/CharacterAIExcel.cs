...
public struct CharacterAIExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.EngageType EngageType { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.EngageType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.EngageType.SearchAndMove; } }
  public Schale.FlatData.PositioningType Positioning { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.PositioningType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.PositioningType.CloseToObstacle; } }
  ...
  public static Offset<Schale.FlatData.CharacterAIExcel> CreateCharacterAIExcel(FlatBufferBuilder builder,
      long Id = 0,
      Schale.FlatData.EngageType EngageType = Schale.FlatData.EngageType.SearchAndMove,
      Schale.FlatData.PositioningType Positioning = Schale.FlatData.PositioningType.CloseToObstacle,
  ...
  public static void AddEngageType(FlatBufferBuilder builder, Schale.FlatData.EngageType engageType) { builder.AddInt(1, (int)engageType, 0); }
  public static void AddPositioning(FlatBufferBuilder builder, Schale.FlatData.PositioningType positioning) { builder.AddInt(2, (int)positioning, 0); }
  ...
  public static Offset<Schale.FlatData.CharacterAIExcel> EndCharacterAIExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CharacterAIExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.CharacterAIExcel> Pack(FlatBufferBuilder builder, CharacterAIExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.CharacterAIExcel>);
...
public class CharacterAIExcelT
{
  ...
  public Schale.FlatData.EngageType EngageType { get; set; }
  public Schale.FlatData.PositioningType Positioning { get; set; }
  ...
  public CharacterAIExcelT() {
    this.Id = 0;
    this.EngageType = Schale.FlatData.EngageType.SearchAndMove;
    this.Positioning = Schale.FlatData.PositioningType.CloseToObstacle;
...
static public class CharacterAIExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*EngageType*/, 4 /*Schale.FlatData.EngageType*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*Positioning*/, 4 /*Schale.FlatData.PositioningType*/, 4, false)
