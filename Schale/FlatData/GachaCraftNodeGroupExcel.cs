...
public struct GachaCraftNodeGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.GachaCraftNodeGroupExcel> CreateGachaCraftNodeGroupExcel(FlatBufferBuilder builder,
      long NodeId = 0,
      long GachaGroupId = 0,
      long ProbWeight = 0) {
  ...
  public static Offset<Schale.FlatData.GachaCraftNodeGroupExcel> EndGachaCraftNodeGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.GachaCraftNodeGroupExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.GachaCraftNodeGroupExcel> Pack(FlatBufferBuilder builder, GachaCraftNodeGroupExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.GachaCraftNodeGroupExcel>);
