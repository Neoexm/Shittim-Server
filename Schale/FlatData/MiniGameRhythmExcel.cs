...
public struct MiniGameRhythmExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.Difficulty StageDifficulty { get { int o = __p.__offset(10); return o != 0 ? (Schale.FlatData.Difficulty)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.Difficulty.Normal; } }
  ...
  public static Offset<Schale.FlatData.MiniGameRhythmExcel> CreateMiniGameRhythmExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long RhythmBgmId = 0,
      StringOffset PresetNameOffset = default(StringOffset),
      Schale.FlatData.Difficulty StageDifficulty = Schale.FlatData.Difficulty.Normal,
  ...
  public static void AddStageDifficulty(FlatBufferBuilder builder, Schale.FlatData.Difficulty stageDifficulty) { builder.AddInt(3, (int)stageDifficulty, 0); }
  ...
  public static Offset<Schale.FlatData.MiniGameRhythmExcel> EndMiniGameRhythmExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MiniGameRhythmExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MiniGameRhythmExcel> Pack(FlatBufferBuilder builder, MiniGameRhythmExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MiniGameRhythmExcel>);
...
public class MiniGameRhythmExcelT
{
  ...
  public Schale.FlatData.Difficulty StageDifficulty { get; set; }
  ...
  public MiniGameRhythmExcelT() {
    ...
    this.StageDifficulty = Schale.FlatData.Difficulty.Normal;
...
static public class MiniGameRhythmExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*StageDifficulty*/, 4 /*Schale.FlatData.Difficulty*/, 4, false)
