...
public struct MiniGameTBGThemaRewardExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.MiniGameTBGThemaRewardType MiniGameTBGThemaRewardType { get { int o = __p.__offset(12); return o != 0 ? (Schale.FlatData.MiniGameTBGThemaRewardType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.MiniGameTBGThemaRewardType.TreasureReward; } }
  ...
  public static Offset<Schale.FlatData.MiniGameTBGThemaRewardExcel> CreateMiniGameTBGThemaRewardExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      int ThemaRound = 0,
      int ThemaUniqueId = 0,
      bool IsLoop = false,
      Schale.FlatData.MiniGameTBGThemaRewardType MiniGameTBGThemaRewardType = Schale.FlatData.MiniGameTBGThemaRewardType.TreasureReward,
  ...
  public static void AddMiniGameTBGThemaRewardType(FlatBufferBuilder builder, Schale.FlatData.MiniGameTBGThemaRewardType miniGameTBGThemaRewardType) { builder.AddInt(4, (int)miniGameTBGThemaRewardType, 0); }
  ...
  public static Offset<Schale.FlatData.MiniGameTBGThemaRewardExcel> EndMiniGameTBGThemaRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MiniGameTBGThemaRewardExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MiniGameTBGThemaRewardExcel> Pack(FlatBufferBuilder builder, MiniGameTBGThemaRewardExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MiniGameTBGThemaRewardExcel>);
...
public class MiniGameTBGThemaRewardExcelT
{
  ...
  public Schale.FlatData.MiniGameTBGThemaRewardType MiniGameTBGThemaRewardType { get; set; }
  ...
  public MiniGameTBGThemaRewardExcelT() {
    ...
    this.IsLoop = false;
    this.MiniGameTBGThemaRewardType = Schale.FlatData.MiniGameTBGThemaRewardType.TreasureReward;
...
static public class MiniGameTBGThemaRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*MiniGameTBGThemaRewardType*/, 4 /*Schale.FlatData.MiniGameTBGThemaRewardType*/, 4, false)
