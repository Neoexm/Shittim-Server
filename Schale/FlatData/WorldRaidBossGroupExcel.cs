...
public struct WorldRaidBossGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.WorldRaidBossGroupExcel> CreateWorldRaidBossGroupExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Schale.FlatData.WorldRaidBossGroupExcel> EndWorldRaidBossGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.WorldRaidBossGroupExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.WorldRaidBossGroupExcel> Pack(FlatBufferBuilder builder, WorldRaidBossGroupExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.WorldRaidBossGroupExcel>);
