...
public struct CharacterLevelStatFactorExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.CharacterLevelStatFactorExcel> CreateCharacterLevelStatFactorExcel(FlatBufferBuilder builder,
      long Level = 0,
  ...
  public static Offset<Schale.FlatData.CharacterLevelStatFactorExcel> EndCharacterLevelStatFactorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CharacterLevelStatFactorExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.CharacterLevelStatFactorExcel> Pack(FlatBufferBuilder builder, CharacterLevelStatFactorExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.CharacterLevelStatFactorExcel>);
