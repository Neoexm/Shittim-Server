...
public struct RecipeSelectionGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.RecipeSelectionGroupExcel> CreateRecipeSelectionGroupExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.RecipeSelectionGroupExcel> EndRecipeSelectionGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.RecipeSelectionGroupExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.RecipeSelectionGroupExcel> Pack(FlatBufferBuilder builder, RecipeSelectionGroupExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.RecipeSelectionGroupExcel>);
