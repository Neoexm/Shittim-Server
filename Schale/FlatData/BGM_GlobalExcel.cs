...
public struct BGM_GlobalExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.BGM_GlobalExcel> EndBGM_GlobalExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.BGM_GlobalExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.BGM_GlobalExcel> Pack(FlatBufferBuilder builder, BGM_GlobalExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.BGM_GlobalExcel>);
