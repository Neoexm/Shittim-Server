...
public struct ConquestUnexpectedEventExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ParcelType UnexpectedEventConditionType { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.ConquestUnexpectedEventExcel> CreateConquestUnexpectedEventExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      Schale.FlatData.ParcelType UnexpectedEventConditionType = Schale.FlatData.ParcelType.None,
  ...
  public static void AddUnexpectedEventConditionType(FlatBufferBuilder builder, Schale.FlatData.ParcelType unexpectedEventConditionType) { builder.AddInt(1, (int)unexpectedEventConditionType, 0); }
  ...
  public static Offset<Schale.FlatData.ConquestUnexpectedEventExcel> EndConquestUnexpectedEventExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ConquestUnexpectedEventExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ConquestUnexpectedEventExcel> Pack(FlatBufferBuilder builder, ConquestUnexpectedEventExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ConquestUnexpectedEventExcel>);
...
public class ConquestUnexpectedEventExcelT
{
  ...
  public Schale.FlatData.ParcelType UnexpectedEventConditionType { get; set; }
  ...
  public ConquestUnexpectedEventExcelT() {
    ...
    this.UnexpectedEventConditionType = Schale.FlatData.ParcelType.None;
...
static public class ConquestUnexpectedEventExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*UnexpectedEventConditionType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
