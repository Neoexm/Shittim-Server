...
public struct ProtocolSettingExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.OpenConditionContent OpenConditionContent { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.OpenConditionContent)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.OpenConditionContent.Shop; } }
  ...
  public static Offset<Schale.FlatData.ProtocolSettingExcel> CreateProtocolSettingExcel(FlatBufferBuilder builder,
  ...
  public static void AddOpenConditionContent(FlatBufferBuilder builder, Schale.FlatData.OpenConditionContent openConditionContent) { builder.AddInt(1, (int)openConditionContent, 0); }
  ...
  public static Offset<Schale.FlatData.ProtocolSettingExcel> EndProtocolSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ProtocolSettingExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ProtocolSettingExcel> Pack(FlatBufferBuilder builder, ProtocolSettingExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ProtocolSettingExcel>);
...
static public class ProtocolSettingExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*OpenConditionContent*/, 4 /*Schale.FlatData.OpenConditionContent*/, 4, false)
