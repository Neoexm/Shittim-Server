...
public struct SchoolDungeonStageExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.SchoolDungeonType DungeonType { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.SchoolDungeonType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.SchoolDungeonType.SchoolA; } }
  ...
  public Schale.FlatData.ParcelType StageEnterCostType(int j) { int o = __p.__offset(14); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.ParcelType)0; }
  public int StageEnterCostTypeLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.ParcelType> GetStageEnterCostTypeBytes() { return __p.__vector_as_span<Schale.FlatData.ParcelType>(14, 4); }
#else
  public ArraySegment<byte>? GetStageEnterCostTypeBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public Schale.FlatData.ParcelType[] GetStageEnterCostTypeArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.ParcelType[] a = new Schale.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Schale.FlatData.StarGoalType StarGoal(int j) { int o = __p.__offset(24); return o != 0 ? (Schale.FlatData.StarGoalType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.StarGoalType)0; }
  public int StarGoalLength { get { int o = __p.__offset(24); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.StarGoalType> GetStarGoalBytes() { return __p.__vector_as_span<Schale.FlatData.StarGoalType>(24, 4); }
#else
  public ArraySegment<byte>? GetStarGoalBytes() { return __p.__vector_as_arraysegment(24); }
#endif
  public Schale.FlatData.StarGoalType[] GetStarGoalArray() { int o = __p.__offset(24); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.StarGoalType[] a = new Schale.FlatData.StarGoalType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.StarGoalType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Schale.FlatData.StageTopography StageTopography { get { int o = __p.__offset(28); return o != 0 ? (Schale.FlatData.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.StageTopography.Street; } }
  ...
  public Schale.FlatData.EchelonExtensionType EchelonExtensionType { get { int o = __p.__offset(36); return o != 0 ? (Schale.FlatData.EchelonExtensionType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.EchelonExtensionType.Base; } }

  public static Offset<Schale.FlatData.SchoolDungeonStageExcel> CreateSchoolDungeonStageExcel(FlatBufferBuilder builder,
      long StageId = 0,
      Schale.FlatData.SchoolDungeonType DungeonType = Schale.FlatData.SchoolDungeonType.SchoolA,
      int Difficulty = 0,
  ...
  public static void AddDungeonType(FlatBufferBuilder builder, Schale.FlatData.SchoolDungeonType dungeonType) { builder.AddInt(1, (int)dungeonType, 0); }
  ...
  public static VectorOffset CreateStageEnterCostTypeVector(FlatBufferBuilder builder, Schale.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateStageEnterCostTypeVectorBlock(FlatBufferBuilder builder, Schale.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStageEnterCostTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStageEnterCostTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, Schale.FlatData.StageTopography stageTopography) { builder.AddInt(12, (int)stageTopography, 0); }
  ...
  public static void AddEchelonExtensionType(FlatBufferBuilder builder, Schale.FlatData.EchelonExtensionType echelonExtensionType) { builder.AddInt(16, (int)echelonExtensionType, 0); }
  public static Offset<Schale.FlatData.SchoolDungeonStageExcel> EndSchoolDungeonStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.SchoolDungeonStageExcel>(o);
  }
  ...
  public void UnPackTo(SchoolDungeonStageExcelT _o) {
    ...
    _o.StageEnterCostType = new List<Schale.FlatData.ParcelType>();
  ...
  public static Offset<Schale.FlatData.SchoolDungeonStageExcel> Pack(FlatBufferBuilder builder, SchoolDungeonStageExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.SchoolDungeonStageExcel>);
...
public class SchoolDungeonStageExcelT
{
  ...
  public Schale.FlatData.SchoolDungeonType DungeonType { get; set; }
  public int Difficulty { get; set; }
  public long BattleDuration { get; set; }
  public long PrevStageId { get; set; }
  public List<Schale.FlatData.ParcelType> StageEnterCostType { get; set; }
  ...
  public SchoolDungeonStageExcelT() {
    this.StageId = 0;
    this.DungeonType = Schale.FlatData.SchoolDungeonType.SchoolA;
    this.Difficulty = 0;
...
static public class SchoolDungeonStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*DungeonType*/, 4 /*Schale.FlatData.SchoolDungeonType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 14 /*StageEnterCostType*/, 4 /*Schale.FlatData.ParcelType*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 24 /*StarGoal*/, 4 /*Schale.FlatData.StarGoalType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 26 /*StarGoalAmount*/, 4 /*int*/, false)
      && verifier.VerifyField(tablePos, 28 /*StageTopography*/, 4 /*Schale.FlatData.StageTopography*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 36 /*EchelonExtensionType*/, 4 /*Schale.FlatData.EchelonExtensionType*/, 4, false)
