...
public struct LoadingImageExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.LoadingImageExcel> CreateLoadingImageExcel(FlatBufferBuilder builder,
      long ID = 0,
  ...
  public static Offset<Schale.FlatData.LoadingImageExcel> EndLoadingImageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.LoadingImageExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.LoadingImageExcel> Pack(FlatBufferBuilder builder, LoadingImageExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.LoadingImageExcel>);
