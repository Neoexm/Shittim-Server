...
public struct LimitedStageSeasonExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.LimitedStageSeasonExcel> CreateLimitedStageSeasonExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Schale.FlatData.LimitedStageSeasonExcel> EndLimitedStageSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.LimitedStageSeasonExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.LimitedStageSeasonExcel> Pack(FlatBufferBuilder builder, LimitedStageSeasonExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.LimitedStageSeasonExcel>);
