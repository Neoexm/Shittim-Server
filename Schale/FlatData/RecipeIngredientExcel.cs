...
public struct RecipeIngredientExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.RecipeType RecipeType { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.RecipeType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.RecipeType.None; } }
  public Schale.FlatData.ParcelType CostParcelType(int j) { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.ParcelType)0; }
  public int CostParcelTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.ParcelType> GetCostParcelTypeBytes() { return __p.__vector_as_span<Schale.FlatData.ParcelType>(8, 4); }
#else
  public ArraySegment<byte>? GetCostParcelTypeBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public Schale.FlatData.ParcelType[] GetCostParcelTypeArray() { int o = __p.__offset(8); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.ParcelType[] a = new Schale.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Schale.FlatData.ParcelType IngredientParcelType(int j) { int o = __p.__offset(14); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.ParcelType)0; }
  public int IngredientParcelTypeLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.ParcelType> GetIngredientParcelTypeBytes() { return __p.__vector_as_span<Schale.FlatData.ParcelType>(14, 4); }
#else
  public ArraySegment<byte>? GetIngredientParcelTypeBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public Schale.FlatData.ParcelType[] GetIngredientParcelTypeArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.ParcelType[] a = new Schale.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.RecipeIngredientExcel> CreateRecipeIngredientExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddRecipeType(FlatBufferBuilder builder, Schale.FlatData.RecipeType recipeType) { builder.AddInt(1, (int)recipeType, 0); }
  ...
  public static VectorOffset CreateIngredientParcelTypeVector(FlatBufferBuilder builder, Schale.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateIngredientParcelTypeVectorBlock(FlatBufferBuilder builder, Schale.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateIngredientParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateIngredientParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Schale.FlatData.RecipeIngredientExcel> EndRecipeIngredientExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.RecipeIngredientExcel>(o);
  }
  ...
  public void UnPackTo(RecipeIngredientExcelT _o) {
    ...
    _o.IngredientParcelType = new List<Schale.FlatData.ParcelType>();
  ...
  public static Offset<Schale.FlatData.RecipeIngredientExcel> Pack(FlatBufferBuilder builder, RecipeIngredientExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.RecipeIngredientExcel>);
...
public class RecipeIngredientExcelT
{
  ...
  public List<Schale.FlatData.ParcelType> IngredientParcelType { get; set; }
...
static public class RecipeIngredientExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*RecipeType*/, 4 /*Schale.FlatData.RecipeType*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 8 /*CostParcelType*/, 4 /*Schale.FlatData.ParcelType*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 14 /*IngredientParcelType*/, 4 /*Schale.FlatData.ParcelType*/, false)
