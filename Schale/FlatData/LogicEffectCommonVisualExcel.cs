...
public struct LogicEffectCommonVisualExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.EffectBone ParticleEnterSocket { get { int o = __p.__offset(12); return o != 0 ? (Schale.FlatData.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.EffectBone.None; } }
  ...
  public Schale.FlatData.EffectBone ParticleLoopSocket { get { int o = __p.__offset(16); return o != 0 ? (Schale.FlatData.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.EffectBone.None; } }
  ...
  public Schale.FlatData.EffectBone ParticleEndSocket { get { int o = __p.__offset(20); return o != 0 ? (Schale.FlatData.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.EffectBone.None; } }
  ...
  public Schale.FlatData.EffectBone ParticleApplySocket { get { int o = __p.__offset(24); return o != 0 ? (Schale.FlatData.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.EffectBone.None; } }
  ...
  public Schale.FlatData.EffectBone ParticleRemovedSocket { get { int o = __p.__offset(28); return o != 0 ? (Schale.FlatData.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.EffectBone.None; } }

  public static Offset<Schale.FlatData.LogicEffectCommonVisualExcel> CreateLogicEffectCommonVisualExcel(FlatBufferBuilder builder,
      uint StringID = 0,
      ...
      Schale.FlatData.EffectBone ParticleEnterSocket = Schale.FlatData.EffectBone.None,
      StringOffset ParticleLoopPathOffset = default(StringOffset),
      Schale.FlatData.EffectBone ParticleLoopSocket = Schale.FlatData.EffectBone.None,
      StringOffset ParticleEndPathOffset = default(StringOffset),
      Schale.FlatData.EffectBone ParticleEndSocket = Schale.FlatData.EffectBone.None,
      StringOffset ParticleApplyPathOffset = default(StringOffset),
      Schale.FlatData.EffectBone ParticleApplySocket = Schale.FlatData.EffectBone.None,
      StringOffset ParticleRemovedPathOffset = default(StringOffset),
      Schale.FlatData.EffectBone ParticleRemovedSocket = Schale.FlatData.EffectBone.None) {
  ...
  public static void AddParticleEnterSocket(FlatBufferBuilder builder, Schale.FlatData.EffectBone particleEnterSocket) { builder.AddInt(4, (int)particleEnterSocket, 0); }
  ...
  public static void AddParticleLoopSocket(FlatBufferBuilder builder, Schale.FlatData.EffectBone particleLoopSocket) { builder.AddInt(6, (int)particleLoopSocket, 0); }
  ...
  public static void AddParticleEndSocket(FlatBufferBuilder builder, Schale.FlatData.EffectBone particleEndSocket) { builder.AddInt(8, (int)particleEndSocket, 0); }
  ...
  public static void AddParticleApplySocket(FlatBufferBuilder builder, Schale.FlatData.EffectBone particleApplySocket) { builder.AddInt(10, (int)particleApplySocket, 0); }
  ...
  public static void AddParticleRemovedSocket(FlatBufferBuilder builder, Schale.FlatData.EffectBone particleRemovedSocket) { builder.AddInt(12, (int)particleRemovedSocket, 0); }
  public static Offset<Schale.FlatData.LogicEffectCommonVisualExcel> EndLogicEffectCommonVisualExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.LogicEffectCommonVisualExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.LogicEffectCommonVisualExcel> Pack(FlatBufferBuilder builder, LogicEffectCommonVisualExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.LogicEffectCommonVisualExcel>);
...
public class LogicEffectCommonVisualExcelT
{
  ...
  public Schale.FlatData.EffectBone ParticleEnterSocket { get; set; }
  public string ParticleLoopPath { get; set; }
  public Schale.FlatData.EffectBone ParticleLoopSocket { get; set; }
  public string ParticleEndPath { get; set; }
  public Schale.FlatData.EffectBone ParticleEndSocket { get; set; }
  public string ParticleApplyPath { get; set; }
  public Schale.FlatData.EffectBone ParticleApplySocket { get; set; }
  public string ParticleRemovedPath { get; set; }
  public Schale.FlatData.EffectBone ParticleRemovedSocket { get; set; }
  ...
  public LogicEffectCommonVisualExcelT() {
    ...
    this.ParticleEnterSocket = Schale.FlatData.EffectBone.None;
    this.ParticleLoopPath = null;
    this.ParticleLoopSocket = Schale.FlatData.EffectBone.None;
    this.ParticleEndPath = null;
    this.ParticleEndSocket = Schale.FlatData.EffectBone.None;
    this.ParticleApplyPath = null;
    this.ParticleApplySocket = Schale.FlatData.EffectBone.None;
    this.ParticleRemovedPath = null;
    this.ParticleRemovedSocket = Schale.FlatData.EffectBone.None;
  }
}
...
static public class LogicEffectCommonVisualExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*ParticleEnterSocket*/, 4 /*Schale.FlatData.EffectBone*/, 4, false)
      && verifier.VerifyString(tablePos, 14 /*ParticleLoopPath*/, false)
      && verifier.VerifyField(tablePos, 16 /*ParticleLoopSocket*/, 4 /*Schale.FlatData.EffectBone*/, 4, false)
      && verifier.VerifyString(tablePos, 18 /*ParticleEndPath*/, false)
      && verifier.VerifyField(tablePos, 20 /*ParticleEndSocket*/, 4 /*Schale.FlatData.EffectBone*/, 4, false)
      && verifier.VerifyString(tablePos, 22 /*ParticleApplyPath*/, false)
      && verifier.VerifyField(tablePos, 24 /*ParticleApplySocket*/, 4 /*Schale.FlatData.EffectBone*/, 4, false)
      && verifier.VerifyString(tablePos, 26 /*ParticleRemovedPath*/, false)
      && verifier.VerifyField(tablePos, 28 /*ParticleRemovedSocket*/, 4 /*Schale.FlatData.EffectBone*/, 4, false)
