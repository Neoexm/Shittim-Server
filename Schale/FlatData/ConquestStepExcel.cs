...
public struct ConquestStepExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.StageDifficulty MapDifficulty { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.StageDifficulty)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.StageDifficulty.None; } }
  ...
  public Schale.FlatData.ParcelType StepEnterItemType { get { int o = __p.__offset(14); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.ConquestStepExcel> CreateConquestStepExcel(FlatBufferBuilder builder,
      ...
      Schale.FlatData.ParcelType StepEnterItemType = Schale.FlatData.ParcelType.None,
  ...
  public static void AddMapDifficulty(FlatBufferBuilder builder, Schale.FlatData.StageDifficulty mapDifficulty) { builder.AddInt(1, (int)mapDifficulty, 0); }
  ...
  public static void AddStepEnterItemType(FlatBufferBuilder builder, Schale.FlatData.ParcelType stepEnterItemType) { builder.AddInt(5, (int)stepEnterItemType, 0); }
  ...
  public static Offset<Schale.FlatData.ConquestStepExcel> EndConquestStepExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ConquestStepExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ConquestStepExcel> Pack(FlatBufferBuilder builder, ConquestStepExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ConquestStepExcel>);
...
public class ConquestStepExcelT
{
  ...
  public Schale.FlatData.ParcelType StepEnterItemType { get; set; }
  ...
  public ConquestStepExcelT() {
    ...
    this.StepEnterItemType = Schale.FlatData.ParcelType.None;
...
static public class ConquestStepExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*MapDifficulty*/, 4 /*Schale.FlatData.StageDifficulty*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 14 /*StepEnterItemType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
