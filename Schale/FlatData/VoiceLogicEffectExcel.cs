...
public struct VoiceLogicEffectExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.VoiceLogicEffectExcel> CreateVoiceLogicEffectExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.VoiceLogicEffectExcel> EndVoiceLogicEffectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.VoiceLogicEffectExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.VoiceLogicEffectExcel> Pack(FlatBufferBuilder builder, VoiceLogicEffectExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.VoiceLogicEffectExcel>);
