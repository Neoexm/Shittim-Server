...
public struct ContentsShortcutExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.StageDifficulty ConquestMapDifficulty { get { int o = __p.__offset(20); return o != 0 ? (Schale.FlatData.StageDifficulty)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.StageDifficulty.None; } }
  ...
  public static Offset<Schale.FlatData.ContentsShortcutExcel> CreateContentsShortcutExcel(FlatBufferBuilder builder,
      ...
      Schale.FlatData.StageDifficulty ConquestMapDifficulty = Schale.FlatData.StageDifficulty.None,
  ...
  public static void AddConquestMapDifficulty(FlatBufferBuilder builder, Schale.FlatData.StageDifficulty conquestMapDifficulty) { builder.AddInt(8, (int)conquestMapDifficulty, 0); }
  ...
  public static Offset<Schale.FlatData.ContentsShortcutExcel> Pack(FlatBufferBuilder builder, ContentsShortcutExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ContentsShortcutExcel>);
...
public class ContentsShortcutExcelT
{
  ...
  public Schale.FlatData.StageDifficulty ConquestMapDifficulty { get; set; }
  ...
  public ContentsShortcutExcelT() {
    ...
    this.ConquestMapDifficulty = Schale.FlatData.StageDifficulty.None;
...
static public class ContentsShortcutExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*ConquestMapDifficulty*/, 4 /*Schale.FlatData.StageDifficulty*/, 4, false)
