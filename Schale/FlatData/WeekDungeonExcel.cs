...
public struct WeekDungeonExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.WeekDungeonType WeekDungeonType { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.WeekDungeonType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.WeekDungeonType.None; } }
  ...
  public Schale.FlatData.StarGoalType StarGoal(int j) { int o = __p.__offset(22); return o != 0 ? (Schale.FlatData.StarGoalType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.StarGoalType)0; }
  public int StarGoalLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.StarGoalType> GetStarGoalBytes() { return __p.__vector_as_span<Schale.FlatData.StarGoalType>(22, 4); }
#else
  public ArraySegment<byte>? GetStarGoalBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public Schale.FlatData.StarGoalType[] GetStarGoalArray() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.StarGoalType[] a = new Schale.FlatData.StarGoalType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.StarGoalType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Schale.FlatData.StageTopography StageTopography { get { int o = __p.__offset(26); return o != 0 ? (Schale.FlatData.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.StageTopography.Street; } }
  ...
  public Schale.FlatData.EchelonExtensionType EchelonExtensionType { get { int o = __p.__offset(40); return o != 0 ? (Schale.FlatData.EchelonExtensionType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.EchelonExtensionType.Base; } }

  public static Offset<Schale.FlatData.WeekDungeonExcel> CreateWeekDungeonExcel(FlatBufferBuilder builder,
      long StageId = 0,
      Schale.FlatData.WeekDungeonType WeekDungeonType = Schale.FlatData.WeekDungeonType.None,
      int Difficulty = 0,
  ...
  public static void AddWeekDungeonType(FlatBufferBuilder builder, Schale.FlatData.WeekDungeonType weekDungeonType) { builder.AddInt(1, (int)weekDungeonType, 0); }
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, Schale.FlatData.StageTopography stageTopography) { builder.AddInt(11, (int)stageTopography, 0); }
  ...
  public static void AddEchelonExtensionType(FlatBufferBuilder builder, Schale.FlatData.EchelonExtensionType echelonExtensionType) { builder.AddInt(18, (int)echelonExtensionType, 0); }
  public static Offset<Schale.FlatData.WeekDungeonExcel> EndWeekDungeonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.WeekDungeonExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.WeekDungeonExcel> Pack(FlatBufferBuilder builder, WeekDungeonExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.WeekDungeonExcel>);
...
public class WeekDungeonExcelT
{
  ...
  public Schale.FlatData.WeekDungeonType WeekDungeonType { get; set; }
  ...
  public WeekDungeonExcelT() {
    this.StageId = 0;
    this.WeekDungeonType = Schale.FlatData.WeekDungeonType.None;
    this.Difficulty = 0;
...
static public class WeekDungeonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*WeekDungeonType*/, 4 /*Schale.FlatData.WeekDungeonType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 22 /*StarGoal*/, 4 /*Schale.FlatData.StarGoalType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 24 /*StarGoalAmount*/, 4 /*int*/, false)
      && verifier.VerifyField(tablePos, 26 /*StageTopography*/, 4 /*Schale.FlatData.StageTopography*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 40 /*EchelonExtensionType*/, 4 /*Schale.FlatData.EchelonExtensionType*/, 4, false)
