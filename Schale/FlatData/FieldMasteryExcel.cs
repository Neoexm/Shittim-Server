...
public struct FieldMasteryExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ParcelType TokenType { get { int o = __p.__offset(12); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public Schale.FlatData.FieldConditionType AccomplishmentConditionType { get { int o = __p.__offset(18); return o != 0 ? (Schale.FlatData.FieldConditionType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.FieldConditionType.Invalid; } }
  public long AccomplishmentConditionId { get { int o = __p.__offset(20); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }

  public static Offset<Schale.FlatData.FieldMasteryExcel> CreateFieldMasteryExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long SeasonId = 0,
      int Order = 0,
      long ExpAmount = 0,
      Schale.FlatData.ParcelType TokenType = Schale.FlatData.ParcelType.None,
      long TokenId = 0,
      long TokenRequirement = 0,
      Schale.FlatData.FieldConditionType AccomplishmentConditionType = Schale.FlatData.FieldConditionType.Invalid,
  ...
  public static void AddTokenType(FlatBufferBuilder builder, Schale.FlatData.ParcelType tokenType) { builder.AddInt(4, (int)tokenType, 0); }
  ...
  public static void AddAccomplishmentConditionType(FlatBufferBuilder builder, Schale.FlatData.FieldConditionType accomplishmentConditionType) { builder.AddInt(7, (int)accomplishmentConditionType, 0); }
  ...
  public static Offset<Schale.FlatData.FieldMasteryExcel> EndFieldMasteryExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.FieldMasteryExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.FieldMasteryExcel> Pack(FlatBufferBuilder builder, FieldMasteryExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.FieldMasteryExcel>);
...
public class FieldMasteryExcelT
{
  ...
  public Schale.FlatData.ParcelType TokenType { get; set; }
  public long TokenId { get; set; }
  public long TokenRequirement { get; set; }
  public Schale.FlatData.FieldConditionType AccomplishmentConditionType { get; set; }
  ...
  public FieldMasteryExcelT() {
    ...
    this.Order = 0;
    this.ExpAmount = 0;
    this.TokenType = Schale.FlatData.ParcelType.None;
    this.TokenId = 0;
    this.TokenRequirement = 0;
    this.AccomplishmentConditionType = Schale.FlatData.FieldConditionType.Invalid;
...
static public class FieldMasteryExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*TokenType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*TokenId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 16 /*TokenRequirement*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 18 /*AccomplishmentConditionType*/, 4 /*Schale.FlatData.FieldConditionType*/, 4, false)
