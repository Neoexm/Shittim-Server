...
public struct GroundVector3 : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.GroundVector3> EndGroundVector3(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.GroundVector3>(o);
  }
  ...
  public static Offset<Schale.FlatData.GroundVector3> Pack(FlatBufferBuilder builder, GroundVector3T _o) {
    if (_o == null) return default(Offset<Schale.FlatData.GroundVector3>);
