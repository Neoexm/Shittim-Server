...
public struct FavorLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.FavorLevelExcel> CreateFavorLevelExcel(FlatBufferBuilder builder,
      long Level = 0,
  ...
  public static Offset<Schale.FlatData.FavorLevelExcel> EndFavorLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.FavorLevelExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.FavorLevelExcel> Pack(FlatBufferBuilder builder, FavorLevelExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.FavorLevelExcel>);
