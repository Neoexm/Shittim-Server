...
public struct CampaignUnitExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.StrategyAIType AIMoveType { get { int o = __p.__offset(22); return o != 0 ? (Schale.FlatData.StrategyAIType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.StrategyAIType.None; } }
  public Schale.FlatData.HexaUnitGrade Grade { get { int o = __p.__offset(24); return o != 0 ? (Schale.FlatData.HexaUnitGrade)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.HexaUnitGrade.Grade1; } }
  public Schale.FlatData.TacticEnvironment EnvironmentType { get { int o = __p.__offset(26); return o != 0 ? (Schale.FlatData.TacticEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.TacticEnvironment.None; } }
  ...
  public static Offset<Schale.FlatData.CampaignUnitExcel> CreateCampaignUnitExcel(FlatBufferBuilder builder,
      long Id = 0,
      uint Key = 0,
      ...
      long GroundId = 0,
      int MoveRange = 0,
      Schale.FlatData.StrategyAIType AIMoveType = Schale.FlatData.StrategyAIType.None,
      Schale.FlatData.HexaUnitGrade Grade = Schale.FlatData.HexaUnitGrade.Grade1,
      Schale.FlatData.TacticEnvironment EnvironmentType = Schale.FlatData.TacticEnvironment.None,
      float Scale = 0.0f,
  ...
  public static void AddAIMoveType(FlatBufferBuilder builder, Schale.FlatData.StrategyAIType aIMoveType) { builder.AddInt(9, (int)aIMoveType, 0); }
  public static void AddGrade(FlatBufferBuilder builder, Schale.FlatData.HexaUnitGrade grade) { builder.AddInt(10, (int)grade, 0); }
  public static void AddEnvironmentType(FlatBufferBuilder builder, Schale.FlatData.TacticEnvironment environmentType) { builder.AddInt(11, (int)environmentType, 0); }
  ...
  public static Offset<Schale.FlatData.CampaignUnitExcel> EndCampaignUnitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CampaignUnitExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.CampaignUnitExcel> Pack(FlatBufferBuilder builder, CampaignUnitExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.CampaignUnitExcel>);
...
public class CampaignUnitExcelT
{
  ...
  public Schale.FlatData.StrategyAIType AIMoveType { get; set; }
  public Schale.FlatData.HexaUnitGrade Grade { get; set; }
  public Schale.FlatData.TacticEnvironment EnvironmentType { get; set; }
  ...
  public CampaignUnitExcelT() {
    ...
    this.GroundId = 0;
    this.MoveRange = 0;
    this.AIMoveType = Schale.FlatData.StrategyAIType.None;
    this.Grade = Schale.FlatData.HexaUnitGrade.Grade1;
    this.EnvironmentType = Schale.FlatData.TacticEnvironment.None;
    this.Scale = 0.0f;
...
static public class CampaignUnitExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*AIMoveType*/, 4 /*Schale.FlatData.StrategyAIType*/, 4, false)
      && verifier.VerifyField(tablePos, 24 /*Grade*/, 4 /*Schale.FlatData.HexaUnitGrade*/, 4, false)
      && verifier.VerifyField(tablePos, 26 /*EnvironmentType*/, 4 /*Schale.FlatData.TacticEnvironment*/, 4, false)
