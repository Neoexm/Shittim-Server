...
public struct AccountLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.AccountLevelExcel> CreateAccountLevelExcel(FlatBufferBuilder builder,
      long Id = 0,
      long Level = 0,
      long Exp = 0,
  ...
  public static Offset<Schale.FlatData.AccountLevelExcel> EndAccountLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.AccountLevelExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.AccountLevelExcel> Pack(FlatBufferBuilder builder, AccountLevelExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.AccountLevelExcel>);
