...
public struct CharacterVoiceExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.CVCollectionType CVCollectionType { get { int o = __p.__offset(18); return o != 0 ? (Schale.FlatData.CVCollectionType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.CVCollectionType.CVNormal; } }
  ...
  public Schale.FlatData.Nation Nation(int j) { int o = __p.__offset(24); return o != 0 ? (Schale.FlatData.Nation)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.Nation)0; }
  public int NationLength { get { int o = __p.__offset(24); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.Nation> GetNationBytes() { return __p.__vector_as_span<Schale.FlatData.Nation>(24, 4); }
#else
  public ArraySegment<byte>? GetNationBytes() { return __p.__vector_as_arraysegment(24); }
#endif
  public Schale.FlatData.Nation[] GetNationArray() { int o = __p.__offset(24); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.Nation[] a = new Schale.FlatData.Nation[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.Nation)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.CharacterVoiceExcel> CreateCharacterVoiceExcel(FlatBufferBuilder builder,
  ...
  public static void AddCVCollectionType(FlatBufferBuilder builder, Schale.FlatData.CVCollectionType cVCollectionType) { builder.AddInt(7, (int)cVCollectionType, 0); }
  ...
  public static Offset<Schale.FlatData.CharacterVoiceExcel> EndCharacterVoiceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CharacterVoiceExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.CharacterVoiceExcel> Pack(FlatBufferBuilder builder, CharacterVoiceExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.CharacterVoiceExcel>);
...
static public class CharacterVoiceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 18 /*CVCollectionType*/, 4 /*Schale.FlatData.CVCollectionType*/, 4, false)
      && verifier.VerifyField(tablePos, 20 /*UnlockFavorRank*/, 8 /*long*/, 8, false)
      && verifier.VerifyString(tablePos, 22 /*LocalizeCVGroup*/, false)
      && verifier.VerifyVectorOfData(tablePos, 24 /*Nation*/, 4 /*Schale.FlatData.Nation*/, false)
