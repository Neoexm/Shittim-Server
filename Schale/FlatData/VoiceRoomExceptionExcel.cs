...
public struct VoiceRoomExceptionExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.CVPrintType LinkedCharacterVoicePrintType { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.CVPrintType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.CVPrintType.CharacterOverwrite; } }
  public long LinkedCostumeUniqueId { get { int o = __p.__offset(8); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }

  public static Offset<Schale.FlatData.VoiceRoomExceptionExcel> CreateVoiceRoomExceptionExcel(FlatBufferBuilder builder,
      long CostumeUniqueId = 0,
      Schale.FlatData.CVPrintType LinkedCharacterVoicePrintType = Schale.FlatData.CVPrintType.CharacterOverwrite,
  ...
  public static void AddLinkedCharacterVoicePrintType(FlatBufferBuilder builder, Schale.FlatData.CVPrintType linkedCharacterVoicePrintType) { builder.AddInt(1, (int)linkedCharacterVoicePrintType, 0); }
  ...
  public static Offset<Schale.FlatData.VoiceRoomExceptionExcel> EndVoiceRoomExceptionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.VoiceRoomExceptionExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.VoiceRoomExceptionExcel> Pack(FlatBufferBuilder builder, VoiceRoomExceptionExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.VoiceRoomExceptionExcel>);
...
public class VoiceRoomExceptionExcelT
{
  ...
  public Schale.FlatData.CVPrintType LinkedCharacterVoicePrintType { get; set; }
  public long LinkedCostumeUniqueId { get; set; }

  public VoiceRoomExceptionExcelT() {
    this.CostumeUniqueId = 0;
    this.LinkedCharacterVoicePrintType = Schale.FlatData.CVPrintType.CharacterOverwrite;
...
static public class VoiceRoomExceptionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*LinkedCharacterVoicePrintType*/, 4 /*Schale.FlatData.CVPrintType*/, 4, false)
