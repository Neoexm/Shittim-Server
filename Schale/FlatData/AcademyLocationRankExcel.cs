...
public struct AcademyLocationRankExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.AcademyLocationRankExcel> CreateAcademyLocationRankExcel(FlatBufferBuilder builder,
      long Rank = 0,
      long RankExp = 0,
      long TotalExp = 0) {
  ...
  public static Offset<Schale.FlatData.AcademyLocationRankExcel> EndAcademyLocationRankExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.AcademyLocationRankExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.AcademyLocationRankExcel> Pack(FlatBufferBuilder builder, AcademyLocationRankExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.AcademyLocationRankExcel>);
