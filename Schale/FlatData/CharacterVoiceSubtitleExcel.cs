...
public struct CharacterVoiceSubtitleExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.CharacterVoiceSubtitleExcel> CreateCharacterVoiceSubtitleExcel(FlatBufferBuilder builder,
      StringOffset LocalizeCVGroupOffset = default(StringOffset),
      long CharacterVoiceGroupId = 0,
      StringOffset TLM_IDOffset = default(StringOffset),
      long Duration = 0,
      long Duration_kr = 0,
      bool Separate = false,
    ...
    CharacterVoiceSubtitleExcel.AddDurationKr(builder, Duration_kr);
    ...
    CharacterVoiceSubtitleExcel.AddLocalizeEN(builder, Localize_ENOffset);
    CharacterVoiceSubtitleExcel.AddLocalizeTW(builder, Localize_TWOffset);
    CharacterVoiceSubtitleExcel.AddLocalizeTH(builder, Localize_THOffset);
    CharacterVoiceSubtitleExcel.AddLocalizeJP(builder, Localize_JPOffset);
    CharacterVoiceSubtitleExcel.AddLocalizeKR(builder, Localize_KROffset);
    CharacterVoiceSubtitleExcel.AddTLMID(builder, TLM_IDOffset);
  ...
  public static Offset<Schale.FlatData.CharacterVoiceSubtitleExcel> EndCharacterVoiceSubtitleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CharacterVoiceSubtitleExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.CharacterVoiceSubtitleExcel> Pack(FlatBufferBuilder builder, CharacterVoiceSubtitleExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.CharacterVoiceSubtitleExcel>);
    var _LocalizeCVGroup = _o.LocalizeCVGroup == null ? default(StringOffset) : builder.CreateString(_o.LocalizeCVGroup);
    var _TLM_ID = _o.TLMID == null ? default(StringOffset) : builder.CreateString(_o.TLMID);
