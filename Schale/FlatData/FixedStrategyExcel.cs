...
public struct FixedStrategyExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.FixedStrategyExcel> EndFixedStrategyExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.FixedStrategyExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.FixedStrategyExcel> Pack(FlatBufferBuilder builder, FixedStrategyExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.FixedStrategyExcel>);
