...
public struct ArenaRewardExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ArenaRewardType ArenaRewardType { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.ArenaRewardType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ArenaRewardType.None; } }
  ...
  public static Offset<Schale.FlatData.ArenaRewardExcel> CreateArenaRewardExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      Schale.FlatData.ArenaRewardType ArenaRewardType = Schale.FlatData.ArenaRewardType.None,
      long RankStart = 0,
      long RankEnd = 0,
  ...
  public static void AddArenaRewardType(FlatBufferBuilder builder, Schale.FlatData.ArenaRewardType arenaRewardType) { builder.AddInt(1, (int)arenaRewardType, 0); }
  ...
  public static Offset<Schale.FlatData.ArenaRewardExcel> EndArenaRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ArenaRewardExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ArenaRewardExcel> Pack(FlatBufferBuilder builder, ArenaRewardExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ArenaRewardExcel>);
...
public class ArenaRewardExcelT
{
  ...
  public Schale.FlatData.ArenaRewardType ArenaRewardType { get; set; }
  ...
  public ArenaRewardExcelT() {
    this.UniqueId = 0;
    this.ArenaRewardType = Schale.FlatData.ArenaRewardType.None;
    this.RankStart = 0;
    this.RankEnd = 0;
...
static public class ArenaRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ArenaRewardType*/, 4 /*Schale.FlatData.ArenaRewardType*/, 4, false)
