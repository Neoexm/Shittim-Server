...
public struct FurnitureTemplateExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.FurnitureTemplateExcel> CreateFurnitureTemplateExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.FurnitureTemplateExcel> EndFurnitureTemplateExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.FurnitureTemplateExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.FurnitureTemplateExcel> Pack(FlatBufferBuilder builder, FurnitureTemplateExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.FurnitureTemplateExcel>);
