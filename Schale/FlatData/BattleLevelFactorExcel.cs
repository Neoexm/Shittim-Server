...
public struct BattleLevelFactorExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.BattleLevelFactorExcel> CreateBattleLevelFactorExcel(FlatBufferBuilder builder,
      int LevelDiff = 0,
      long DamageRate = 0) {
  ...
  public static Offset<Schale.FlatData.BattleLevelFactorExcel> EndBattleLevelFactorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.BattleLevelFactorExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.BattleLevelFactorExcel> Pack(FlatBufferBuilder builder, BattleLevelFactorExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.BattleLevelFactorExcel>);
