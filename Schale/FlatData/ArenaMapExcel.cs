...
public struct ArenaMapExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.ArenaMapExcel> Pack(FlatBufferBuilder builder, ArenaMapExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ArenaMapExcel>);
