...
public struct VideoExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.VideoExcel> CreateVideoExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Schale.FlatData.VideoExcel> EndVideoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.VideoExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.VideoExcel> Pack(FlatBufferBuilder builder, VideoExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.VideoExcel>);
