...
public struct AcademyLocationExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.School OpenCondition(int j) { int o = __p.__offset(12); return o != 0 ? (Schale.FlatData.School)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.School)0; }
  public int OpenConditionLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.School> GetOpenConditionBytes() { return __p.__vector_as_span<Schale.FlatData.School>(12, 4); }
#else
  public ArraySegment<byte>? GetOpenConditionBytes() { return __p.__vector_as_arraysegment(12); }
#endif
  public Schale.FlatData.School[] GetOpenConditionArray() { int o = __p.__offset(12); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.School[] a = new Schale.FlatData.School[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.School)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Schale.FlatData.ParcelType RewardParcelType { get { int o = __p.__offset(16); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.AcademyLocationExcel> CreateAcademyLocationExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static VectorOffset CreateOpenConditionVector(FlatBufferBuilder builder, Schale.FlatData.School[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateOpenConditionVectorBlock(FlatBufferBuilder builder, Schale.FlatData.School[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateOpenConditionVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.School> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateOpenConditionVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.School>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddRewardParcelType(FlatBufferBuilder builder, Schale.FlatData.ParcelType rewardParcelType) { builder.AddInt(6, (int)rewardParcelType, 0); }
  ...
  public static Offset<Schale.FlatData.AcademyLocationExcel> EndAcademyLocationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.AcademyLocationExcel>(o);
  }
  ...
  public void UnPackTo(AcademyLocationExcelT _o) {
    ...
    _o.OpenCondition = new List<Schale.FlatData.School>();
  ...
  public static Offset<Schale.FlatData.AcademyLocationExcel> Pack(FlatBufferBuilder builder, AcademyLocationExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.AcademyLocationExcel>);
...
public class AcademyLocationExcelT
{
  ...
  public List<Schale.FlatData.School> OpenCondition { get; set; }
...
static public class AcademyLocationExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 12 /*OpenCondition*/, 4 /*Schale.FlatData.School*/, false)
      && verifier.VerifyVectorOfData(tablePos, 14 /*OpenConditionCount*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 16 /*RewardParcelType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
