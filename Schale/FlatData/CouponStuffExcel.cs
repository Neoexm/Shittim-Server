...
public struct CouponStuffExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ParcelType ParcelType { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.CouponStuffExcel> CreateCouponStuffExcel(FlatBufferBuilder builder,
      long StuffId = 0,
  ...
  public static void AddParcelType(FlatBufferBuilder builder, Schale.FlatData.ParcelType parcelType) { builder.AddInt(1, (int)parcelType, 0); }
  ...
  public static Offset<Schale.FlatData.CouponStuffExcel> EndCouponStuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CouponStuffExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.CouponStuffExcel> Pack(FlatBufferBuilder builder, CouponStuffExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.CouponStuffExcel>);
...
static public class CouponStuffExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ParcelType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
