...
public struct ScenarioBGName_GlobalExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.ScenarioBGName_GlobalExcel> EndScenarioBGName_GlobalExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ScenarioBGName_GlobalExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ScenarioBGName_GlobalExcel> Pack(FlatBufferBuilder builder, ScenarioBGName_GlobalExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ScenarioBGName_GlobalExcel>);
