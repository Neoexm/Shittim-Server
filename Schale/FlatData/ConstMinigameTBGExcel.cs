...
public struct ConstMinigameTBGExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.ConstMinigameTBGExcel> CreateConstMinigameTBGExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.ConstMinigameTBGExcel> EndConstMinigameTBGExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ConstMinigameTBGExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ConstMinigameTBGExcel> Pack(FlatBufferBuilder builder, ConstMinigameTBGExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ConstMinigameTBGExcel>);
