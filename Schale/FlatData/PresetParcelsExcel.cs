...
public struct PresetParcelsExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.PresetParcelsExcel> CreatePresetParcelsExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.PresetParcelsExcel> EndPresetParcelsExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.PresetParcelsExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.PresetParcelsExcel> Pack(FlatBufferBuilder builder, PresetParcelsExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.PresetParcelsExcel>);
