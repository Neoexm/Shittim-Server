...
public struct MiniGameDefenseCharacterBanExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.MiniGameDefenseCharacterBanExcel> CreateMiniGameDefenseCharacterBanExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.MiniGameDefenseCharacterBanExcel> EndMiniGameDefenseCharacterBanExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MiniGameDefenseCharacterBanExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MiniGameDefenseCharacterBanExcel> Pack(FlatBufferBuilder builder, MiniGameDefenseCharacterBanExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MiniGameDefenseCharacterBanExcel>);
