...
public struct MultiFloorRaidStageExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.MultiFloorRaidStageExcel> CreateMultiFloorRaidStageExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Schale.FlatData.MultiFloorRaidStageExcel> EndMultiFloorRaidStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MultiFloorRaidStageExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MultiFloorRaidStageExcel> Pack(FlatBufferBuilder builder, MultiFloorRaidStageExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MultiFloorRaidStageExcel>);
