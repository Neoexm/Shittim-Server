...
public struct ToastExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ToastType ToastType { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.ToastType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ToastType.None; } }
  ...
  public static Offset<Schale.FlatData.ToastExcel> CreateToastExcel(FlatBufferBuilder builder,
      uint Id = 0,
      Schale.FlatData.ToastType ToastType = Schale.FlatData.ToastType.None,
      uint MissionId = 0,
      uint TextId = 0,
      long LifeTime = 0) {
  ...
  public static void AddToastType(FlatBufferBuilder builder, Schale.FlatData.ToastType toastType) { builder.AddInt(1, (int)toastType, 0); }
  ...
  public static Offset<Schale.FlatData.ToastExcel> EndToastExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ToastExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ToastExcel> Pack(FlatBufferBuilder builder, ToastExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ToastExcel>);
...
public class ToastExcelT
{
  ...
  public Schale.FlatData.ToastType ToastType { get; set; }
  ...
  public ToastExcelT() {
    this.Id = 0;
    this.ToastType = Schale.FlatData.ToastType.None;
    this.MissionId = 0;
    this.TextId = 0;
    this.LifeTime = 0;
  }
...
static public class ToastExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ToastType*/, 4 /*Schale.FlatData.ToastType*/, 4, false)
