...
public struct StageFileRefreshSettingExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.StageFileRefreshSettingExcel> CreateStageFileRefreshSettingExcel(FlatBufferBuilder builder,
      long GroundId = 0,
  ...
  public static Offset<Schale.FlatData.StageFileRefreshSettingExcel> EndStageFileRefreshSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.StageFileRefreshSettingExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.StageFileRefreshSettingExcel> Pack(FlatBufferBuilder builder, StageFileRefreshSettingExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.StageFileRefreshSettingExcel>);
