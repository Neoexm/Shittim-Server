...
public struct AcademyMessangerExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.AcademyMessageConditions MessageCondition { get { int o = __p.__offset(10); return o != 0 ? (Schale.FlatData.AcademyMessageConditions)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.AcademyMessageConditions.None; } }
  ...
  public Schale.FlatData.AcademyMessageTypes MessageType { get { int o = __p.__offset(24); return o != 0 ? (Schale.FlatData.AcademyMessageTypes)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.AcademyMessageTypes.None; } }
  ...
  public static Offset<Schale.FlatData.AcademyMessangerExcel> CreateAcademyMessangerExcel(FlatBufferBuilder builder,
      long MessageGroupId = 0,
      long Id = 0,
      long CharacterId = 0,
      Schale.FlatData.AcademyMessageConditions MessageCondition = Schale.FlatData.AcademyMessageConditions.None,
      ...
      Schale.FlatData.AcademyMessageTypes MessageType = Schale.FlatData.AcademyMessageTypes.None,
  ...
  public static void AddMessageCondition(FlatBufferBuilder builder, Schale.FlatData.AcademyMessageConditions messageCondition) { builder.AddInt(3, (int)messageCondition, 0); }
  ...
  public static void AddMessageType(FlatBufferBuilder builder, Schale.FlatData.AcademyMessageTypes messageType) { builder.AddInt(10, (int)messageType, 0); }
  ...
  public static Offset<Schale.FlatData.AcademyMessangerExcel> EndAcademyMessangerExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.AcademyMessangerExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.AcademyMessangerExcel> Pack(FlatBufferBuilder builder, AcademyMessangerExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.AcademyMessangerExcel>);
...
public class AcademyMessangerExcelT
{
  ...
  public Schale.FlatData.AcademyMessageConditions MessageCondition { get; set; }
  ...
  public Schale.FlatData.AcademyMessageTypes MessageType { get; set; }
  ...
  public AcademyMessangerExcelT() {
    ...
    this.Id = 0;
    this.CharacterId = 0;
    this.MessageCondition = Schale.FlatData.AcademyMessageConditions.None;
    ...
    this.MessageType = Schale.FlatData.AcademyMessageTypes.None;
    this.ImagePath = null;
    this.MessageKR = null;
    this.MessageJP = null;
    this.MessageTH = null;
...
static public class AcademyMessangerExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*MessageCondition*/, 4 /*Schale.FlatData.AcademyMessageConditions*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 24 /*MessageType*/, 4 /*Schale.FlatData.AcademyMessageTypes*/, 4, false)
