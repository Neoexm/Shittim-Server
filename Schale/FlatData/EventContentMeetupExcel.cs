...
public struct EventContentMeetupExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.MeetupConditionType ConditionType { get { int o = __p.__offset(12); return o != 0 ? (Schale.FlatData.MeetupConditionType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.MeetupConditionType.None; } }
  ...
  public Schale.FlatData.MeetupConditionPrintType ConditionPrintType { get { int o = __p.__offset(16); return o != 0 ? (Schale.FlatData.MeetupConditionPrintType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.MeetupConditionPrintType.None; } }

  public static Offset<Schale.FlatData.EventContentMeetupExcel> CreateEventContentMeetupExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddConditionType(FlatBufferBuilder builder, Schale.FlatData.MeetupConditionType conditionType) { builder.AddInt(4, (int)conditionType, 0); }
  ...
  public static void AddConditionPrintType(FlatBufferBuilder builder, Schale.FlatData.MeetupConditionPrintType conditionPrintType) { builder.AddInt(6, (int)conditionPrintType, 0); }
  public static Offset<Schale.FlatData.EventContentMeetupExcel> EndEventContentMeetupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentMeetupExcel>(o);
  }
...
public class EventContentMeetupExcelT
{
  ...
  public Schale.FlatData.MeetupConditionType ConditionType { get; set; }
  public List<long> ConditionParameter { get; set; }
  public Schale.FlatData.MeetupConditionPrintType ConditionPrintType { get; set; }
  ...
  public EventContentMeetupExcelT() {
    ...
    this.ConditionType = Schale.FlatData.MeetupConditionType.None;
    this.ConditionParameter = null;
    this.ConditionPrintType = Schale.FlatData.MeetupConditionPrintType.None;
  }
}
...
static public class EventContentMeetupExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*ConditionType*/, 4 /*Schale.FlatData.MeetupConditionType*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 14 /*ConditionParameter*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 16 /*ConditionPrintType*/, 4 /*Schale.FlatData.MeetupConditionPrintType*/, 4, false)
