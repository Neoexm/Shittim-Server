...
public struct RecipeExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.RecipeExcel> CreateRecipeExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Schale.FlatData.RecipeExcel> EndRecipeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.RecipeExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.RecipeExcel> Pack(FlatBufferBuilder builder, RecipeExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.RecipeExcel>);
