...
public struct CharacterStatsDetailExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.StatType DetailShowStats(int j) { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.StatType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.StatType)0; }
  public int DetailShowStatsLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.StatType> GetDetailShowStatsBytes() { return __p.__vector_as_span<Schale.FlatData.StatType>(6, 4); }
#else
  public ArraySegment<byte>? GetDetailShowStatsBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public Schale.FlatData.StatType[] GetDetailShowStatsArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.StatType[] a = new Schale.FlatData.StatType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.StatType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static VectorOffset CreateDetailShowStatsVector(FlatBufferBuilder builder, Schale.FlatData.StatType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateDetailShowStatsVectorBlock(FlatBufferBuilder builder, Schale.FlatData.StatType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateDetailShowStatsVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.StatType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateDetailShowStatsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.StatType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Schale.FlatData.CharacterStatsDetailExcel> EndCharacterStatsDetailExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CharacterStatsDetailExcel>(o);
  }
  ...
  public void UnPackTo(CharacterStatsDetailExcelT _o) {
    ...
    _o.DetailShowStats = new List<Schale.FlatData.StatType>();
...
public class CharacterStatsDetailExcelT
{
  ...
  public List<Schale.FlatData.StatType> DetailShowStats { get; set; }
...
static public class CharacterStatsDetailExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*DetailShowStats*/, 4 /*Schale.FlatData.StatType*/, false)
