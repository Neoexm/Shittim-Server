...
public struct VoiceTimelineExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.VoiceTimelineExcel> CreateVoiceTimelineExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      uint Id = 0,
  ...
  public static Offset<Schale.FlatData.VoiceTimelineExcel> EndVoiceTimelineExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.VoiceTimelineExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.VoiceTimelineExcel> Pack(FlatBufferBuilder builder, VoiceTimelineExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.VoiceTimelineExcel>);
