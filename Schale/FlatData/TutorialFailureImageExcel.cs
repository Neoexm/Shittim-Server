...
public struct TutorialFailureImageExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.TutorialFailureContentType Contents { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.TutorialFailureContentType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.TutorialFailureContentType.None; } }
  ...
  public static Offset<Schale.FlatData.TutorialFailureImageExcel> CreateTutorialFailureImageExcel(FlatBufferBuilder builder,
      long Id = 0,
      Schale.FlatData.TutorialFailureContentType Contents = Schale.FlatData.TutorialFailureContentType.None,
...
public class TutorialFailureImageExcelT
{
  ...
  public Schale.FlatData.TutorialFailureContentType Contents { get; set; }
  ...
  public TutorialFailureImageExcelT() {
    this.Id = 0;
    this.Contents = Schale.FlatData.TutorialFailureContentType.None;
    this.Type = null;
...
static public class TutorialFailureImageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*Contents*/, 4 /*Schale.FlatData.TutorialFailureContentType*/, 4, false)
