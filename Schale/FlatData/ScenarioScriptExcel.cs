...
public struct ScenarioScriptExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.ScenarioScriptExcel> CreateScenarioScriptExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Schale.FlatData.ScenarioScriptExcel> EndScenarioScriptExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ScenarioScriptExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ScenarioScriptExcel> Pack(FlatBufferBuilder builder, ScenarioScriptExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ScenarioScriptExcel>);
