...
public struct AcademyZoneExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.Tag Tags(int j) { int o = __p.__offset(16); return o != 0 ? (Schale.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(16); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.Tag> GetTagsBytes() { return __p.__vector_as_span<Schale.FlatData.Tag>(16, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(16); }
#endif
  public Schale.FlatData.Tag[] GetTagsArray() { int o = __p.__offset(16); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.Tag[] a = new Schale.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }

  public static Offset<Schale.FlatData.AcademyZoneExcel> CreateAcademyZoneExcel(FlatBufferBuilder builder,
      long Id = 0,
      long LocationId = 0,
  ...
  public static Offset<Schale.FlatData.AcademyZoneExcel> EndAcademyZoneExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.AcademyZoneExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.AcademyZoneExcel> Pack(FlatBufferBuilder builder, AcademyZoneExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.AcademyZoneExcel>);
...
static public class AcademyZoneExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 16 /*Tags*/, 4 /*Schale.FlatData.Tag*/, false)
