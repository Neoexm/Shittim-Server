...
public struct ContentsScenarioExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ScenarioContentType ScenarioContentType { get { int o = __p.__offset(10); return o != 0 ? (Schale.FlatData.ScenarioContentType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ScenarioContentType.Prologue; } }
  ...
  public static Offset<Schale.FlatData.ContentsScenarioExcel> CreateContentsScenarioExcel(FlatBufferBuilder builder,
      uint Id = 0,
      uint LocalizeId = 0,
      int DisplayOrder = 0,
      Schale.FlatData.ScenarioContentType ScenarioContentType = Schale.FlatData.ScenarioContentType.Prologue,
  ...
  public static void AddScenarioContentType(FlatBufferBuilder builder, Schale.FlatData.ScenarioContentType scenarioContentType) { builder.AddInt(3, (int)scenarioContentType, 0); }
  ...
  public static Offset<Schale.FlatData.ContentsScenarioExcel> EndContentsScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ContentsScenarioExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ContentsScenarioExcel> Pack(FlatBufferBuilder builder, ContentsScenarioExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ContentsScenarioExcel>);
...
public class ContentsScenarioExcelT
{
  ...
  public Schale.FlatData.ScenarioContentType ScenarioContentType { get; set; }
  ...
  public ContentsScenarioExcelT() {
    ...
    this.LocalizeId = 0;
    this.DisplayOrder = 0;
    this.ScenarioContentType = Schale.FlatData.ScenarioContentType.Prologue;
...
static public class ContentsScenarioExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ScenarioContentType*/, 4 /*Schale.FlatData.ScenarioContentType*/, 4, false)
