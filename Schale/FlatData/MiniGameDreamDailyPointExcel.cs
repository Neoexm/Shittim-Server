...
public struct MiniGameDreamDailyPointExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.MiniGameDreamDailyPointExcel> CreateMiniGameDreamDailyPointExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<Schale.FlatData.MiniGameDreamDailyPointExcel> EndMiniGameDreamDailyPointExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MiniGameDreamDailyPointExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MiniGameDreamDailyPointExcel> Pack(FlatBufferBuilder builder, MiniGameDreamDailyPointExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MiniGameDreamDailyPointExcel>);
