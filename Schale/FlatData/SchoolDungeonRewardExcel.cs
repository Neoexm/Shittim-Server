...
public struct SchoolDungeonRewardExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.RewardTag RewardTag { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.RewardTag)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.RewardTag.Default; } }
  ...
  public static Offset<Schale.FlatData.SchoolDungeonRewardExcel> CreateSchoolDungeonRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static void AddRewardTag(FlatBufferBuilder builder, Schale.FlatData.RewardTag rewardTag) { builder.AddInt(2, (int)rewardTag, 0); }
  ...
  public static Offset<Schale.FlatData.SchoolDungeonRewardExcel> EndSchoolDungeonRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.SchoolDungeonRewardExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.SchoolDungeonRewardExcel> Pack(FlatBufferBuilder builder, SchoolDungeonRewardExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.SchoolDungeonRewardExcel>);
...
static public class SchoolDungeonRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*RewardTag*/, 4 /*Schale.FlatData.RewardTag*/, 4, false)
