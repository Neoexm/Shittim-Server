...
public struct MiniGameDefenseFixedStatExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.MiniGameDefenseFixedStatExcel> CreateMiniGameDefenseFixedStatExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.MiniGameDefenseFixedStatExcel> EndMiniGameDefenseFixedStatExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MiniGameDefenseFixedStatExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MiniGameDefenseFixedStatExcel> Pack(FlatBufferBuilder builder, MiniGameDefenseFixedStatExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MiniGameDefenseFixedStatExcel>);
