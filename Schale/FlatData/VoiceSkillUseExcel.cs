...
public struct VoiceSkillUseExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.VoiceSkillUseExcel> CreateVoiceSkillUseExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.VoiceSkillUseExcel> EndVoiceSkillUseExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.VoiceSkillUseExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.VoiceSkillUseExcel> Pack(FlatBufferBuilder builder, VoiceSkillUseExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.VoiceSkillUseExcel>);
