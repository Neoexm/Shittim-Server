...
public struct MinigameTBGEncounterExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.TBGThemaType ThemaType { get { int o = __p.__offset(12); return o != 0 ? (Schale.FlatData.TBGThemaType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.TBGThemaType.None; } }
  public Schale.FlatData.TBGObjectType ObjectType { get { int o = __p.__offset(14); return o != 0 ? (Schale.FlatData.TBGObjectType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.TBGObjectType.None; } }
  ...
  public static Offset<Schale.FlatData.MinigameTBGEncounterExcel> CreateMinigameTBGEncounterExcel(FlatBufferBuilder builder,
  ...
  public static void AddThemaType(FlatBufferBuilder builder, Schale.FlatData.TBGThemaType themaType) { builder.AddInt(4, (int)themaType, 0); }
  public static void AddObjectType(FlatBufferBuilder builder, Schale.FlatData.TBGObjectType objectType) { builder.AddInt(5, (int)objectType, 0); }
  ...
  public static Offset<Schale.FlatData.MinigameTBGEncounterExcel> EndMinigameTBGEncounterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MinigameTBGEncounterExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MinigameTBGEncounterExcel> Pack(FlatBufferBuilder builder, MinigameTBGEncounterExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MinigameTBGEncounterExcel>);
...
static public class MinigameTBGEncounterExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*ThemaType*/, 4 /*Schale.FlatData.TBGThemaType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*ObjectType*/, 4 /*Schale.FlatData.TBGObjectType*/, 4, false)
