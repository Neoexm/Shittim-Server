...
public struct ScenarioCharacterNameExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ScenarioCharacterShapes Shape { get { int o = __p.__offset(28); return o != 0 ? (Schale.FlatData.ScenarioCharacterShapes)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ScenarioCharacterShapes.None; } }
  ...
  public static Offset<Schale.FlatData.ScenarioCharacterNameExcel> CreateScenarioCharacterNameExcel(FlatBufferBuilder builder,
      ...
      Schale.FlatData.ScenarioCharacterShapes Shape = Schale.FlatData.ScenarioCharacterShapes.None,
  ...
  public static void AddShape(FlatBufferBuilder builder, Schale.FlatData.ScenarioCharacterShapes shape) { builder.AddInt(12, (int)shape, 0); }
  ...
  public static Offset<Schale.FlatData.ScenarioCharacterNameExcel> EndScenarioCharacterNameExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ScenarioCharacterNameExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ScenarioCharacterNameExcel> Pack(FlatBufferBuilder builder, ScenarioCharacterNameExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ScenarioCharacterNameExcel>);
...
public class ScenarioCharacterNameExcelT
{
  ...
  public Schale.FlatData.ScenarioCharacterShapes Shape { get; set; }
  ...
  public ScenarioCharacterNameExcelT() {
    ...
    this.Shape = Schale.FlatData.ScenarioCharacterShapes.None;
...
static public class ScenarioCharacterNameExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 28 /*Shape*/, 4 /*Schale.FlatData.ScenarioCharacterShapes*/, 4, false)
