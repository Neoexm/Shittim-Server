...
public struct MultiFloorRaidStatChangeExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.StatType StatType(int j) { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.StatType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.StatType)0; }
  public int StatTypeLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.StatType> GetStatTypeBytes() { return __p.__vector_as_span<Schale.FlatData.StatType>(6, 4); }
#else
  public ArraySegment<byte>? GetStatTypeBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public Schale.FlatData.StatType[] GetStatTypeArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.StatType[] a = new Schale.FlatData.StatType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.StatType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.MultiFloorRaidStatChangeExcel> CreateMultiFloorRaidStatChangeExcel(FlatBufferBuilder builder,
      long StatChangeId = 0,
  ...
  public static VectorOffset CreateStatTypeVector(FlatBufferBuilder builder, Schale.FlatData.StatType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateStatTypeVectorBlock(FlatBufferBuilder builder, Schale.FlatData.StatType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStatTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.StatType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStatTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.StatType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Schale.FlatData.MultiFloorRaidStatChangeExcel> EndMultiFloorRaidStatChangeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MultiFloorRaidStatChangeExcel>(o);
  }
  ...
  public void UnPackTo(MultiFloorRaidStatChangeExcelT _o) {
    ...
    _o.StatType = new List<Schale.FlatData.StatType>();
  ...
  public static Offset<Schale.FlatData.MultiFloorRaidStatChangeExcel> Pack(FlatBufferBuilder builder, MultiFloorRaidStatChangeExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MultiFloorRaidStatChangeExcel>);
...
public class MultiFloorRaidStatChangeExcelT
{
  ...
  public List<Schale.FlatData.StatType> StatType { get; set; }
...
static public class MultiFloorRaidStatChangeExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*StatType*/, 4 /*Schale.FlatData.StatType*/, false)
