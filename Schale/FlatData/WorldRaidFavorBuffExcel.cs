...
public struct WorldRaidFavorBuffExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.WorldRaidFavorBuffExcel> CreateWorldRaidFavorBuffExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.WorldRaidFavorBuffExcel> EndWorldRaidFavorBuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.WorldRaidFavorBuffExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.WorldRaidFavorBuffExcel> Pack(FlatBufferBuilder builder, WorldRaidFavorBuffExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.WorldRaidFavorBuffExcel>);
