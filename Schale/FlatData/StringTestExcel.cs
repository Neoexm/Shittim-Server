...
public struct StringTestExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.StringTestExcel> EndStringTestExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.StringTestExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.StringTestExcel> Pack(FlatBufferBuilder builder, StringTestExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.StringTestExcel>);
