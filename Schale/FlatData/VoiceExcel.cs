...
public struct VoiceExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.Nation Nation(int j) { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.Nation)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.Nation)0; }
  public int NationLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.Nation> GetNationBytes() { return __p.__vector_as_span<Schale.FlatData.Nation>(8, 4); }
#else
  public ArraySegment<byte>? GetNationBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public Schale.FlatData.Nation[] GetNationArray() { int o = __p.__offset(8); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.Nation[] a = new Schale.FlatData.Nation[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.Nation)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.VoiceExcel> CreateVoiceExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      uint Id = 0,
  ...
  public static Offset<Schale.FlatData.VoiceExcel> EndVoiceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.VoiceExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.VoiceExcel> Pack(FlatBufferBuilder builder, VoiceExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.VoiceExcel>);
...
static public class VoiceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 8 /*Nation*/, 4 /*Schale.FlatData.Nation*/, false)
