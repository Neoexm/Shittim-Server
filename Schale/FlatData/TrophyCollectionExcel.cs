...
public struct TrophyCollectionExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.TrophyCollectionExcel> CreateTrophyCollectionExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Schale.FlatData.TrophyCollectionExcel> EndTrophyCollectionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.TrophyCollectionExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.TrophyCollectionExcel> Pack(FlatBufferBuilder builder, TrophyCollectionExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.TrophyCollectionExcel>);
