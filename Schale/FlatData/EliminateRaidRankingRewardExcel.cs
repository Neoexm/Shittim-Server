...
public struct EliminateRaidRankingRewardExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ParcelType RewardParcelType(int j) { int o = __p.__offset(34); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.ParcelType)0; }
  public int RewardParcelTypeLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.ParcelType> GetRewardParcelTypeBytes() { return __p.__vector_as_span<Schale.FlatData.ParcelType>(34, 4); }
#else
  public ArraySegment<byte>? GetRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public Schale.FlatData.ParcelType[] GetRewardParcelTypeArray() { int o = __p.__offset(34); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.ParcelType[] a = new Schale.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.EliminateRaidRankingRewardExcel> CreateEliminateRaidRankingRewardExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.EliminateRaidRankingRewardExcel> EndEliminateRaidRankingRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EliminateRaidRankingRewardExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.EliminateRaidRankingRewardExcel> Pack(FlatBufferBuilder builder, EliminateRaidRankingRewardExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EliminateRaidRankingRewardExcel>);
...
static public class EliminateRaidRankingRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 34 /*RewardParcelType*/, 4 /*Schale.FlatData.ParcelType*/, false)
