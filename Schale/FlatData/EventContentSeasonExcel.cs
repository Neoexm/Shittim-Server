...
public struct EventContentSeasonExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.EventContentType EventContentType { get { int o = __p.__offset(12); return o != 0 ? (Schale.FlatData.EventContentType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.EventContentType.Stage; } }
  public Schale.FlatData.OpenConditionContent OpenConditionContent { get { int o = __p.__offset(14); return o != 0 ? (Schale.FlatData.OpenConditionContent)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.OpenConditionContent.Shop; } }
  ...
  public Schale.FlatData.SubEventType SubEventType { get { int o = __p.__offset(20); return o != 0 ? (Schale.FlatData.SubEventType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.SubEventType.None; } }
  ...
  public Schale.FlatData.EventContentReleaseType EventContentReleaseType { get { int o = __p.__offset(68); return o != 0 ? (Schale.FlatData.EventContentReleaseType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.EventContentReleaseType.None; } }
  public long EventContentStageRewardIdPermanent { get { int o = __p.__offset(70); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Schale.FlatData.RewardTag RewardTagPermanent { get { int o = __p.__offset(72); return o != 0 ? (Schale.FlatData.RewardTag)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.RewardTag.Default; } }
  ...
  public static Offset<Schale.FlatData.EventContentSeasonExcel> CreateEventContentSeasonExcel(FlatBufferBuilder builder,
      ...
      Schale.FlatData.OpenConditionContent OpenConditionContent = Schale.FlatData.OpenConditionContent.Shop,
      bool EventDisplay = false,
      int IconOrder = 0,
      Schale.FlatData.SubEventType SubEventType = Schale.FlatData.SubEventType.None,
      bool SubEvent = false,
      long EventItemId = 0,
      long MainEventId = 0,
      ...
      Schale.FlatData.EventContentReleaseType EventContentReleaseType = Schale.FlatData.EventContentReleaseType.None,
      long EventContentStageRewardIdPermanent = 0,
      Schale.FlatData.RewardTag RewardTagPermanent = Schale.FlatData.RewardTag.Default,
  ...
  public static void AddEventContentType(FlatBufferBuilder builder, Schale.FlatData.EventContentType eventContentType) { builder.AddInt(4, (int)eventContentType, 0); }
  public static void AddOpenConditionContent(FlatBufferBuilder builder, Schale.FlatData.OpenConditionContent openConditionContent) { builder.AddInt(5, (int)openConditionContent, 0); }
  ...
  public static void AddSubEventType(FlatBufferBuilder builder, Schale.FlatData.SubEventType subEventType) { builder.AddInt(8, (int)subEventType, 0); }
  ...
  public static void AddEventContentReleaseType(FlatBufferBuilder builder, Schale.FlatData.EventContentReleaseType eventContentReleaseType) { builder.AddInt(32, (int)eventContentReleaseType, 0); }
  ...
  public static void AddRewardTagPermanent(FlatBufferBuilder builder, Schale.FlatData.RewardTag rewardTagPermanent) { builder.AddInt(34, (int)rewardTagPermanent, 0); }
  ...
  public static Offset<Schale.FlatData.EventContentSeasonExcel> EndEventContentSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentSeasonExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.EventContentSeasonExcel> Pack(FlatBufferBuilder builder, EventContentSeasonExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EventContentSeasonExcel>);
...
public class EventContentSeasonExcelT
{
  ...
  public Schale.FlatData.OpenConditionContent OpenConditionContent { get; set; }
  public bool EventDisplay { get; set; }
  public int IconOrder { get; set; }
  public Schale.FlatData.SubEventType SubEventType { get; set; }
  ...
  public Schale.FlatData.EventContentReleaseType EventContentReleaseType { get; set; }
  public long EventContentStageRewardIdPermanent { get; set; }
  public Schale.FlatData.RewardTag RewardTagPermanent { get; set; }
  ...
  public EventContentSeasonExcelT() {
    ...
    this.OpenConditionContent = Schale.FlatData.OpenConditionContent.Shop;
    this.EventDisplay = false;
    this.IconOrder = 0;
    this.SubEventType = Schale.FlatData.SubEventType.None;
    this.SubEvent = false;
    this.EventItemId = 0;
    this.MainEventId = 0;
    ...
    this.EventContentReleaseType = Schale.FlatData.EventContentReleaseType.None;
    this.EventContentStageRewardIdPermanent = 0;
    this.RewardTagPermanent = Schale.FlatData.RewardTag.Default;
...
static public class EventContentSeasonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*EventContentType*/, 4 /*Schale.FlatData.EventContentType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*OpenConditionContent*/, 4 /*Schale.FlatData.OpenConditionContent*/, 4, false)
      && verifier.VerifyField(tablePos, 16 /*EventDisplay*/, 1 /*bool*/, 1, false)
      && verifier.VerifyField(tablePos, 18 /*IconOrder*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 20 /*SubEventType*/, 4 /*Schale.FlatData.SubEventType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 68 /*EventContentReleaseType*/, 4 /*Schale.FlatData.EventContentReleaseType*/, 4, false)
      && verifier.VerifyField(tablePos, 70 /*EventContentStageRewardIdPermanent*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 72 /*RewardTagPermanent*/, 4 /*Schale.FlatData.RewardTag*/, 4, false)
