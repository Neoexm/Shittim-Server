...
public struct EventContentBuffGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.EventContentBuffGroupExcel> CreateEventContentBuffGroupExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.EventContentBuffGroupExcel> EndEventContentBuffGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentBuffGroupExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.EventContentBuffGroupExcel> Pack(FlatBufferBuilder builder, EventContentBuffGroupExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EventContentBuffGroupExcel>);
