...
public struct TacticSkipExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.TacticSkipExcel> CreateTacticSkipExcel(FlatBufferBuilder builder,
      int LevelDiff = 0,
      long HPResult = 0) {
  ...
  public static Offset<Schale.FlatData.TacticSkipExcel> EndTacticSkipExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.TacticSkipExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.TacticSkipExcel> Pack(FlatBufferBuilder builder, TacticSkipExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.TacticSkipExcel>);
