...
public struct MiniGameDreamEndingRewardExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.DreamMakerEndingRewardType DreamMakerEndingRewardType { get { int o = __p.__offset(10); return o != 0 ? (Schale.FlatData.DreamMakerEndingRewardType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.DreamMakerEndingRewardType.None; } }
  public Schale.FlatData.DreamMakerEndingType DreamMakerEndingType { get { int o = __p.__offset(12); return o != 0 ? (Schale.FlatData.DreamMakerEndingType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.DreamMakerEndingType.None; } }
  ...
  public static Offset<Schale.FlatData.MiniGameDreamEndingRewardExcel> CreateMiniGameDreamEndingRewardExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long EndingId = 0,
      uint LocalizeEtcId = 0,
      Schale.FlatData.DreamMakerEndingRewardType DreamMakerEndingRewardType = Schale.FlatData.DreamMakerEndingRewardType.None,
      Schale.FlatData.DreamMakerEndingType DreamMakerEndingType = Schale.FlatData.DreamMakerEndingType.None,
  ...
  public static void AddDreamMakerEndingRewardType(FlatBufferBuilder builder, Schale.FlatData.DreamMakerEndingRewardType dreamMakerEndingRewardType) { builder.AddInt(3, (int)dreamMakerEndingRewardType, 0); }
  public static void AddDreamMakerEndingType(FlatBufferBuilder builder, Schale.FlatData.DreamMakerEndingType dreamMakerEndingType) { builder.AddInt(4, (int)dreamMakerEndingType, 0); }
  ...
  public static Offset<Schale.FlatData.MiniGameDreamEndingRewardExcel> EndMiniGameDreamEndingRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MiniGameDreamEndingRewardExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MiniGameDreamEndingRewardExcel> Pack(FlatBufferBuilder builder, MiniGameDreamEndingRewardExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MiniGameDreamEndingRewardExcel>);
...
public class MiniGameDreamEndingRewardExcelT
{
  ...
  public Schale.FlatData.DreamMakerEndingRewardType DreamMakerEndingRewardType { get; set; }
  public Schale.FlatData.DreamMakerEndingType DreamMakerEndingType { get; set; }
  ...
  public MiniGameDreamEndingRewardExcelT() {
    ...
    this.DreamMakerEndingRewardType = Schale.FlatData.DreamMakerEndingRewardType.None;
    this.DreamMakerEndingType = Schale.FlatData.DreamMakerEndingType.None;
...
static public class MiniGameDreamEndingRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*DreamMakerEndingRewardType*/, 4 /*Schale.FlatData.DreamMakerEndingRewardType*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*DreamMakerEndingType*/, 4 /*Schale.FlatData.DreamMakerEndingType*/, 4, false)
