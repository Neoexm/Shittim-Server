...
public struct CafeProductionExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ParcelType CafeProductionParcelType { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.CafeProductionExcel> CreateCafeProductionExcel(FlatBufferBuilder builder,
      long CafeId = 0,
      long Rank = 0,
      Schale.FlatData.ParcelType CafeProductionParcelType = Schale.FlatData.ParcelType.None,
  ...
  public static void AddCafeProductionParcelType(FlatBufferBuilder builder, Schale.FlatData.ParcelType cafeProductionParcelType) { builder.AddInt(2, (int)cafeProductionParcelType, 0); }
  ...
  public static Offset<Schale.FlatData.CafeProductionExcel> EndCafeProductionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CafeProductionExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.CafeProductionExcel> Pack(FlatBufferBuilder builder, CafeProductionExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.CafeProductionExcel>);
...
public class CafeProductionExcelT
{
  ...
  public Schale.FlatData.ParcelType CafeProductionParcelType { get; set; }
  ...
  public CafeProductionExcelT() {
    this.CafeId = 0;
    this.Rank = 0;
    this.CafeProductionParcelType = Schale.FlatData.ParcelType.None;
...
static public class CafeProductionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CafeProductionParcelType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
