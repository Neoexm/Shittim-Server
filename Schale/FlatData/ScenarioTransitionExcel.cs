...
public struct ScenarioTransitionExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.ScenarioTransitionExcel> CreateScenarioTransitionExcel(FlatBufferBuilder builder,
      uint Name = 0,
  ...
  public static Offset<Schale.FlatData.ScenarioTransitionExcel> EndScenarioTransitionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ScenarioTransitionExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ScenarioTransitionExcel> Pack(FlatBufferBuilder builder, ScenarioTransitionExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ScenarioTransitionExcel>);
