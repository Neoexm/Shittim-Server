...
public struct HpBarAbbreviationExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.HpBarAbbreviationExcel> CreateHpBarAbbreviationExcel(FlatBufferBuilder builder,
      int MonsterLv = 0,
      int StandardHpBar = 0,
      int RaidBossHpBar = 0) {
  ...
  public static Offset<Schale.FlatData.HpBarAbbreviationExcel> EndHpBarAbbreviationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.HpBarAbbreviationExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.HpBarAbbreviationExcel> Pack(FlatBufferBuilder builder, HpBarAbbreviationExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.HpBarAbbreviationExcel>);
