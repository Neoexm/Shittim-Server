...
public struct PropVector3 : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.PropVector3> CreatePropVector3(FlatBufferBuilder builder,
      float X = 0.0f,
      float Y = 0.0f,
      float Z = 0.0f) {
  ...
  public static Offset<Schale.FlatData.PropVector3> EndPropVector3(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.PropVector3>(o);
  }
  ...
  public static Offset<Schale.FlatData.PropVector3> Pack(FlatBufferBuilder builder, PropVector3T _o) {
    if (_o == null) return default(Offset<Schale.FlatData.PropVector3>);
