...
public struct MemoryLobbyExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.MemoryLobbyCategory MemoryLobbyCategory { get { int o = __p.__offset(14); return o != 0 ? (Schale.FlatData.MemoryLobbyCategory)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.MemoryLobbyCategory.None; } }
  ...
  public static Offset<Schale.FlatData.MemoryLobbyExcel> CreateMemoryLobbyExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      Schale.FlatData.MemoryLobbyCategory MemoryLobbyCategory = Schale.FlatData.MemoryLobbyCategory.None,
  ...
  public static void AddMemoryLobbyCategory(FlatBufferBuilder builder, Schale.FlatData.MemoryLobbyCategory memoryLobbyCategory) { builder.AddInt(5, (int)memoryLobbyCategory, 0); }
  ...
  public static Offset<Schale.FlatData.MemoryLobbyExcel> EndMemoryLobbyExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MemoryLobbyExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MemoryLobbyExcel> Pack(FlatBufferBuilder builder, MemoryLobbyExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MemoryLobbyExcel>);
...
public class MemoryLobbyExcelT
{
  ...
  public Schale.FlatData.MemoryLobbyCategory MemoryLobbyCategory { get; set; }
  ...
  public MemoryLobbyExcelT() {
    ...
    this.MemoryLobbyCategory = Schale.FlatData.MemoryLobbyCategory.None;
...
static public class MemoryLobbyExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*MemoryLobbyCategory*/, 4 /*Schale.FlatData.MemoryLobbyCategory*/, 4, false)
