...
public struct FurnitureGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.FurnitureGroupExcel> CreateFurnitureGroupExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Schale.FlatData.FurnitureGroupExcel> EndFurnitureGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.FurnitureGroupExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.FurnitureGroupExcel> Pack(FlatBufferBuilder builder, FurnitureGroupExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.FurnitureGroupExcel>);
