...
public struct ItemExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ItemCategory ItemCategory { get { int o = __p.__offset(14); return o != 0 ? (Schale.FlatData.ItemCategory)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ItemCategory.Coin; } }
  ...
  public Schale.FlatData.ParcelType UsingResultParcelType { get { int o = __p.__offset(28); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public Schale.FlatData.MailType MailType { get { int o = __p.__offset(34); return o != 0 ? (Schale.FlatData.MailType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.MailType.System; } }
  public Schale.FlatData.ParcelType ExpiryChangeParcelType { get { int o = __p.__offset(36); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public Schale.FlatData.Tag Tags(int j) { int o = __p.__offset(46); return o != 0 ? (Schale.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(46); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.Tag> GetTagsBytes() { return __p.__vector_as_span<Schale.FlatData.Tag>(46, 4); }
#else
  ...
  public static Offset<Schale.FlatData.ItemExcel> CreateItemExcel(FlatBufferBuilder builder,
      ...
      Schale.FlatData.ParcelType UsingResultParcelType = Schale.FlatData.ParcelType.None,
  ...
  public static void AddItemCategory(FlatBufferBuilder builder, Schale.FlatData.ItemCategory itemCategory) { builder.AddInt(5, (int)itemCategory, 0); }
  ...
  public static void AddUsingResultParcelType(FlatBufferBuilder builder, Schale.FlatData.ParcelType usingResultParcelType) { builder.AddInt(12, (int)usingResultParcelType, 0); }
  ...
  public static void AddMailType(FlatBufferBuilder builder, Schale.FlatData.MailType mailType) { builder.AddInt(15, (int)mailType, 0); }
  public static void AddExpiryChangeParcelType(FlatBufferBuilder builder, Schale.FlatData.ParcelType expiryChangeParcelType) { builder.AddInt(16, (int)expiryChangeParcelType, 0); }
...
public class ItemExcelT
{
  ...
  public Schale.FlatData.ParcelType UsingResultParcelType { get; set; }
  ...
  public ItemExcelT() {
    ...
    this.UsingResultParcelType = Schale.FlatData.ParcelType.None;
...
static public class ItemExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*ItemCategory*/, 4 /*Schale.FlatData.ItemCategory*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 28 /*UsingResultParcelType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 34 /*MailType*/, 4 /*Schale.FlatData.MailType*/, 4, false)
      && verifier.VerifyField(tablePos, 36 /*ExpiryChangeParcelType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
