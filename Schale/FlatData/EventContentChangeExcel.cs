...
public struct EventContentChangeExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ParcelType ChangeCostType { get { int o = __p.__offset(16); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.EventContentChangeExcel> CreateEventContentChangeExcel(FlatBufferBuilder builder,
      ...
      long RewardId = 0,
      int RewardAmount = 0,
      Schale.FlatData.ParcelType ChangeCostType = Schale.FlatData.ParcelType.None,
      long ChangeCostId = 0,
  ...
  public static void AddChangeCostType(FlatBufferBuilder builder, Schale.FlatData.ParcelType changeCostType) { builder.AddInt(6, (int)changeCostType, 0); }
  ...
  public static Offset<Schale.FlatData.EventContentChangeExcel> EndEventContentChangeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentChangeExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.EventContentChangeExcel> Pack(FlatBufferBuilder builder, EventContentChangeExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EventContentChangeExcel>);
...
public class EventContentChangeExcelT
{
  ...
  public Schale.FlatData.ParcelType ChangeCostType { get; set; }
  ...
  public EventContentChangeExcelT() {
    ...
    this.RewardId = 0;
    this.RewardAmount = 0;
    this.ChangeCostType = Schale.FlatData.ParcelType.None;
    this.ChangeCostId = 0;
...
static public class EventContentChangeExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*ChangeCostType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
