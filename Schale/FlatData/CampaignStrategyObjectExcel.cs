...
public struct CampaignStrategyObjectExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.StrategyObjectType StrategyObjectType { get { int o = __p.__offset(12); return o != 0 ? (Schale.FlatData.StrategyObjectType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.StrategyObjectType.None; } }
  public Schale.FlatData.ParcelType StrategyRewardParcelType { get { int o = __p.__offset(14); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.CampaignStrategyObjectExcel> CreateCampaignStrategyObjectExcel(FlatBufferBuilder builder,
      long Id = 0,
      uint Key = 0,
      StringOffset NameOffset = default(StringOffset),
      StringOffset PrefabNameOffset = default(StringOffset),
      Schale.FlatData.StrategyObjectType StrategyObjectType = Schale.FlatData.StrategyObjectType.None,
      Schale.FlatData.ParcelType StrategyRewardParcelType = Schale.FlatData.ParcelType.None,
  ...
  public static void AddStrategyObjectType(FlatBufferBuilder builder, Schale.FlatData.StrategyObjectType strategyObjectType) { builder.AddInt(4, (int)strategyObjectType, 0); }
  public static void AddStrategyRewardParcelType(FlatBufferBuilder builder, Schale.FlatData.ParcelType strategyRewardParcelType) { builder.AddInt(5, (int)strategyRewardParcelType, 0); }
  ...
  public static Offset<Schale.FlatData.CampaignStrategyObjectExcel> EndCampaignStrategyObjectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CampaignStrategyObjectExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.CampaignStrategyObjectExcel> Pack(FlatBufferBuilder builder, CampaignStrategyObjectExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.CampaignStrategyObjectExcel>);
...
public class CampaignStrategyObjectExcelT
{
  ...
  public Schale.FlatData.StrategyObjectType StrategyObjectType { get; set; }
  public Schale.FlatData.ParcelType StrategyRewardParcelType { get; set; }
  ...
  public CampaignStrategyObjectExcelT() {
    ...
    this.StrategyObjectType = Schale.FlatData.StrategyObjectType.None;
    this.StrategyRewardParcelType = Schale.FlatData.ParcelType.None;
...
static public class CampaignStrategyObjectExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*StrategyObjectType*/, 4 /*Schale.FlatData.StrategyObjectType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*StrategyRewardParcelType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
