...
public struct GuideMissionSeasonExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.GuideMissionSeasonExcel> CreateGuideMissionSeasonExcel(FlatBufferBuilder builder,
      ...
      Schale.FlatData.ParcelType RequirementParcelType = Schale.FlatData.ParcelType.None,
  ...
  public static Offset<Schale.FlatData.GuideMissionSeasonExcel> Pack(FlatBufferBuilder builder, GuideMissionSeasonExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.GuideMissionSeasonExcel>);
...
public class GuideMissionSeasonExcelT
{
  ...
  public Schale.FlatData.ParcelType RequirementParcelType { get; set; }
  public long RequirementParcelId { get; set; }
  public int RequirementParcelAmount { get; set; }
  public Schale.FlatData.GuideMissionTabType TabType { get; set; }
  ...
  public GuideMissionSeasonExcelT() {
    ...
    this.RequirementParcelType = Schale.FlatData.ParcelType.None;
    this.RequirementParcelId = 0;
    this.RequirementParcelAmount = 0;
    this.TabType = Schale.FlatData.GuideMissionTabType.None;
