...
public struct EventContentDiceRaceProbExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.EventContentDiceRaceProbExcel> CreateEventContentDiceRaceProbExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.EventContentDiceRaceProbExcel> EndEventContentDiceRaceProbExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentDiceRaceProbExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.EventContentDiceRaceProbExcel> Pack(FlatBufferBuilder builder, EventContentDiceRaceProbExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EventContentDiceRaceProbExcel>);
