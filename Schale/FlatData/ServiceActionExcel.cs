...
public struct ServiceActionExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ServiceActionType ServiceActionType { get { int o = __p.__offset(4); return o != 0 ? (Schale.FlatData.ServiceActionType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ServiceActionType.ClanCreate; } }
  ...
  public static Offset<Schale.FlatData.ServiceActionExcel> CreateServiceActionExcel(FlatBufferBuilder builder,
      Schale.FlatData.ServiceActionType ServiceActionType = Schale.FlatData.ServiceActionType.ClanCreate,
      bool IsLegacy = false,
      long GoodsId = 0) {
  ...
  public static void AddServiceActionType(FlatBufferBuilder builder, Schale.FlatData.ServiceActionType serviceActionType) { builder.AddInt(0, (int)serviceActionType, 0); }
  ...
  public static Offset<Schale.FlatData.ServiceActionExcel> EndServiceActionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ServiceActionExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ServiceActionExcel> Pack(FlatBufferBuilder builder, ServiceActionExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ServiceActionExcel>);
...
{
  public Schale.FlatData.ServiceActionType ServiceActionType { get; set; }
  public bool IsLegacy { get; set; }
  public long GoodsId { get; set; }

  public ServiceActionExcelT() {
    this.ServiceActionType = Schale.FlatData.ServiceActionType.ClanCreate;
    this.IsLegacy = false;
    this.GoodsId = 0;
  }
}
...
static public class ServiceActionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*ServiceActionType*/, 4 /*Schale.FlatData.ServiceActionType*/, 4, false)
