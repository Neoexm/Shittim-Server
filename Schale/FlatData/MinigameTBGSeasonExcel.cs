...
public struct MinigameTBGSeasonExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ParcelType EventUseCostType { get { int o = __p.__offset(28); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  public long EventUseCostId { get { int o = __p.__offset(30); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Schale.FlatData.ParcelType EchelonRevivalCostType { get { int o = __p.__offset(32); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.MinigameTBGSeasonExcel> CreateMinigameTBGSeasonExcel(FlatBufferBuilder builder,
      ...
      Schale.FlatData.ParcelType EchelonRevivalCostType = Schale.FlatData.ParcelType.None,
  ...
  public static void AddEventUseCostType(FlatBufferBuilder builder, Schale.FlatData.ParcelType eventUseCostType) { builder.AddInt(12, (int)eventUseCostType, 0); }
  public static void AddEventUseCostId(FlatBufferBuilder builder, long eventUseCostId) { builder.AddLong(13, eventUseCostId, 0); }
  public static void AddEchelonRevivalCostType(FlatBufferBuilder builder, Schale.FlatData.ParcelType echelonRevivalCostType) { builder.AddInt(14, (int)echelonRevivalCostType, 0); }
  ...
  public static Offset<Schale.FlatData.MinigameTBGSeasonExcel> EndMinigameTBGSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MinigameTBGSeasonExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MinigameTBGSeasonExcel> Pack(FlatBufferBuilder builder, MinigameTBGSeasonExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MinigameTBGSeasonExcel>);
...
public class MinigameTBGSeasonExcelT
{
  ...
  public Schale.FlatData.ParcelType EchelonRevivalCostType { get; set; }
  ...
  public MinigameTBGSeasonExcelT() {
    ...
    this.EchelonRevivalCostType = Schale.FlatData.ParcelType.None;
...
static public class MinigameTBGSeasonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 28 /*EventUseCostType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
      && verifier.VerifyField(tablePos, 30 /*EventUseCostId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 32 /*EchelonRevivalCostType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
