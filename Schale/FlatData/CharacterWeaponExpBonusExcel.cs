...
public struct CharacterWeaponExpBonusExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.WeaponType WeaponType { get { int o = __p.__offset(4); return o != 0 ? (Schale.FlatData.WeaponType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.WeaponType.None; } }
  ...
  public static Offset<Schale.FlatData.CharacterWeaponExpBonusExcel> CreateCharacterWeaponExpBonusExcel(FlatBufferBuilder builder,
  ...
  public static void AddWeaponType(FlatBufferBuilder builder, Schale.FlatData.WeaponType weaponType) { builder.AddInt(0, (int)weaponType, 0); }
  ...
  public static Offset<Schale.FlatData.CharacterWeaponExpBonusExcel> EndCharacterWeaponExpBonusExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CharacterWeaponExpBonusExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.CharacterWeaponExpBonusExcel> Pack(FlatBufferBuilder builder, CharacterWeaponExpBonusExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.CharacterWeaponExpBonusExcel>);
...
static public class CharacterWeaponExpBonusExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*WeaponType*/, 4 /*Schale.FlatData.WeaponType*/, 4, false)
