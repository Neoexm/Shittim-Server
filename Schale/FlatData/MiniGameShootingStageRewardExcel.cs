...
public struct MiniGameShootingStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.MiniGameShootingStageRewardExcel> CreateMiniGameShootingStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      long RewardId = 0,
      long ClearSection = 0,
  ...
  public static Offset<Schale.FlatData.MiniGameShootingStageRewardExcel> EndMiniGameShootingStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MiniGameShootingStageRewardExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MiniGameShootingStageRewardExcel> Pack(FlatBufferBuilder builder, MiniGameShootingStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MiniGameShootingStageRewardExcel>);
