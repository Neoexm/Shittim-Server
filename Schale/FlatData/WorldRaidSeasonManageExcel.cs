...
public struct WorldRaidSeasonManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.WorldRaidSeasonManageExcel> EndWorldRaidSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.WorldRaidSeasonManageExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.WorldRaidSeasonManageExcel> Pack(FlatBufferBuilder builder, WorldRaidSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.WorldRaidSeasonManageExcel>);
