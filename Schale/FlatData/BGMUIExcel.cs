...
public struct BGMUIExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.BGMUIExcel> CreateBGMUIExcel(FlatBufferBuilder builder,
      uint UIPrefab = 0,
      long BGMId = 0,
      long BGMId2nd = 0,
      long BGMId3rd = 0,
  ...
  public static Offset<Schale.FlatData.BGMUIExcel> EndBGMUIExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.BGMUIExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.BGMUIExcel> Pack(FlatBufferBuilder builder, BGMUIExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.BGMUIExcel>);
