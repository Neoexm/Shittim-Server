...
public struct EventContentTreasureCellRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.EventContentTreasureCellRewardExcel> CreateEventContentTreasureCellRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Schale.FlatData.EventContentTreasureCellRewardExcel> EndEventContentTreasureCellRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentTreasureCellRewardExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.EventContentTreasureCellRewardExcel> Pack(FlatBufferBuilder builder, EventContentTreasureCellRewardExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EventContentTreasureCellRewardExcel>);
