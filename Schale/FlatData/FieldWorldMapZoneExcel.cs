...
public struct FieldWorldMapZoneExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.FieldConditionType OpenConditionType { get { int o = __p.__offset(10); return o != 0 ? (Schale.FlatData.FieldConditionType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.FieldConditionType.Invalid; } }
  public long OpenConditionId { get { int o = __p.__offset(12); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Schale.FlatData.FieldConditionType CloseConditionType { get { int o = __p.__offset(14); return o != 0 ? (Schale.FlatData.FieldConditionType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.FieldConditionType.Invalid; } }
  ...
  public Schale.FlatData.FieldWorldMapButtonType WorldMapButtonType { get { int o = __p.__offset(22); return o != 0 ? (Schale.FlatData.FieldWorldMapButtonType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.FieldWorldMapButtonType.DefaultMode; } }
  ...
  public static Offset<Schale.FlatData.FieldWorldMapZoneExcel> CreateFieldWorldMapZoneExcel(FlatBufferBuilder builder,
      long Id = 0,
      int GroupId = 0,
      int Date = 0,
      Schale.FlatData.FieldConditionType OpenConditionType = Schale.FlatData.FieldConditionType.Invalid,
      long OpenConditionId = 0,
      Schale.FlatData.FieldConditionType CloseConditionType = Schale.FlatData.FieldConditionType.Invalid,
      long CloseConditionId = 0,
      long ResultFieldScene = 0,
      long FieldStageInteractionId = 0,
      Schale.FlatData.FieldWorldMapButtonType WorldMapButtonType = Schale.FlatData.FieldWorldMapButtonType.DefaultMode,
      uint LocalizeCode = 0,
  ...
  public static void AddOpenConditionType(FlatBufferBuilder builder, Schale.FlatData.FieldConditionType openConditionType) { builder.AddInt(3, (int)openConditionType, 0); }
  public static void AddOpenConditionId(FlatBufferBuilder builder, long openConditionId) { builder.AddLong(4, openConditionId, 0); }
  public static void AddCloseConditionType(FlatBufferBuilder builder, Schale.FlatData.FieldConditionType closeConditionType) { builder.AddInt(5, (int)closeConditionType, 0); }
  ...
  public static void AddWorldMapButtonType(FlatBufferBuilder builder, Schale.FlatData.FieldWorldMapButtonType worldMapButtonType) { builder.AddInt(9, (int)worldMapButtonType, 0); }
  ...
  public static Offset<Schale.FlatData.FieldWorldMapZoneExcel> EndFieldWorldMapZoneExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.FieldWorldMapZoneExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.FieldWorldMapZoneExcel> Pack(FlatBufferBuilder builder, FieldWorldMapZoneExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.FieldWorldMapZoneExcel>);
...
public class FieldWorldMapZoneExcelT
{
  ...
  public Schale.FlatData.FieldConditionType OpenConditionType { get; set; }
  public long OpenConditionId { get; set; }
  public Schale.FlatData.FieldConditionType CloseConditionType { get; set; }
  public long CloseConditionId { get; set; }
  public long ResultFieldScene { get; set; }
  public long FieldStageInteractionId { get; set; }
  public Schale.FlatData.FieldWorldMapButtonType WorldMapButtonType { get; set; }
  ...
  public FieldWorldMapZoneExcelT() {
    ...
    this.GroupId = 0;
    this.Date = 0;
    this.OpenConditionType = Schale.FlatData.FieldConditionType.Invalid;
    this.OpenConditionId = 0;
    this.CloseConditionType = Schale.FlatData.FieldConditionType.Invalid;
    this.CloseConditionId = 0;
    this.ResultFieldScene = 0;
    this.FieldStageInteractionId = 0;
    this.WorldMapButtonType = Schale.FlatData.FieldWorldMapButtonType.DefaultMode;
    this.LocalizeCode = 0;
...
static public class FieldWorldMapZoneExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*OpenConditionType*/, 4 /*Schale.FlatData.FieldConditionType*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*OpenConditionId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 14 /*CloseConditionType*/, 4 /*Schale.FlatData.FieldConditionType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 22 /*WorldMapButtonType*/, 4 /*Schale.FlatData.FieldWorldMapButtonType*/, 4, false)
