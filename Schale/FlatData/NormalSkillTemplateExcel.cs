...
public struct NormalSkillTemplateExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.NormalSkillTemplateExcel> CreateNormalSkillTemplateExcel(FlatBufferBuilder builder,
      long Index = 0,
  ...
  public static Offset<Schale.FlatData.NormalSkillTemplateExcel> EndNormalSkillTemplateExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.NormalSkillTemplateExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.NormalSkillTemplateExcel> Pack(FlatBufferBuilder builder, NormalSkillTemplateExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.NormalSkillTemplateExcel>);
