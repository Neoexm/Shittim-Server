...
public struct MessagePopupExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.MessagePopupLayout MessagePopupLayout { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.MessagePopupLayout)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.MessagePopupLayout.TextOnly; } }
  public Schale.FlatData.MessagePopupImagePositionType OrderType { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.MessagePopupImagePositionType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.MessagePopupImagePositionType.ImageFirst; } }
  ...
  public Schale.FlatData.MessagePopupButtonType Button(int j) { int o = __p.__offset(22); return o != 0 ? (Schale.FlatData.MessagePopupButtonType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.MessagePopupButtonType)0; }
  public int ButtonLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.MessagePopupButtonType> GetButtonBytes() { return __p.__vector_as_span<Schale.FlatData.MessagePopupButtonType>(22, 4); }
#else
  public ArraySegment<byte>? GetButtonBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public Schale.FlatData.MessagePopupButtonType[] GetButtonArray() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.MessagePopupButtonType[] a = new Schale.FlatData.MessagePopupButtonType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.MessagePopupButtonType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.MessagePopupExcel> CreateMessagePopupExcel(FlatBufferBuilder builder,
      uint StringId = 0,
      Schale.FlatData.MessagePopupLayout MessagePopupLayout = Schale.FlatData.MessagePopupLayout.TextOnly,
      Schale.FlatData.MessagePopupImagePositionType OrderType = Schale.FlatData.MessagePopupImagePositionType.ImageFirst,
  ...
  public static void AddMessagePopupLayout(FlatBufferBuilder builder, Schale.FlatData.MessagePopupLayout messagePopupLayout) { builder.AddInt(1, (int)messagePopupLayout, 0); }
  public static void AddOrderType(FlatBufferBuilder builder, Schale.FlatData.MessagePopupImagePositionType orderType) { builder.AddInt(2, (int)orderType, 0); }
  ...
  public static VectorOffset CreateButtonVector(FlatBufferBuilder builder, Schale.FlatData.MessagePopupButtonType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateButtonVectorBlock(FlatBufferBuilder builder, Schale.FlatData.MessagePopupButtonType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateButtonVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.MessagePopupButtonType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateButtonVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.MessagePopupButtonType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Schale.FlatData.MessagePopupExcel> EndMessagePopupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MessagePopupExcel>(o);
  }
  ...
  public void UnPackTo(MessagePopupExcelT _o) {
    ...
    _o.Button = new List<Schale.FlatData.MessagePopupButtonType>();
  ...
  public static Offset<Schale.FlatData.MessagePopupExcel> Pack(FlatBufferBuilder builder, MessagePopupExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MessagePopupExcel>);
...
public class MessagePopupExcelT
{
  ...
  public Schale.FlatData.MessagePopupLayout MessagePopupLayout { get; set; }
  public Schale.FlatData.MessagePopupImagePositionType OrderType { get; set; }
  ...
  public List<Schale.FlatData.MessagePopupButtonType> Button { get; set; }
  ...
  public MessagePopupExcelT() {
    this.StringId = 0;
    this.MessagePopupLayout = Schale.FlatData.MessagePopupLayout.TextOnly;
    this.OrderType = Schale.FlatData.MessagePopupImagePositionType.ImageFirst;
    this.Image = null;
    this.TitleText = 0;
    this.SubTitleText = 0;
    this.MessageText = 0;
...
static public class MessagePopupExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*MessagePopupLayout*/, 4 /*Schale.FlatData.MessagePopupLayout*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*OrderType*/, 4 /*Schale.FlatData.MessagePopupImagePositionType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 22 /*Button*/, 4 /*Schale.FlatData.MessagePopupButtonType*/, false)
