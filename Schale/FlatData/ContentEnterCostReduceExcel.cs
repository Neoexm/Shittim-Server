...
public struct ContentEnterCostReduceExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ParcelType ReduceEnterCostType { get { int o = __p.__offset(10); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.ContentEnterCostReduceExcel> CreateContentEnterCostReduceExcel(FlatBufferBuilder builder,
      long EnterCostReduceGroupId = 0,
      Schale.FlatData.ContentType ContentType = Schale.FlatData.ContentType.None,
      long StageId = 0,
      Schale.FlatData.ParcelType ReduceEnterCostType = Schale.FlatData.ParcelType.None,
  ...
  public static void AddReduceEnterCostType(FlatBufferBuilder builder, Schale.FlatData.ParcelType reduceEnterCostType) { builder.AddInt(3, (int)reduceEnterCostType, 0); }
  ...
  public static Offset<Schale.FlatData.ContentEnterCostReduceExcel> EndContentEnterCostReduceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ContentEnterCostReduceExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ContentEnterCostReduceExcel> Pack(FlatBufferBuilder builder, ContentEnterCostReduceExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ContentEnterCostReduceExcel>);
...
public class ContentEnterCostReduceExcelT
{
  ...
  public Schale.FlatData.ParcelType ReduceEnterCostType { get; set; }
  ...
  public ContentEnterCostReduceExcelT() {
    ...
    this.StageId = 0;
    this.ReduceEnterCostType = Schale.FlatData.ParcelType.None;
...
static public class ContentEnterCostReduceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ReduceEnterCostType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
