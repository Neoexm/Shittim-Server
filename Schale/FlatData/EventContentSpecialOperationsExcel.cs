...
public struct EventContentSpecialOperationsExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.EventContentSpecialOperationsExcel> CreateEventContentSpecialOperationsExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.EventContentSpecialOperationsExcel> EndEventContentSpecialOperationsExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentSpecialOperationsExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.EventContentSpecialOperationsExcel> Pack(FlatBufferBuilder builder, EventContentSpecialOperationsExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EventContentSpecialOperationsExcel>);
