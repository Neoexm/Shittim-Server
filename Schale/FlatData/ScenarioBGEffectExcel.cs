...
public struct ScenarioBGEffectExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ScenarioBGScroll Scroll { get { int o = __p.__offset(10); return o != 0 ? (Schale.FlatData.ScenarioBGScroll)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ScenarioBGScroll.None; } }
  ...
  public static Offset<Schale.FlatData.ScenarioBGEffectExcel> CreateScenarioBGEffectExcel(FlatBufferBuilder builder,
      uint Name = 0,
      StringOffset EffectOffset = default(StringOffset),
      StringOffset Effect2Offset = default(StringOffset),
      Schale.FlatData.ScenarioBGScroll Scroll = Schale.FlatData.ScenarioBGScroll.None,
      long ScrollTime = 0,
      long ScrollFrom = 0,
      long ScrollTo = 0) {
  ...
  public static void AddScroll(FlatBufferBuilder builder, Schale.FlatData.ScenarioBGScroll scroll) { builder.AddInt(3, (int)scroll, 0); }
  ...
  public static Offset<Schale.FlatData.ScenarioBGEffectExcel> EndScenarioBGEffectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ScenarioBGEffectExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ScenarioBGEffectExcel> Pack(FlatBufferBuilder builder, ScenarioBGEffectExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ScenarioBGEffectExcel>);
...
public class ScenarioBGEffectExcelT
{
  ...
  public Schale.FlatData.ScenarioBGScroll Scroll { get; set; }
  ...
  public ScenarioBGEffectExcelT() {
    ...
    this.Effect = null;
    this.Effect2 = null;
    this.Scroll = Schale.FlatData.ScenarioBGScroll.None;
    this.ScrollTime = 0;
    this.ScrollFrom = 0;
    this.ScrollTo = 0;
  }
...
static public class ScenarioBGEffectExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*Scroll*/, 4 /*Schale.FlatData.ScenarioBGScroll*/, 4, false)
