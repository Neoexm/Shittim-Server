...
public struct MiniGameAudioAnimatorExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.MiniGameAudioAnimatorExcel> CreateMiniGameAudioAnimatorExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.MiniGameAudioAnimatorExcel> EndMiniGameAudioAnimatorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MiniGameAudioAnimatorExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MiniGameAudioAnimatorExcel> Pack(FlatBufferBuilder builder, MiniGameAudioAnimatorExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MiniGameAudioAnimatorExcel>);
