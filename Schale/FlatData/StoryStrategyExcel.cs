...
public struct StoryStrategyExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.StageTopography StageTopography { get { int o = __p.__offset(22); return o != 0 ? (Schale.FlatData.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.StageTopography.Street; } }
  public Schale.FlatData.StrategyEnvironment StrategyEnvironment { get { int o = __p.__offset(24); return o != 0 ? (Schale.FlatData.StrategyEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.StrategyEnvironment.None; } }
  public Schale.FlatData.ContentType ContentType { get { int o = __p.__offset(26); return o != 0 ? (Schale.FlatData.ContentType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ContentType.None; } }
  ...
  public static Offset<Schale.FlatData.StoryStrategyExcel> CreateStoryStrategyExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, Schale.FlatData.StageTopography stageTopography) { builder.AddInt(9, (int)stageTopography, 0); }
  public static void AddStrategyEnvironment(FlatBufferBuilder builder, Schale.FlatData.StrategyEnvironment strategyEnvironment) { builder.AddInt(10, (int)strategyEnvironment, 0); }
  public static void AddContentType(FlatBufferBuilder builder, Schale.FlatData.ContentType contentType) { builder.AddInt(11, (int)contentType, 0); }
  ...
  public static Offset<Schale.FlatData.StoryStrategyExcel> EndStoryStrategyExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.StoryStrategyExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.StoryStrategyExcel> Pack(FlatBufferBuilder builder, StoryStrategyExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.StoryStrategyExcel>);
...
static public class StoryStrategyExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*StageTopography*/, 4 /*Schale.FlatData.StageTopography*/, 4, false)
      && verifier.VerifyField(tablePos, 24 /*StrategyEnvironment*/, 4 /*Schale.FlatData.StrategyEnvironment*/, 4, false)
      && verifier.VerifyField(tablePos, 26 /*ContentType*/, 4 /*Schale.FlatData.ContentType*/, 4, false)
