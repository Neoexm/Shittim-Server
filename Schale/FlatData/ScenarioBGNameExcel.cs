...
public struct ScenarioBGNameExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ScenarioBGType BGType { get { int o = __p.__offset(10); return o != 0 ? (Schale.FlatData.ScenarioBGType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ScenarioBGType.None; } }
  ...
  public static Offset<Schale.FlatData.ScenarioBGNameExcel> CreateScenarioBGNameExcel(FlatBufferBuilder builder,
      uint Name = 0,
      ...
      Schale.FlatData.ScenarioBGType BGType = Schale.FlatData.ScenarioBGType.None,
  ...
  public static void AddBGType(FlatBufferBuilder builder, Schale.FlatData.ScenarioBGType bGType) { builder.AddInt(3, (int)bGType, 0); }
  ...
  public static Offset<Schale.FlatData.ScenarioBGNameExcel> EndScenarioBGNameExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ScenarioBGNameExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ScenarioBGNameExcel> Pack(FlatBufferBuilder builder, ScenarioBGNameExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ScenarioBGNameExcel>);
...
public class ScenarioBGNameExcelT
{
  ...
  public Schale.FlatData.ScenarioBGType BGType { get; set; }
  ...
  public ScenarioBGNameExcelT() {
    ...
    this.BGType = Schale.FlatData.ScenarioBGType.None;
...
static public class ScenarioBGNameExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*BGType*/, 4 /*Schale.FlatData.ScenarioBGType*/, 4, false)
