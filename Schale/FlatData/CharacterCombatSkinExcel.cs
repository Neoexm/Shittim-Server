...
public struct CharacterCombatSkinExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.CharacterCombatSkinExcel> CreateCharacterCombatSkinExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.CharacterCombatSkinExcel> EndCharacterCombatSkinExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CharacterCombatSkinExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.CharacterCombatSkinExcel> Pack(FlatBufferBuilder builder, CharacterCombatSkinExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.CharacterCombatSkinExcel>);
