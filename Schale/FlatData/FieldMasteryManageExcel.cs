...
public struct FieldMasteryManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.FieldMasteryManageExcel> CreateFieldMasteryManageExcel(FlatBufferBuilder builder,
      long FieldSeason = 0,
      uint LocalizeEtc = 0,
  ...
  public static Offset<Schale.FlatData.FieldMasteryManageExcel> EndFieldMasteryManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.FieldMasteryManageExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.FieldMasteryManageExcel> Pack(FlatBufferBuilder builder, FieldMasteryManageExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.FieldMasteryManageExcel>);
