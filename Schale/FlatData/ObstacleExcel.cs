...
public struct ObstacleExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ObstacleDestroyType DestroyType { get { int o = __p.__offset(24); return o != 0 ? (Schale.FlatData.ObstacleDestroyType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ObstacleDestroyType.Remain; } }
  ...
  public static Offset<Schale.FlatData.ObstacleExcel> CreateObstacleExcel(FlatBufferBuilder builder,
      long Index = 0,
      ...
      int BlockRate = 0,
      int EvasionRate = 0,
      Schale.FlatData.ObstacleDestroyType DestroyType = Schale.FlatData.ObstacleDestroyType.Remain,
  ...
  public static void AddDestroyType(FlatBufferBuilder builder, Schale.FlatData.ObstacleDestroyType destroyType) { builder.AddInt(10, (int)destroyType, 0); }
  ...
  public static Offset<Schale.FlatData.ObstacleExcel> EndObstacleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ObstacleExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ObstacleExcel> Pack(FlatBufferBuilder builder, ObstacleExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ObstacleExcel>);
...
public class ObstacleExcelT
{
  ...
  public Schale.FlatData.ObstacleDestroyType DestroyType { get; set; }
  ...
  public ObstacleExcelT() {
    ...
    this.BlockRate = 0;
    this.EvasionRate = 0;
    this.DestroyType = Schale.FlatData.ObstacleDestroyType.Remain;
...
static public class ObstacleExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 24 /*DestroyType*/, 4 /*Schale.FlatData.ObstacleDestroyType*/, 4, false)
