...
public struct BlendInfo : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.BlendInfo> EndBlendInfo(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.BlendInfo>(o);
  }
  ...
  public static Offset<Schale.FlatData.BlendInfo> Pack(FlatBufferBuilder builder, BlendInfoT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.BlendInfo>);
