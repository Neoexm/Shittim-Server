...
public struct MissionExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.MissionCategory Category { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.MissionCategory)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.MissionCategory.Challenge; } }
  public uint Description { get { int o = __p.__offset(8); return o != 0 ? __p.bb.GetUint(o + __p.bb_pos) : (uint)0; } }
  public Schale.FlatData.MissionResetType ResetType { get { int o = __p.__offset(10); return o != 0 ? (Schale.FlatData.MissionResetType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.MissionResetType.None; } }
  public Schale.FlatData.MissionToastDisplayConditionType ToastDisplayType { get { int o = __p.__offset(12); return o != 0 ? (Schale.FlatData.MissionToastDisplayConditionType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.MissionToastDisplayConditionType.Always; } }
  ...
  public Schale.FlatData.ContentType DateAutoRefer { get { int o = __p.__offset(28); return o != 0 ? (Schale.FlatData.ContentType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ContentType.None; } }
...
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.SuddenMissionContentType> GetContentTagsBytes() { return __p.__vector_as_span<Schale.FlatData.SuddenMissionContentType>(38, 4); }
#else
  public ArraySegment<byte>? GetContentTagsBytes() { return __p.__vector_as_arraysegment(38); }
#endif
  public Schale.FlatData.SuddenMissionContentType[] GetContentTagsArray() { int o = __p.__offset(38); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.SuddenMissionContentType[] a = new Schale.FlatData.SuddenMissionContentType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.SuddenMissionContentType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Schale.FlatData.MissionCompleteConditionType CompleteConditionType { get { int o = __p.__offset(44); return o != 0 ? (Schale.FlatData.MissionCompleteConditionType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.MissionCompleteConditionType.None; } }
  ...
  public Schale.FlatData.Tag CompleteConditionParameterTag(int j) { int o = __p.__offset(50); return o != 0 ? (Schale.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.Tag)0; }
  public int CompleteConditionParameterTagLength { get { int o = __p.__offset(50); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.Tag> GetCompleteConditionParameterTagBytes() { return __p.__vector_as_span<Schale.FlatData.Tag>(50, 4); }
#else
  public ArraySegment<byte>? GetCompleteConditionParameterTagBytes() { return __p.__vector_as_arraysegment(50); }
#endif
  public Schale.FlatData.Tag[] GetCompleteConditionParameterTagArray() { int o = __p.__offset(50); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.Tag[] a = new Schale.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Schale.FlatData.ParcelType MissionRewardParcelType(int j) { int o = __p.__offset(54); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.ParcelType)0; }
  public int MissionRewardParcelTypeLength { get { int o = __p.__offset(54); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.ParcelType> GetMissionRewardParcelTypeBytes() { return __p.__vector_as_span<Schale.FlatData.ParcelType>(54, 4); }
#else
  public ArraySegment<byte>? GetMissionRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(54); }
#endif
  public Schale.FlatData.ParcelType[] GetMissionRewardParcelTypeArray() { int o = __p.__offset(54); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.ParcelType[] a = new Schale.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.MissionExcel> CreateMissionExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddCategory(FlatBufferBuilder builder, Schale.FlatData.MissionCategory category) { builder.AddInt(1, (int)category, 0); }
  public static void AddDescription(FlatBufferBuilder builder, uint description) { builder.AddUint(2, description, 0); }
  public static void AddResetType(FlatBufferBuilder builder, Schale.FlatData.MissionResetType resetType) { builder.AddInt(3, (int)resetType, 0); }
  public static void AddToastDisplayType(FlatBufferBuilder builder, Schale.FlatData.MissionToastDisplayConditionType toastDisplayType) { builder.AddInt(4, (int)toastDisplayType, 0); }
  ...
  public static void AddDateAutoRefer(FlatBufferBuilder builder, Schale.FlatData.ContentType dateAutoRefer) { builder.AddInt(12, (int)dateAutoRefer, 0); }
  ...
  public static VectorOffset CreateContentTagsVectorBlock(FlatBufferBuilder builder, Schale.FlatData.SuddenMissionContentType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateContentTagsVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.SuddenMissionContentType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateContentTagsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.SuddenMissionContentType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddCompleteConditionType(FlatBufferBuilder builder, Schale.FlatData.MissionCompleteConditionType completeConditionType) { builder.AddInt(20, (int)completeConditionType, 0); }
  ...
  public static Offset<Schale.FlatData.MissionExcel> EndMissionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MissionExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MissionExcel> Pack(FlatBufferBuilder builder, MissionExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MissionExcel>);
...
static public class MissionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*Category*/, 4 /*Schale.FlatData.MissionCategory*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*Description*/, 4 /*uint*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*ResetType*/, 4 /*Schale.FlatData.MissionResetType*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*ToastDisplayType*/, 4 /*Schale.FlatData.MissionToastDisplayConditionType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 44 /*CompleteConditionType*/, 4 /*Schale.FlatData.MissionCompleteConditionType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 50 /*CompleteConditionParameterTag*/, 4 /*Schale.FlatData.Tag*/, false)
      && verifier.VerifyString(tablePos, 52 /*RewardIcon*/, false)
      && verifier.VerifyVectorOfData(tablePos, 54 /*MissionRewardParcelType*/, 4 /*Schale.FlatData.ParcelType*/, false)
