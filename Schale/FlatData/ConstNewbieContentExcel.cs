...
public struct ConstNewbieContentExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.ConstNewbieContentExcel> CreateConstNewbieContentExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.ConstNewbieContentExcel> EndConstNewbieContentExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ConstNewbieContentExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ConstNewbieContentExcel> Pack(FlatBufferBuilder builder, ConstNewbieContentExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ConstNewbieContentExcel>);
