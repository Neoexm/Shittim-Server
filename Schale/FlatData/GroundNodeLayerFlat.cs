...
public struct GroundNodeLayerFlat : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.GroundNodeLayerFlat> CreateGroundNodeLayerFlat(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.GroundNodeLayerFlat> EndGroundNodeLayerFlat(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.GroundNodeLayerFlat>(o);
  }
  ...
  public static Offset<Schale.FlatData.GroundNodeLayerFlat> Pack(FlatBufferBuilder builder, GroundNodeLayerFlatT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.GroundNodeLayerFlat>);
