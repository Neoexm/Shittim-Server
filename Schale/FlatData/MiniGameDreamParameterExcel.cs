...
public struct MiniGameDreamParameterExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.DreamMakerParameterType ParameterType { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.DreamMakerParameterType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.DreamMakerParameterType.None; } }
  ...
  public static Offset<Schale.FlatData.MiniGameDreamParameterExcel> CreateMiniGameDreamParameterExcel(FlatBufferBuilder builder,
      long Id = 0,
      long EventContentId = 0,
      Schale.FlatData.DreamMakerParameterType ParameterType = Schale.FlatData.DreamMakerParameterType.None,
  ...
  public static void AddParameterType(FlatBufferBuilder builder, Schale.FlatData.DreamMakerParameterType parameterType) { builder.AddInt(2, (int)parameterType, 0); }
  ...
  public static Offset<Schale.FlatData.MiniGameDreamParameterExcel> EndMiniGameDreamParameterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MiniGameDreamParameterExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MiniGameDreamParameterExcel> Pack(FlatBufferBuilder builder, MiniGameDreamParameterExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MiniGameDreamParameterExcel>);
...
public class MiniGameDreamParameterExcelT
{
  ...
  public Schale.FlatData.DreamMakerParameterType ParameterType { get; set; }
  ...
  public MiniGameDreamParameterExcelT() {
    ...
    this.ParameterType = Schale.FlatData.DreamMakerParameterType.None;
...
static public class MiniGameDreamParameterExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ParameterType*/, 4 /*Schale.FlatData.DreamMakerParameterType*/, 4, false)
