...
public struct LocalizeErrorExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.WebAPIErrorLevel ErrorLevel { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.WebAPIErrorLevel)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.WebAPIErrorLevel.None; } }
  ...
  public static Offset<Schale.FlatData.LocalizeErrorExcel> CreateLocalizeErrorExcel(FlatBufferBuilder builder,
      uint Key = 0,
      Schale.FlatData.WebAPIErrorLevel ErrorLevel = Schale.FlatData.WebAPIErrorLevel.None,
  ...
  public static void AddErrorLevel(FlatBufferBuilder builder, Schale.FlatData.WebAPIErrorLevel errorLevel) { builder.AddInt(1, (int)errorLevel, 0); }
  ...
  public static Offset<Schale.FlatData.LocalizeErrorExcel> EndLocalizeErrorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.LocalizeErrorExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.LocalizeErrorExcel> Pack(FlatBufferBuilder builder, LocalizeErrorExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.LocalizeErrorExcel>);
...
public class LocalizeErrorExcelT
{
  ...
  public Schale.FlatData.WebAPIErrorLevel ErrorLevel { get; set; }
  ...
  public LocalizeErrorExcelT() {
    this.Key = 0;
    this.ErrorLevel = Schale.FlatData.WebAPIErrorLevel.None;
    this.Kr = null;
    this.Jp = null;
    this.Th = null;
    this.Tw = null;
...
static public class LocalizeErrorExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ErrorLevel*/, 4 /*Schale.FlatData.WebAPIErrorLevel*/, 4, false)
