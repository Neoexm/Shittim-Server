...
public struct FieldCurtainCallFreeModeExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.FieldCurtainCallFreeModeExcel> CreateFieldCurtainCallFreeModeExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long OpenDate = 0,
  ...
  public static Offset<Schale.FlatData.FieldCurtainCallFreeModeExcel> EndFieldCurtainCallFreeModeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.FieldCurtainCallFreeModeExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.FieldCurtainCallFreeModeExcel> Pack(FlatBufferBuilder builder, FieldCurtainCallFreeModeExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.FieldCurtainCallFreeModeExcel>);
