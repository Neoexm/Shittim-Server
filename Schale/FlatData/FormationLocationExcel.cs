...
public struct FormationLocationExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.FormationLocationExcel> CreateFormationLocationExcel(FlatBufferBuilder builder,
      long Id = 0,
      long GroupID = 0,
  ...
  public static Offset<Schale.FlatData.FormationLocationExcel> EndFormationLocationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.FormationLocationExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.FormationLocationExcel> Pack(FlatBufferBuilder builder, FormationLocationExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.FormationLocationExcel>);
