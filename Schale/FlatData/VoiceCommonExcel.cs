...
public struct VoiceCommonExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.VoiceEvent VoiceEvent { get { int o = __p.__offset(4); return o != 0 ? (Schale.FlatData.VoiceEvent)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.VoiceEvent.OnTSA; } }
  ...
  public static Offset<Schale.FlatData.VoiceCommonExcel> CreateVoiceCommonExcel(FlatBufferBuilder builder,
      Schale.FlatData.VoiceEvent VoiceEvent = Schale.FlatData.VoiceEvent.OnTSA,
      long Rate = 0,
  ...
  public static void AddVoiceEvent(FlatBufferBuilder builder, Schale.FlatData.VoiceEvent voiceEvent) { builder.AddInt(0, (int)voiceEvent, 0); }
  ...
  public static Offset<Schale.FlatData.VoiceCommonExcel> EndVoiceCommonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.VoiceCommonExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.VoiceCommonExcel> Pack(FlatBufferBuilder builder, VoiceCommonExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.VoiceCommonExcel>);
...
{
  public Schale.FlatData.VoiceEvent VoiceEvent { get; set; }
  public long Rate { get; set; }
  public List<uint> VoiceHash { get; set; }

  public VoiceCommonExcelT() {
    this.VoiceEvent = Schale.FlatData.VoiceEvent.OnTSA;
    this.Rate = 0;
    this.VoiceHash = null;
  }
}
...
static public class VoiceCommonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*VoiceEvent*/, 4 /*Schale.FlatData.VoiceEvent*/, 4, false)
