...
public struct PickupDuplicateBonusExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ShopCategoryType ShopCategoryType { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ShopCategoryType.General; } }
  ...
  public static Offset<Schale.FlatData.PickupDuplicateBonusExcel> CreatePickupDuplicateBonusExcel(FlatBufferBuilder builder,
      long Id = 0,
      Schale.FlatData.ShopCategoryType ShopCategoryType = Schale.FlatData.ShopCategoryType.General,
      long ShopId = 0,
  ...
  public static void AddShopCategoryType(FlatBufferBuilder builder, Schale.FlatData.ShopCategoryType shopCategoryType) { builder.AddInt(1, (int)shopCategoryType, 0); }
  ...
  public static Offset<Schale.FlatData.PickupDuplicateBonusExcel> EndPickupDuplicateBonusExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.PickupDuplicateBonusExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.PickupDuplicateBonusExcel> Pack(FlatBufferBuilder builder, PickupDuplicateBonusExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.PickupDuplicateBonusExcel>);
...
public class PickupDuplicateBonusExcelT
{
  ...
  public Schale.FlatData.ShopCategoryType ShopCategoryType { get; set; }
  ...
  public PickupDuplicateBonusExcelT() {
    this.Id = 0;
    this.ShopCategoryType = Schale.FlatData.ShopCategoryType.General;
    this.ShopId = 0;
...
static public class PickupDuplicateBonusExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ShopCategoryType*/, 4 /*Schale.FlatData.ShopCategoryType*/, 4, false)
