...
public struct MiniGameShootingStageExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.Difficulty Difficulty { get { int o = __p.__offset(10); return o != 0 ? (Schale.FlatData.Difficulty)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.Difficulty.Normal; } }
  ...
  public static Offset<Schale.FlatData.MiniGameShootingStageExcel> CreateMiniGameShootingStageExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static void AddDifficulty(FlatBufferBuilder builder, Schale.FlatData.Difficulty difficulty) { builder.AddInt(3, (int)difficulty, 0); }
  ...
  public static Offset<Schale.FlatData.MiniGameShootingStageExcel> EndMiniGameShootingStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MiniGameShootingStageExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MiniGameShootingStageExcel> Pack(FlatBufferBuilder builder, MiniGameShootingStageExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MiniGameShootingStageExcel>);
...
static public class MiniGameShootingStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*Difficulty*/, 4 /*Schale.FlatData.Difficulty*/, 4, false)
