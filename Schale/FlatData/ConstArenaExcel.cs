...
public struct ConstArenaExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ParcelType EnterCostType { get { int o = __p.__offset(16); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public Schale.FlatData.StatType ModifiedStatType(int j) { int o = __p.__offset(34); return o != 0 ? (Schale.FlatData.StatType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.StatType)0; }
  public int ModifiedStatTypeLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.StatType> GetModifiedStatTypeBytes() { return __p.__vector_as_span<Schale.FlatData.StatType>(34, 4); }
#else
  public ArraySegment<byte>? GetModifiedStatTypeBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public Schale.FlatData.StatType[] GetModifiedStatTypeArray() { int o = __p.__offset(34); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.StatType[] a = new Schale.FlatData.StatType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.StatType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.ConstArenaExcel> CreateConstArenaExcel(FlatBufferBuilder builder,
      ...
      Schale.FlatData.ParcelType EnterCostType = Schale.FlatData.ParcelType.None,
      long EnterCostId = 0,
      long TicketCost = 0,
  ...
  public static void AddEnterCostType(FlatBufferBuilder builder, Schale.FlatData.ParcelType enterCostType) { builder.AddInt(6, (int)enterCostType, 0); }
  ...
  public static VectorOffset CreateModifiedStatTypeVector(FlatBufferBuilder builder, Schale.FlatData.StatType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateModifiedStatTypeVectorBlock(FlatBufferBuilder builder, Schale.FlatData.StatType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateModifiedStatTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.StatType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateModifiedStatTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.StatType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Schale.FlatData.ConstArenaExcel> EndConstArenaExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ConstArenaExcel>(o);
  }
  ...
  public void UnPackTo(ConstArenaExcelT _o) {
    ...
    _o.ModifiedStatType = new List<Schale.FlatData.StatType>();
  ...
  public static Offset<Schale.FlatData.ConstArenaExcel> Pack(FlatBufferBuilder builder, ConstArenaExcelT _o) {
...
public class ConstArenaExcelT
{
  ...
  public Schale.FlatData.ParcelType EnterCostType { get; set; }
  ...
  public List<Schale.FlatData.StatType> ModifiedStatType { get; set; }
  ...
  public ConstArenaExcelT() {
    ...
    this.EnterCostType = Schale.FlatData.ParcelType.None;
    this.EnterCostId = 0;
    this.TicketCost = 0;
...
static public class ConstArenaExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*EnterCostType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 34 /*ModifiedStatType*/, 4 /*Schale.FlatData.StatType*/, false)
