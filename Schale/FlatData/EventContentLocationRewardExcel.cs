...
public struct EventContentLocationRewardExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ParcelType ExtraRewardParcelType(int j) { int o = __p.__offset(30); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.ParcelType)0; }
  public int ExtraRewardParcelTypeLength { get { int o = __p.__offset(30); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.ParcelType> GetExtraRewardParcelTypeBytes() { return __p.__vector_as_span<Schale.FlatData.ParcelType>(30, 4); }
#else
  public ArraySegment<byte>? GetExtraRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(30); }
#endif
  public Schale.FlatData.ParcelType[] GetExtraRewardParcelTypeArray() { int o = __p.__offset(30); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.ParcelType[] a = new Schale.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Schale.FlatData.ParcelType RewardParcelType(int j) { int o = __p.__offset(40); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.ParcelType)0; }
  public int RewardParcelTypeLength { get { int o = __p.__offset(40); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.ParcelType> GetRewardParcelTypeBytes() { return __p.__vector_as_span<Schale.FlatData.ParcelType>(40, 4); }
#else
  public ArraySegment<byte>? GetRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(40); }
#endif
  public Schale.FlatData.ParcelType[] GetRewardParcelTypeArray() { int o = __p.__offset(40); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.ParcelType[] a = new Schale.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.EventContentLocationRewardExcel> CreateEventContentLocationRewardExcel(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateExtraRewardParcelTypeVector(FlatBufferBuilder builder, Schale.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateExtraRewardParcelTypeVectorBlock(FlatBufferBuilder builder, Schale.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateExtraRewardParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateExtraRewardParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Schale.FlatData.EventContentLocationRewardExcel> EndEventContentLocationRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentLocationRewardExcel>(o);
  }
  ...
  public void UnPackTo(EventContentLocationRewardExcelT _o) {
    ...
    _o.ExtraRewardParcelType = new List<Schale.FlatData.ParcelType>();
  ...
  public static Offset<Schale.FlatData.EventContentLocationRewardExcel> Pack(FlatBufferBuilder builder, EventContentLocationRewardExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EventContentLocationRewardExcel>);
...
public class EventContentLocationRewardExcelT
{
  ...
  public List<Schale.FlatData.ParcelType> ExtraRewardParcelType { get; set; }
...
static public class EventContentLocationRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 30 /*ExtraRewardParcelType*/, 4 /*Schale.FlatData.ParcelType*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 40 /*RewardParcelType*/, 4 /*Schale.FlatData.ParcelType*/, false)
