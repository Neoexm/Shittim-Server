...
public struct BuffParticleExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.BuffParticleExcel> CreateBuffParticleExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<Schale.FlatData.BuffParticleExcel> EndBuffParticleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.BuffParticleExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.BuffParticleExcel> Pack(FlatBufferBuilder builder, BuffParticleExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.BuffParticleExcel>);
