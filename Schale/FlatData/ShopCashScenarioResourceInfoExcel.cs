...
public struct ShopCashScenarioResourceInfoExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.ShopCashScenarioResourceInfoExcel> CreateShopCashScenarioResourceInfoExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.ShopCashScenarioResourceInfoExcel> EndShopCashScenarioResourceInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ShopCashScenarioResourceInfoExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ShopCashScenarioResourceInfoExcel> Pack(FlatBufferBuilder builder, ShopCashScenarioResourceInfoExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ShopCashScenarioResourceInfoExcel>);
