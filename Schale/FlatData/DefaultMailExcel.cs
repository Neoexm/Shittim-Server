...
public struct DefaultMailExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.MailType MailType { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.MailType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.MailType.System; } }
  ...
  public static Offset<Schale.FlatData.DefaultMailExcel> CreateDefaultMailExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddMailType(FlatBufferBuilder builder, Schale.FlatData.MailType mailType) { builder.AddInt(2, (int)mailType, 0); }
  ...
  public static Offset<Schale.FlatData.DefaultMailExcel> EndDefaultMailExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.DefaultMailExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.DefaultMailExcel> Pack(FlatBufferBuilder builder, DefaultMailExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.DefaultMailExcel>);
...
static public class DefaultMailExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*MailType*/, 4 /*Schale.FlatData.MailType*/, 4, false)
