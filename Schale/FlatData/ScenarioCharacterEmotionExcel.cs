...
public struct ScenarioCharacterEmotionExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.ScenarioCharacterEmotionExcel> CreateScenarioCharacterEmotionExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.ScenarioCharacterEmotionExcel> EndScenarioCharacterEmotionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ScenarioCharacterEmotionExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ScenarioCharacterEmotionExcel> Pack(FlatBufferBuilder builder, ScenarioCharacterEmotionExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ScenarioCharacterEmotionExcel>);
