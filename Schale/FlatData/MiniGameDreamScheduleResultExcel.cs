...
public struct MiniGameDreamScheduleResultExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.DreamMakerResult DreamMakerResult { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.DreamMakerResult)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.DreamMakerResult.None; } }
  ...
  public Schale.FlatData.DreamMakerParameterType RewardParameter(int j) { int o = __p.__offset(14); return o != 0 ? (Schale.FlatData.DreamMakerParameterType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.DreamMakerParameterType)0; }
  public int RewardParameterLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.DreamMakerParameterType> GetRewardParameterBytes() { return __p.__vector_as_span<Schale.FlatData.DreamMakerParameterType>(14, 4); }
#else
  ...
  public Schale.FlatData.DreamMakerParamOperationType RewardParameterOperationType(int j) { int o = __p.__offset(16); return o != 0 ? (Schale.FlatData.DreamMakerParamOperationType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.DreamMakerParamOperationType)0; }
  public int RewardParameterOperationTypeLength { get { int o = __p.__offset(16); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.DreamMakerParamOperationType> GetRewardParameterOperationTypeBytes() { return __p.__vector_as_span<Schale.FlatData.DreamMakerParamOperationType>(16, 4); }
#else
  public ArraySegment<byte>? GetRewardParameterOperationTypeBytes() { return __p.__vector_as_arraysegment(16); }
#endif
  public Schale.FlatData.DreamMakerParamOperationType[] GetRewardParameterOperationTypeArray() { int o = __p.__offset(16); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.DreamMakerParamOperationType[] a = new Schale.FlatData.DreamMakerParamOperationType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.DreamMakerParamOperationType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Schale.FlatData.ParcelType RewardParcelType { get { int o = __p.__offset(20); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.MiniGameDreamScheduleResultExcel> CreateMiniGameDreamScheduleResultExcel(FlatBufferBuilder builder,
      long Id = 0,
      long EventContentId = 0,
      Schale.FlatData.DreamMakerResult DreamMakerResult = Schale.FlatData.DreamMakerResult.None,
  ...
  public static void AddDreamMakerResult(FlatBufferBuilder builder, Schale.FlatData.DreamMakerResult dreamMakerResult) { builder.AddInt(2, (int)dreamMakerResult, 0); }
  ...
  public static VectorOffset CreateRewardParameterVector(FlatBufferBuilder builder, Schale.FlatData.DreamMakerParameterType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateRewardParameterVectorBlock(FlatBufferBuilder builder, Schale.FlatData.DreamMakerParameterType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRewardParameterVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.DreamMakerParameterType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRewardParameterVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.DreamMakerParameterType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateRewardParameterOperationTypeVector(FlatBufferBuilder builder, Schale.FlatData.DreamMakerParamOperationType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateRewardParameterOperationTypeVectorBlock(FlatBufferBuilder builder, Schale.FlatData.DreamMakerParamOperationType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRewardParameterOperationTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.DreamMakerParamOperationType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRewardParameterOperationTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.DreamMakerParamOperationType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddRewardParcelType(FlatBufferBuilder builder, Schale.FlatData.ParcelType rewardParcelType) { builder.AddInt(8, (int)rewardParcelType, 0); }
  ...
  public static Offset<Schale.FlatData.MiniGameDreamScheduleResultExcel> EndMiniGameDreamScheduleResultExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MiniGameDreamScheduleResultExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameDreamScheduleResultExcelT _o) {
    ...
    _o.RewardParameter = new List<Schale.FlatData.DreamMakerParameterType>();
    ...
    _o.RewardParameterOperationType = new List<Schale.FlatData.DreamMakerParamOperationType>();
  ...
  public static Offset<Schale.FlatData.MiniGameDreamScheduleResultExcel> Pack(FlatBufferBuilder builder, MiniGameDreamScheduleResultExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MiniGameDreamScheduleResultExcel>);
...
public class MiniGameDreamScheduleResultExcelT
{
  ...
  public Schale.FlatData.DreamMakerResult DreamMakerResult { get; set; }
  public long DreamMakerScheduleGroup { get; set; }
  public int Prob { get; set; }
  public List<Schale.FlatData.DreamMakerParameterType> RewardParameter { get; set; }
  public List<Schale.FlatData.DreamMakerParamOperationType> RewardParameterOperationType { get; set; }
  ...
  public MiniGameDreamScheduleResultExcelT() {
    ...
    this.DreamMakerResult = Schale.FlatData.DreamMakerResult.None;
...
static public class MiniGameDreamScheduleResultExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*DreamMakerResult*/, 4 /*Schale.FlatData.DreamMakerResult*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 14 /*RewardParameter*/, 4 /*Schale.FlatData.DreamMakerParameterType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 16 /*RewardParameterOperationType*/, 4 /*Schale.FlatData.DreamMakerParamOperationType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 18 /*RewardParameterAmount*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 20 /*RewardParcelType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
