...
public struct ArenaSeasonCloseRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.ArenaSeasonCloseRewardExcel> CreateArenaSeasonCloseRewardExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
      long RankStart = 0,
      long RankEnd = 0,
  ...
  public static Offset<Schale.FlatData.ArenaSeasonCloseRewardExcel> EndArenaSeasonCloseRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ArenaSeasonCloseRewardExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ArenaSeasonCloseRewardExcel> Pack(FlatBufferBuilder builder, ArenaSeasonCloseRewardExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ArenaSeasonCloseRewardExcel>);
