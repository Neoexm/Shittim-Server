...
public struct TacticDamageSimulatorSettingExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.TerrainAdaptationStat OverrideStreetAdaptation { get { int o = __p.__offset(22); return o != 0 ? (Schale.FlatData.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.TerrainAdaptationStat.D; } }
  public Schale.FlatData.TerrainAdaptationStat OverrideOutdoorAdaptation { get { int o = __p.__offset(24); return o != 0 ? (Schale.FlatData.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.TerrainAdaptationStat.D; } }
  public Schale.FlatData.TerrainAdaptationStat OverrideIndoorAdaptation { get { int o = __p.__offset(26); return o != 0 ? (Schale.FlatData.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.TerrainAdaptationStat.D; } }
  ...
  public static Offset<Schale.FlatData.TacticDamageSimulatorSettingExcel> CreateTacticDamageSimulatorSettingExcel(FlatBufferBuilder builder,
      int Order = 0,
      int Repeat = 0,
      long TestPreset = 0,
      ...
      Schale.FlatData.TerrainAdaptationStat OverrideStreetAdaptation = Schale.FlatData.TerrainAdaptationStat.D,
      Schale.FlatData.TerrainAdaptationStat OverrideOutdoorAdaptation = Schale.FlatData.TerrainAdaptationStat.D,
      Schale.FlatData.TerrainAdaptationStat OverrideIndoorAdaptation = Schale.FlatData.TerrainAdaptationStat.D,
  ...
  public static void AddOverrideStreetAdaptation(FlatBufferBuilder builder, Schale.FlatData.TerrainAdaptationStat overrideStreetAdaptation) { builder.AddInt(9, (int)overrideStreetAdaptation, 0); }
  public static void AddOverrideOutdoorAdaptation(FlatBufferBuilder builder, Schale.FlatData.TerrainAdaptationStat overrideOutdoorAdaptation) { builder.AddInt(10, (int)overrideOutdoorAdaptation, 0); }
  public static void AddOverrideIndoorAdaptation(FlatBufferBuilder builder, Schale.FlatData.TerrainAdaptationStat overrideIndoorAdaptation) { builder.AddInt(11, (int)overrideIndoorAdaptation, 0); }
  ...
  public static Offset<Schale.FlatData.TacticDamageSimulatorSettingExcel> EndTacticDamageSimulatorSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.TacticDamageSimulatorSettingExcel>(o);
  }
...
public class TacticDamageSimulatorSettingExcelT
{
  ...
  public Schale.FlatData.TerrainAdaptationStat OverrideStreetAdaptation { get; set; }
  public Schale.FlatData.TerrainAdaptationStat OverrideOutdoorAdaptation { get; set; }
  public Schale.FlatData.TerrainAdaptationStat OverrideIndoorAdaptation { get; set; }
  ...
  public TacticDamageSimulatorSettingExcelT() {
    ...
    this.OverrideStreetAdaptation = Schale.FlatData.TerrainAdaptationStat.D;
    this.OverrideOutdoorAdaptation = Schale.FlatData.TerrainAdaptationStat.D;
    this.OverrideIndoorAdaptation = Schale.FlatData.TerrainAdaptationStat.D;
...
static public class TacticDamageSimulatorSettingExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*OverrideStreetAdaptation*/, 4 /*Schale.FlatData.TerrainAdaptationStat*/, 4, false)
      && verifier.VerifyField(tablePos, 24 /*OverrideOutdoorAdaptation*/, 4 /*Schale.FlatData.TerrainAdaptationStat*/, 4, false)
      && verifier.VerifyField(tablePos, 26 /*OverrideIndoorAdaptation*/, 4 /*Schale.FlatData.TerrainAdaptationStat*/, 4, false)
