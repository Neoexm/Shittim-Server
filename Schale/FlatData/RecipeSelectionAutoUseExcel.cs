...
public struct RecipeSelectionAutoUseExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.RecipeSelectionAutoUseExcel> CreateRecipeSelectionAutoUseExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Schale.FlatData.RecipeSelectionAutoUseExcel> EndRecipeSelectionAutoUseExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.RecipeSelectionAutoUseExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.RecipeSelectionAutoUseExcel> Pack(FlatBufferBuilder builder, RecipeSelectionAutoUseExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.RecipeSelectionAutoUseExcel>);
