...
public struct CheatCodeListExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.CheatCodeListExcel> EndCheatCodeListExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CheatCodeListExcel>(o);
  }
