...
public struct EventContentChangeScenarioExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.EventChangeType ChangeType { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.EventChangeType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.EventChangeType.MainSub; } }
  ...
  public static Offset<Schale.FlatData.EventContentChangeScenarioExcel> CreateEventContentChangeScenarioExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      Schale.FlatData.EventChangeType ChangeType = Schale.FlatData.EventChangeType.MainSub,
      long ChangeCount = 0,
  ...
  public static void AddChangeType(FlatBufferBuilder builder, Schale.FlatData.EventChangeType changeType) { builder.AddInt(1, (int)changeType, 0); }
  ...
  public static Offset<Schale.FlatData.EventContentChangeScenarioExcel> EndEventContentChangeScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentChangeScenarioExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.EventContentChangeScenarioExcel> Pack(FlatBufferBuilder builder, EventContentChangeScenarioExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EventContentChangeScenarioExcel>);
...
public class EventContentChangeScenarioExcelT
{
  ...
  public Schale.FlatData.EventChangeType ChangeType { get; set; }
  public long ChangeCount { get; set; }
  public long ScenarioGroupId { get; set; }

  public EventContentChangeScenarioExcelT() {
    this.EventContentId = 0;
    this.ChangeType = Schale.FlatData.EventChangeType.MainSub;
    this.ChangeCount = 0;
...
static public class EventContentChangeScenarioExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ChangeType*/, 4 /*Schale.FlatData.EventChangeType*/, 4, false)
