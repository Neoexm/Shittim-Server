...
public struct GroundModuleRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.GroundModuleRewardExcel> CreateGroundModuleRewardExcel(FlatBufferBuilder builder,
      uint GroupId = 0,
  ...
  public static Offset<Schale.FlatData.GroundModuleRewardExcel> EndGroundModuleRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.GroundModuleRewardExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.GroundModuleRewardExcel> Pack(FlatBufferBuilder builder, GroundModuleRewardExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.GroundModuleRewardExcel>);
