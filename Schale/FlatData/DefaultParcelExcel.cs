...
public struct DefaultParcelExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ParcelType ParcelType { get { int o = __p.__offset(4); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.DefaultParcelExcel> CreateDefaultParcelExcel(FlatBufferBuilder builder,
  ...
  public static void AddParcelType(FlatBufferBuilder builder, Schale.FlatData.ParcelType parcelType) { builder.AddInt(0, (int)parcelType, 0); }
  ...
  public static Offset<Schale.FlatData.DefaultParcelExcel> EndDefaultParcelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.DefaultParcelExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.DefaultParcelExcel> Pack(FlatBufferBuilder builder, DefaultParcelExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.DefaultParcelExcel>);
...
static public class DefaultParcelExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*ParcelType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
