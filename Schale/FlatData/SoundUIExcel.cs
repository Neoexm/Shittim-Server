...
public struct SoundUIExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.SoundUIExcel> CreateSoundUIExcel(FlatBufferBuilder builder,
      long ID = 0,
  ...
  public static Offset<Schale.FlatData.SoundUIExcel> EndSoundUIExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.SoundUIExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.SoundUIExcel> Pack(FlatBufferBuilder builder, SoundUIExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.SoundUIExcel>);
