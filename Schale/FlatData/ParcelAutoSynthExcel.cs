...
public struct ParcelAutoSynthExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ParcelType RequireParcelType { get { int o = __p.__offset(4); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public Schale.FlatData.ParcelType ResultParcelType { get { int o = __p.__offset(16); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.ParcelAutoSynthExcel> CreateParcelAutoSynthExcel(FlatBufferBuilder builder,
      Schale.FlatData.ParcelType RequireParcelType = Schale.FlatData.ParcelType.None,
      long RequireParcelId = 0,
      long RequireParcelAmount = 0,
      long SynthStartAmount = 0,
      long SynthEndAmount = 0,
      bool SynthMaxItem = false,
      Schale.FlatData.ParcelType ResultParcelType = Schale.FlatData.ParcelType.None,
  ...
  public static void AddRequireParcelType(FlatBufferBuilder builder, Schale.FlatData.ParcelType requireParcelType) { builder.AddInt(0, (int)requireParcelType, 0); }
  ...
  public static void AddResultParcelType(FlatBufferBuilder builder, Schale.FlatData.ParcelType resultParcelType) { builder.AddInt(6, (int)resultParcelType, 0); }
  ...
  public static Offset<Schale.FlatData.ParcelAutoSynthExcel> EndParcelAutoSynthExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ParcelAutoSynthExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ParcelAutoSynthExcel> Pack(FlatBufferBuilder builder, ParcelAutoSynthExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ParcelAutoSynthExcel>);
...
{
  public Schale.FlatData.ParcelType RequireParcelType { get; set; }
...
static public class ParcelAutoSynthExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*RequireParcelType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 16 /*ResultParcelType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
