...
public struct WeekDungeonGroupBuffExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.School School { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.School)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.School.None; } }
  ...
  public static Offset<Schale.FlatData.WeekDungeonGroupBuffExcel> CreateWeekDungeonGroupBuffExcel(FlatBufferBuilder builder,
  ...
  public static void AddSchool(FlatBufferBuilder builder, Schale.FlatData.School school) { builder.AddInt(1, (int)school, 0); }
  ...
  public static Offset<Schale.FlatData.WeekDungeonGroupBuffExcel> EndWeekDungeonGroupBuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.WeekDungeonGroupBuffExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.WeekDungeonGroupBuffExcel> Pack(FlatBufferBuilder builder, WeekDungeonGroupBuffExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.WeekDungeonGroupBuffExcel>);
...
static public class WeekDungeonGroupBuffExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*School*/, 4 /*Schale.FlatData.School*/, 4, false)
