...
public struct BGMRaidExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.BGMRaidExcel> CreateBGMRaidExcel(FlatBufferBuilder builder,
      long StageId = 0,
      long PhaseIndex = 0,
      long BGMId = 0) {
  ...
  public static Offset<Schale.FlatData.BGMRaidExcel> EndBGMRaidExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.BGMRaidExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.BGMRaidExcel> Pack(FlatBufferBuilder builder, BGMRaidExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.BGMRaidExcel>);
