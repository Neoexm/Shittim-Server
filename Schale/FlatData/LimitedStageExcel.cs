...
public struct LimitedStageExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.StageTopography StageTopography { get { int o = __p.__offset(48); return o != 0 ? (Schale.FlatData.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.StageTopography.Street; } }
  ...
  public Schale.FlatData.StrategyEnvironment StrategyEnvironment { get { int o = __p.__offset(54); return o != 0 ? (Schale.FlatData.StrategyEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.StrategyEnvironment.None; } }
  ...
  public static Offset<Schale.FlatData.LimitedStageExcel> CreateLimitedStageExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, Schale.FlatData.StageTopography stageTopography) { builder.AddInt(22, (int)stageTopography, 0); }
  ...
  public static void AddStrategyEnvironment(FlatBufferBuilder builder, Schale.FlatData.StrategyEnvironment strategyEnvironment) { builder.AddInt(25, (int)strategyEnvironment, 0); }
  ...
  public static Offset<Schale.FlatData.LimitedStageExcel> EndLimitedStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.LimitedStageExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.LimitedStageExcel> Pack(FlatBufferBuilder builder, LimitedStageExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.LimitedStageExcel>);
...
static public class LimitedStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 48 /*StageTopography*/, 4 /*Schale.FlatData.StageTopography*/, 4, false)
      && verifier.VerifyField(tablePos, 50 /*RecommandLevel*/, 4 /*int*/, 4, false)
      && verifier.VerifyString(tablePos, 52 /*BgmId*/, false)
      && verifier.VerifyField(tablePos, 54 /*StrategyEnvironment*/, 4 /*Schale.FlatData.StrategyEnvironment*/, 4, false)
