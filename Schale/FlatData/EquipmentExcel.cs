...
public struct EquipmentExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.EquipmentCategory EquipmentCategory { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.EquipmentCategory)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.EquipmentCategory.Unable; } }
  ...
  public Schale.FlatData.Tag Tags(int j) { int o = __p.__offset(28); return o != 0 ? (Schale.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(28); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.Tag> GetTagsBytes() { return __p.__vector_as_span<Schale.FlatData.Tag>(28, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(28); }
#endif
  public Schale.FlatData.Tag[] GetTagsArray() { int o = __p.__offset(28); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.Tag[] a = new Schale.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Schale.FlatData.ShopCategoryType ShopCategory(int j) { int o = __p.__offset(38); return o != 0 ? (Schale.FlatData.ShopCategoryType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.ShopCategoryType)0; }
  public int ShopCategoryLength { get { int o = __p.__offset(38); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.ShopCategoryType> GetShopCategoryBytes() { return __p.__vector_as_span<Schale.FlatData.ShopCategoryType>(38, 4); }
#else
...
static public class EquipmentExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*EquipmentCategory*/, 4 /*Schale.FlatData.EquipmentCategory*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 28 /*Tags*/, 4 /*Schale.FlatData.Tag*/, false)
