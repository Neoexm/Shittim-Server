...
public struct LocalizeEtcExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.LocalizeEtcExcel> CreateLocalizeEtcExcel(FlatBufferBuilder builder,
      uint Key = 0,
  ...
  public static Offset<Schale.FlatData.LocalizeEtcExcel> EndLocalizeEtcExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.LocalizeEtcExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.LocalizeEtcExcel> Pack(FlatBufferBuilder builder, LocalizeEtcExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.LocalizeEtcExcel>);
