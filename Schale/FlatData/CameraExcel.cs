...
public struct CameraExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.CameraExcel> CreateCameraExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<Schale.FlatData.CameraExcel> EndCameraExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CameraExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.CameraExcel> Pack(FlatBufferBuilder builder, CameraExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.CameraExcel>);
