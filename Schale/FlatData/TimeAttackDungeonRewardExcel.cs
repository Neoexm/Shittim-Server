...
public struct TimeAttackDungeonRewardExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.TimeAttackDungeonRewardType RewardType(int j) { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.TimeAttackDungeonRewardType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.TimeAttackDungeonRewardType)0; }
  public int RewardTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.TimeAttackDungeonRewardType> GetRewardTypeBytes() { return __p.__vector_as_span<Schale.FlatData.TimeAttackDungeonRewardType>(8, 4); }
#else
  public ArraySegment<byte>? GetRewardTypeBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public Schale.FlatData.TimeAttackDungeonRewardType[] GetRewardTypeArray() { int o = __p.__offset(8); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.TimeAttackDungeonRewardType[] a = new Schale.FlatData.TimeAttackDungeonRewardType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.TimeAttackDungeonRewardType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.TimeAttackDungeonRewardExcel> CreateTimeAttackDungeonRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static VectorOffset CreateRewardTypeVector(FlatBufferBuilder builder, Schale.FlatData.TimeAttackDungeonRewardType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateRewardTypeVectorBlock(FlatBufferBuilder builder, Schale.FlatData.TimeAttackDungeonRewardType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRewardTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.TimeAttackDungeonRewardType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRewardTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.TimeAttackDungeonRewardType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Schale.FlatData.TimeAttackDungeonRewardExcel> EndTimeAttackDungeonRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.TimeAttackDungeonRewardExcel>(o);
  }
  ...
  public void UnPackTo(TimeAttackDungeonRewardExcelT _o) {
    ...
    _o.RewardType = new List<Schale.FlatData.TimeAttackDungeonRewardType>();
  ...
  public static Offset<Schale.FlatData.TimeAttackDungeonRewardExcel> Pack(FlatBufferBuilder builder, TimeAttackDungeonRewardExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.TimeAttackDungeonRewardExcel>);
...
public class TimeAttackDungeonRewardExcelT
{
  ...
  public List<Schale.FlatData.TimeAttackDungeonRewardType> RewardType { get; set; }
...
static public class TimeAttackDungeonRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 8 /*RewardType*/, 4 /*Schale.FlatData.TimeAttackDungeonRewardType*/, false)
