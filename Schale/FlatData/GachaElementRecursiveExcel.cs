...
public struct GachaElementRecursiveExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.GachaElementRecursiveExcel> CreateGachaElementRecursiveExcel(FlatBufferBuilder builder,
      long ID = 0,
      long GachaGroupID = 0,
  ...
  public static Offset<Schale.FlatData.GachaElementRecursiveExcel> EndGachaElementRecursiveExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.GachaElementRecursiveExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.GachaElementRecursiveExcel> Pack(FlatBufferBuilder builder, GachaElementRecursiveExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.GachaElementRecursiveExcel>);
