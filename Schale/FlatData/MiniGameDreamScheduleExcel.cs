...
public struct MiniGameDreamScheduleExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.MiniGameDreamScheduleExcel> CreateMiniGameDreamScheduleExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.MiniGameDreamScheduleExcel> EndMiniGameDreamScheduleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MiniGameDreamScheduleExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MiniGameDreamScheduleExcel> Pack(FlatBufferBuilder builder, MiniGameDreamScheduleExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MiniGameDreamScheduleExcel>);
