...
public struct EventContentLocationExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ParcelType ScheduleEventPointCostParcelType { get { int o = __p.__offset(14); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.EventContentLocationExcel> CreateEventContentLocationExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long Id = 0,
      uint LocalizeEtcId = 0,
      StringOffset PrefabPathOffset = default(StringOffset),
      int LocationResetScheduleCount = 0,
      Schale.FlatData.ParcelType ScheduleEventPointCostParcelType = Schale.FlatData.ParcelType.None,
  ...
  public static void AddScheduleEventPointCostParcelType(FlatBufferBuilder builder, Schale.FlatData.ParcelType scheduleEventPointCostParcelType) { builder.AddInt(5, (int)scheduleEventPointCostParcelType, 0); }
  ...
  public static Offset<Schale.FlatData.EventContentLocationExcel> EndEventContentLocationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentLocationExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.EventContentLocationExcel> Pack(FlatBufferBuilder builder, EventContentLocationExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EventContentLocationExcel>);
...
public class EventContentLocationExcelT
{
  ...
  public Schale.FlatData.ParcelType ScheduleEventPointCostParcelType { get; set; }
  ...
  public EventContentLocationExcelT() {
    ...
    this.ScheduleEventPointCostParcelType = Schale.FlatData.ParcelType.None;
...
static public class EventContentLocationExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*ScheduleEventPointCostParcelType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
