...
public struct MinigameTBGItemExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.TBGItemType ItemType { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.TBGItemType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.TBGItemType.None; } }
  public Schale.FlatData.TBGItemEffectType TBGItemEffectType { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.TBGItemEffectType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.TBGItemEffectType.None; } }
  ...
  public static Offset<Schale.FlatData.MinigameTBGItemExcel> CreateMinigameTBGItemExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      Schale.FlatData.TBGItemType ItemType = Schale.FlatData.TBGItemType.None,
      Schale.FlatData.TBGItemEffectType TBGItemEffectType = Schale.FlatData.TBGItemEffectType.None,
      int ItemParameter = 0,
  ...
  public static void AddItemType(FlatBufferBuilder builder, Schale.FlatData.TBGItemType itemType) { builder.AddInt(1, (int)itemType, 0); }
  public static void AddTBGItemEffectType(FlatBufferBuilder builder, Schale.FlatData.TBGItemEffectType tBGItemEffectType) { builder.AddInt(2, (int)tBGItemEffectType, 0); }
  ...
  public static Offset<Schale.FlatData.MinigameTBGItemExcel> EndMinigameTBGItemExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MinigameTBGItemExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MinigameTBGItemExcel> Pack(FlatBufferBuilder builder, MinigameTBGItemExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MinigameTBGItemExcel>);
...
public class MinigameTBGItemExcelT
{
  ...
  public Schale.FlatData.TBGItemType ItemType { get; set; }
  public Schale.FlatData.TBGItemEffectType TBGItemEffectType { get; set; }
  ...
  public MinigameTBGItemExcelT() {
    this.UniqueId = 0;
    this.ItemType = Schale.FlatData.TBGItemType.None;
    this.TBGItemEffectType = Schale.FlatData.TBGItemEffectType.None;
...
static public class MinigameTBGItemExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ItemType*/, 4 /*Schale.FlatData.TBGItemType*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*TBGItemEffectType*/, 4 /*Schale.FlatData.TBGItemEffectType*/, 4, false)
