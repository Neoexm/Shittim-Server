...
public struct MemoryLobby_GlobalExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.MemoryLobby_GlobalExcel> EndMemoryLobby_GlobalExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MemoryLobby_GlobalExcel>(o);
  }
