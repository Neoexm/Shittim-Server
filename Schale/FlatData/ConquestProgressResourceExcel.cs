...
public struct ConquestProgressResourceExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ConquestProgressType Group { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.ConquestProgressType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ConquestProgressType.None; } }
  ...
  public static Offset<Schale.FlatData.ConquestProgressResourceExcel> CreateConquestProgressResourceExcel(FlatBufferBuilder builder,
      long Id = 0,
      long EventContentId = 0,
      Schale.FlatData.ConquestProgressType Group = Schale.FlatData.ConquestProgressType.None,
  ...
  public static void AddGroup(FlatBufferBuilder builder, Schale.FlatData.ConquestProgressType group) { builder.AddInt(2, (int)group, 0); }
  ...
  public static Offset<Schale.FlatData.ConquestProgressResourceExcel> EndConquestProgressResourceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ConquestProgressResourceExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ConquestProgressResourceExcel> Pack(FlatBufferBuilder builder, ConquestProgressResourceExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ConquestProgressResourceExcel>);
...
public class ConquestProgressResourceExcelT
{
  ...
  public Schale.FlatData.ConquestProgressType Group { get; set; }
  ...
  public ConquestProgressResourceExcelT() {
    ...
    this.Group = Schale.FlatData.ConquestProgressType.None;
...
static public class ConquestProgressResourceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*Group*/, 4 /*Schale.FlatData.ConquestProgressType*/, 4, false)
