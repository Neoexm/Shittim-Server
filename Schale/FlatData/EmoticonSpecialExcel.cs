...
public struct EmoticonSpecialExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.EmoticonSpecialExcel> CreateEmoticonSpecialExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<Schale.FlatData.EmoticonSpecialExcel> EndEmoticonSpecialExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EmoticonSpecialExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.EmoticonSpecialExcel> Pack(FlatBufferBuilder builder, EmoticonSpecialExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EmoticonSpecialExcel>);
