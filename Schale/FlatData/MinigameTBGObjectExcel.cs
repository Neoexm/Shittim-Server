...
public struct MinigameTBGObjectExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.TBGObjectType ObjectType { get { int o = __p.__offset(10); return o != 0 ? (Schale.FlatData.TBGObjectType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.TBGObjectType.None; } }
  public Schale.FlatData.ParcelType ObjectCostType { get { int o = __p.__offset(12); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.MinigameTBGObjectExcel> CreateMinigameTBGObjectExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      StringOffset KeyOffset = default(StringOffset),
      StringOffset PrefabNameOffset = default(StringOffset),
      Schale.FlatData.TBGObjectType ObjectType = Schale.FlatData.TBGObjectType.None,
      Schale.FlatData.ParcelType ObjectCostType = Schale.FlatData.ParcelType.None,
      long ObjectCostId = 0,
  ...
  public static void AddObjectType(FlatBufferBuilder builder, Schale.FlatData.TBGObjectType objectType) { builder.AddInt(3, (int)objectType, 0); }
  public static void AddObjectCostType(FlatBufferBuilder builder, Schale.FlatData.ParcelType objectCostType) { builder.AddInt(4, (int)objectCostType, 0); }
  ...
  public static Offset<Schale.FlatData.MinigameTBGObjectExcel> EndMinigameTBGObjectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MinigameTBGObjectExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MinigameTBGObjectExcel> Pack(FlatBufferBuilder builder, MinigameTBGObjectExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MinigameTBGObjectExcel>);
...
public class MinigameTBGObjectExcelT
{
  ...
  public Schale.FlatData.TBGObjectType ObjectType { get; set; }
  public Schale.FlatData.ParcelType ObjectCostType { get; set; }
  ...
  public MinigameTBGObjectExcelT() {
    ...
    this.ObjectType = Schale.FlatData.TBGObjectType.None;
    this.ObjectCostType = Schale.FlatData.ParcelType.None;
    this.ObjectCostId = 0;
...
static public class MinigameTBGObjectExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ObjectType*/, 4 /*Schale.FlatData.TBGObjectType*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*ObjectCostType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
