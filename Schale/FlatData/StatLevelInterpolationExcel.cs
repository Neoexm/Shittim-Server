...
public struct StatLevelInterpolationExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.StatLevelInterpolationExcel> CreateStatLevelInterpolationExcel(FlatBufferBuilder builder,
      long Level = 0,
  ...
  public static Offset<Schale.FlatData.StatLevelInterpolationExcel> EndStatLevelInterpolationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.StatLevelInterpolationExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.StatLevelInterpolationExcel> Pack(FlatBufferBuilder builder, StatLevelInterpolationExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.StatLevelInterpolationExcel>);
