...
public struct FieldContentStageExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.StageDifficulty StageDifficulty { get { int o = __p.__offset(12); return o != 0 ? (Schale.FlatData.StageDifficulty)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.StageDifficulty.None; } }
  ...
  public Schale.FlatData.ParcelType StageEnterCostType { get { int o = __p.__offset(20); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public Schale.FlatData.StarGoalType StarGoal(int j) { int o = __p.__offset(42); return o != 0 ? (Schale.FlatData.StarGoalType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.StarGoalType)0; }
  public int StarGoalLength { get { int o = __p.__offset(42); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.StarGoalType> GetStarGoalBytes() { return __p.__vector_as_span<Schale.FlatData.StarGoalType>(42, 4); }
#else
  public ArraySegment<byte>? GetStarGoalBytes() { return __p.__vector_as_arraysegment(42); }
#endif
  public Schale.FlatData.StarGoalType[] GetStarGoalArray() { int o = __p.__offset(42); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.StarGoalType[] a = new Schale.FlatData.StarGoalType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.StarGoalType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.FieldContentStageExcel> CreateFieldContentStageExcel(FlatBufferBuilder builder,
      long Id = 0,
      long SeasonId = 0,
      long AreaId = 0,
      long GroupId = 0,
  ...
  public static void AddStageDifficulty(FlatBufferBuilder builder, Schale.FlatData.StageDifficulty stageDifficulty) { builder.AddInt(4, (int)stageDifficulty, 0); }
  ...
  public static void AddStageEnterCostType(FlatBufferBuilder builder, Schale.FlatData.ParcelType stageEnterCostType) { builder.AddInt(8, (int)stageEnterCostType, 0); }
  ...
  public static Offset<Schale.FlatData.FieldContentStageExcel> EndFieldContentStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.FieldContentStageExcel>(o);
  }
...
static public class FieldContentStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*StageDifficulty*/, 4 /*Schale.FlatData.StageDifficulty*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 20 /*StageEnterCostType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 42 /*StarGoal*/, 4 /*Schale.FlatData.StarGoalType*/, false)
