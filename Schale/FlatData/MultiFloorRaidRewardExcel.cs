...
public struct MultiFloorRaidRewardExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ParcelType ClearStageRewardParcelType { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.MultiFloorRaidRewardExcel> CreateMultiFloorRaidRewardExcel(FlatBufferBuilder builder,
  ...
  public static void AddClearStageRewardParcelType(FlatBufferBuilder builder, Schale.FlatData.ParcelType clearStageRewardParcelType) { builder.AddInt(2, (int)clearStageRewardParcelType, 0); }
  ...
  public static Offset<Schale.FlatData.MultiFloorRaidRewardExcel> EndMultiFloorRaidRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MultiFloorRaidRewardExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MultiFloorRaidRewardExcel> Pack(FlatBufferBuilder builder, MultiFloorRaidRewardExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MultiFloorRaidRewardExcel>);
...
static public class MultiFloorRaidRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ClearStageRewardParcelType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
