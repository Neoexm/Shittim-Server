...
public struct ArenaLevelSectionExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.ArenaLevelSectionExcel> CreateArenaLevelSectionExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.ArenaLevelSectionExcel> EndArenaLevelSectionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ArenaLevelSectionExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ArenaLevelSectionExcel> Pack(FlatBufferBuilder builder, ArenaLevelSectionExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ArenaLevelSectionExcel>);
