...
public struct EventContentTreasureExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.EventContentTreasureExcel> CreateEventContentTreasureExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.EventContentTreasureExcel> EndEventContentTreasureExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentTreasureExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.EventContentTreasureExcel> Pack(FlatBufferBuilder builder, EventContentTreasureExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EventContentTreasureExcel>);
