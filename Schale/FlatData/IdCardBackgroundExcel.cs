...
public struct IdCardBackgroundExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.Rarity Rarity { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.Rarity)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.Rarity.N; } }
  ...
  public static Offset<Schale.FlatData.IdCardBackgroundExcel> CreateIdCardBackgroundExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddRarity(FlatBufferBuilder builder, Schale.FlatData.Rarity rarity) { builder.AddInt(1, (int)rarity, 0); }
  ...
  public static Offset<Schale.FlatData.IdCardBackgroundExcel> EndIdCardBackgroundExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.IdCardBackgroundExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.IdCardBackgroundExcel> Pack(FlatBufferBuilder builder, IdCardBackgroundExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.IdCardBackgroundExcel>);
...
static public class IdCardBackgroundExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*Rarity*/, 4 /*Schale.FlatData.Rarity*/, 4, false)
