...
public struct SkillExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.BulletType BulletType { get { int o = __p.__offset(28); return o != 0 ? (Schale.FlatData.BulletType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.BulletType.Normal; } }
  ...
  public static Offset<Schale.FlatData.SkillExcel> CreateSkillExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddBulletType(FlatBufferBuilder builder, Schale.FlatData.BulletType bulletType) { builder.AddInt(12, (int)bulletType, 0); }
  ...
  public static Offset<Schale.FlatData.SkillExcel> EndSkillExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.SkillExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.SkillExcel> Pack(FlatBufferBuilder builder, SkillExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.SkillExcel>);
...
static public class SkillExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 28 /*BulletType*/, 4 /*Schale.FlatData.BulletType*/, 4, false)
