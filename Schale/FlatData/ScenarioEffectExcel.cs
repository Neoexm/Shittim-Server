...
public struct ScenarioEffectExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.ScenarioEffectExcel> CreateScenarioEffectExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.ScenarioEffectExcel> EndScenarioEffectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ScenarioEffectExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ScenarioEffectExcel> Pack(FlatBufferBuilder builder, ScenarioEffectExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ScenarioEffectExcel>);
