...
public struct MissionEmergencyCompleteExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.MissionEmergencyCompleteExcel> CreateMissionEmergencyCompleteExcel(FlatBufferBuilder builder,
      long MissionId = 0,
  ...
  public static Offset<Schale.FlatData.MissionEmergencyCompleteExcel> EndMissionEmergencyCompleteExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MissionEmergencyCompleteExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MissionEmergencyCompleteExcel> Pack(FlatBufferBuilder builder, MissionEmergencyCompleteExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MissionEmergencyCompleteExcel>);
