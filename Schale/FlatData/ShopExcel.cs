...
public struct ShopExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ShopCategoryType CategoryType { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ShopCategoryType.General; } }
  ...
  public Schale.FlatData.PurchaseCountResetType PurchaseCountResetType { get { int o = __p.__offset(26); return o != 0 ? (Schale.FlatData.PurchaseCountResetType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.PurchaseCountResetType.None; } }
  ...
  public static Offset<Schale.FlatData.ShopExcel> CreateShopExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, Schale.FlatData.ShopCategoryType categoryType) { builder.AddInt(2, (int)categoryType, 0); }
  ...
  public static void AddPurchaseCountResetType(FlatBufferBuilder builder, Schale.FlatData.PurchaseCountResetType purchaseCountResetType) { builder.AddInt(11, (int)purchaseCountResetType, 0); }
  ...
  public static Offset<Schale.FlatData.ShopExcel> EndShopExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ShopExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ShopExcel> Pack(FlatBufferBuilder builder, ShopExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ShopExcel>);
...
static public class ShopExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CategoryType*/, 4 /*Schale.FlatData.ShopCategoryType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 26 /*PurchaseCountResetType*/, 4 /*Schale.FlatData.PurchaseCountResetType*/, 4, false)
