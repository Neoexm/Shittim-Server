...
public struct EventContentBoxGachaManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.EventContentBoxGachaManageExcel> CreateEventContentBoxGachaManageExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.EventContentBoxGachaManageExcel> EndEventContentBoxGachaManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentBoxGachaManageExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.EventContentBoxGachaManageExcel> Pack(FlatBufferBuilder builder, EventContentBoxGachaManageExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EventContentBoxGachaManageExcel>);
