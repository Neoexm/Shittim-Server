...
public struct ConquestTileExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ConquestTileType TileType { get { int o = __p.__offset(20); return o != 0 ? (Schale.FlatData.ConquestTileType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ConquestTileType.None; } }
  ...
  public Schale.FlatData.ParcelType ConquestCostType { get { int o = __p.__offset(26); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public Schale.FlatData.ParcelType ManageCostType { get { int o = __p.__offset(32); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public Schale.FlatData.ParcelType Upgrade2CostType { get { int o = __p.__offset(42); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public Schale.FlatData.ParcelType Upgrade3CostType { get { int o = __p.__offset(48); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.ConquestTileExcel> CreateConquestTileExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      bool Playable = false,
      Schale.FlatData.ConquestTileType TileType = Schale.FlatData.ConquestTileType.None,
      bool NotMapFog = false,
      long GroupBonusId = 0,
      Schale.FlatData.ParcelType ConquestCostType = Schale.FlatData.ParcelType.None,
      long ConquestCostId = 0,
      int ConquestCostAmount = 0,
      Schale.FlatData.ParcelType ManageCostType = Schale.FlatData.ParcelType.None,
      long ManageCostId = 0,
      int ManageCostAmount = 0,
      long ConquestRewardId = 0,
      long MassErosionId = 0,
      Schale.FlatData.ParcelType Upgrade2CostType = Schale.FlatData.ParcelType.None,
      long Upgrade2CostId = 0,
      int Upgrade2CostAmount = 0,
      Schale.FlatData.ParcelType Upgrade3CostType = Schale.FlatData.ParcelType.None,
  ...
  public static void AddTileType(FlatBufferBuilder builder, Schale.FlatData.ConquestTileType tileType) { builder.AddInt(8, (int)tileType, 0); }
  ...
  public static void AddConquestCostType(FlatBufferBuilder builder, Schale.FlatData.ParcelType conquestCostType) { builder.AddInt(11, (int)conquestCostType, 0); }
  ...
  public static void AddManageCostType(FlatBufferBuilder builder, Schale.FlatData.ParcelType manageCostType) { builder.AddInt(14, (int)manageCostType, 0); }
  ...
  public static void AddUpgrade2CostType(FlatBufferBuilder builder, Schale.FlatData.ParcelType upgrade2CostType) { builder.AddInt(19, (int)upgrade2CostType, 0); }
  ...
  public static void AddUpgrade3CostType(FlatBufferBuilder builder, Schale.FlatData.ParcelType upgrade3CostType) { builder.AddInt(22, (int)upgrade3CostType, 0); }
  ...
  public static Offset<Schale.FlatData.ConquestTileExcel> EndConquestTileExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ConquestTileExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ConquestTileExcel> Pack(FlatBufferBuilder builder, ConquestTileExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ConquestTileExcel>);
...
public class ConquestTileExcelT
{
  ...
  public Schale.FlatData.ConquestTileType TileType { get; set; }
  public bool NotMapFog { get; set; }
  public long GroupBonusId { get; set; }
  public Schale.FlatData.ParcelType ConquestCostType { get; set; }
  public long ConquestCostId { get; set; }
  public int ConquestCostAmount { get; set; }
  public Schale.FlatData.ParcelType ManageCostType { get; set; }
  ...
  public Schale.FlatData.ParcelType Upgrade2CostType { get; set; }
  public long Upgrade2CostId { get; set; }
  public int Upgrade2CostAmount { get; set; }
  public Schale.FlatData.ParcelType Upgrade3CostType { get; set; }
  ...
  public ConquestTileExcelT() {
    ...
    this.Playable = false;
    this.TileType = Schale.FlatData.ConquestTileType.None;
    this.NotMapFog = false;
    this.GroupBonusId = 0;
    this.ConquestCostType = Schale.FlatData.ParcelType.None;
    this.ConquestCostId = 0;
    this.ConquestCostAmount = 0;
    this.ManageCostType = Schale.FlatData.ParcelType.None;
    this.ManageCostId = 0;
    this.ManageCostAmount = 0;
    this.ConquestRewardId = 0;
    this.MassErosionId = 0;
    this.Upgrade2CostType = Schale.FlatData.ParcelType.None;
    this.Upgrade2CostId = 0;
    this.Upgrade2CostAmount = 0;
    this.Upgrade3CostType = Schale.FlatData.ParcelType.None;
...
static public class ConquestTileExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*TileType*/, 4 /*Schale.FlatData.ConquestTileType*/, 4, false)
      && verifier.VerifyField(tablePos, 22 /*NotMapFog*/, 1 /*bool*/, 1, false)
      && verifier.VerifyField(tablePos, 24 /*GroupBonusId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 26 /*ConquestCostType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 32 /*ManageCostType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 42 /*Upgrade2CostType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 48 /*Upgrade3CostType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
