...
public struct EliminateRaidStageLimitedRewardExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ParcelType LimitedRewardParcelType(int j) { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.ParcelType)0; }
  public int LimitedRewardParcelTypeLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.ParcelType> GetLimitedRewardParcelTypeBytes() { return __p.__vector_as_span<Schale.FlatData.ParcelType>(6, 4); }
#else
  public ArraySegment<byte>? GetLimitedRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public Schale.FlatData.ParcelType[] GetLimitedRewardParcelTypeArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.ParcelType[] a = new Schale.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Schale.FlatData.EliminateRaidStageLimitedRewardExcel> CreateEliminateRaidStageLimitedRewardExcel(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateLimitedRewardParcelTypeVector(FlatBufferBuilder builder, Schale.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateLimitedRewardParcelTypeVectorBlock(FlatBufferBuilder builder, Schale.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateLimitedRewardParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateLimitedRewardParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Schale.FlatData.EliminateRaidStageLimitedRewardExcel> EndEliminateRaidStageLimitedRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EliminateRaidStageLimitedRewardExcel>(o);
  }
  ...
  public void UnPackTo(EliminateRaidStageLimitedRewardExcelT _o) {
    ...
    _o.LimitedRewardParcelType = new List<Schale.FlatData.ParcelType>();
  ...
  public static Offset<Schale.FlatData.EliminateRaidStageLimitedRewardExcel> Pack(FlatBufferBuilder builder, EliminateRaidStageLimitedRewardExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EliminateRaidStageLimitedRewardExcel>);
...
public class EliminateRaidStageLimitedRewardExcelT
{
  ...
  public List<Schale.FlatData.ParcelType> LimitedRewardParcelType { get; set; }
...
static public class EliminateRaidStageLimitedRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*LimitedRewardParcelType*/, 4 /*Schale.FlatData.ParcelType*/, false)
