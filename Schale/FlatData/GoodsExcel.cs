...
public struct GoodsExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ParcelType ConsumeParcelType(int j) { int o = __p.__offset(12); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.ParcelType)0; }
  public int ConsumeParcelTypeLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.ParcelType> GetConsumeParcelTypeBytes() { return __p.__vector_as_span<Schale.FlatData.ParcelType>(12, 4); }
#else
  ...
  public static Offset<Schale.FlatData.GoodsExcel> CreateGoodsExcel(FlatBufferBuilder builder,
      long Id = 0,
      int Type = 0,
  ...
  public static VectorOffset CreateConsumeParcelTypeVector(FlatBufferBuilder builder, Schale.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateConsumeParcelTypeVectorBlock(FlatBufferBuilder builder, Schale.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateConsumeConditionVector(FlatBufferBuilder builder, Schale.FlatData.ConsumeCondition[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateConsumeConditionVectorBlock(FlatBufferBuilder builder, Schale.FlatData.ConsumeCondition[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeConditionVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.ConsumeCondition> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeConditionVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.ConsumeCondition>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateConsumeGachaTicketTypeVector(FlatBufferBuilder builder, Schale.FlatData.GachaTicketType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateConsumeGachaTicketTypeVectorBlock(FlatBufferBuilder builder, Schale.FlatData.GachaTicketType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeGachaTicketTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.GachaTicketType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeGachaTicketTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.GachaTicketType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Schale.FlatData.GoodsExcel> EndGoodsExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.GoodsExcel>(o);
  }
  ...
  public void UnPackTo(GoodsExcelT _o) {
    ...
    _o.ConsumeParcelType = new List<Schale.FlatData.ParcelType>();
    ...
    _o.ConsumeCondition = new List<Schale.FlatData.ConsumeCondition>();
    ...
    _o.ConsumeGachaTicketType = new List<Schale.FlatData.GachaTicketType>();
  ...
  public static Offset<Schale.FlatData.GoodsExcel> Pack(FlatBufferBuilder builder, GoodsExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.GoodsExcel>);
    ...
    if (_o.ConsumeGachaTicketType != null) {
      var __ConsumeGachaTicketType = _o.ConsumeGachaTicketType.ToArray();
    ...
    if (_o.ConsumeGachaTicketTypeAmount != null) {
      var __ConsumeGachaTicketTypeAmount = _o.ConsumeGachaTicketTypeAmount.ToArray();
...
public class GoodsExcelT
{
  ...
  public List<Schale.FlatData.ParcelType> ConsumeParcelType { get; set; }
...
static public class GoodsExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 12 /*ConsumeParcelType*/, 4 /*Schale.FlatData.ParcelType*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 42 /*ParcelType*/, 4 /*Schale.FlatData.ParcelType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 44 /*ParcelId*/, 8 /*long*/, false)
      && verifier.VerifyVectorOfData(tablePos, 46 /*ParcelAmount*/, 8 /*long*/, false)
