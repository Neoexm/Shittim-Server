...
public struct ObstacleFireLineCheckExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.ObstacleFireLineCheckExcel> CreateObstacleFireLineCheckExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.ObstacleFireLineCheckExcel> EndObstacleFireLineCheckExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ObstacleFireLineCheckExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ObstacleFireLineCheckExcel> Pack(FlatBufferBuilder builder, ObstacleFireLineCheckExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ObstacleFireLineCheckExcel>);
