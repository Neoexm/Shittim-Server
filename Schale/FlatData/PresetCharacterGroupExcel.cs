...
public struct PresetCharacterGroupExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.PotentialStatBonusRateType PotentialType01 { get { int o = __p.__offset(58); return o != 0 ? (Schale.FlatData.PotentialStatBonusRateType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.PotentialStatBonusRateType.None; } }
  public int PotentialLevel01 { get { int o = __p.__offset(60); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public Schale.FlatData.PotentialStatBonusRateType PotentialType02 { get { int o = __p.__offset(62); return o != 0 ? (Schale.FlatData.PotentialStatBonusRateType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.PotentialStatBonusRateType.None; } }
  public int PotentialLevel02 { get { int o = __p.__offset(64); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public Schale.FlatData.PotentialStatBonusRateType PotentialType03 { get { int o = __p.__offset(66); return o != 0 ? (Schale.FlatData.PotentialStatBonusRateType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.PotentialStatBonusRateType.None; } }
  public int PotentialLevel03 { get { int o = __p.__offset(68); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }

  public static Offset<Schale.FlatData.PresetCharacterGroupExcel> CreatePresetCharacterGroupExcel(FlatBufferBuilder builder,
      ...
      Schale.FlatData.PotentialStatBonusRateType PotentialType01 = Schale.FlatData.PotentialStatBonusRateType.None,
      int PotentialLevel01 = 0,
      Schale.FlatData.PotentialStatBonusRateType PotentialType02 = Schale.FlatData.PotentialStatBonusRateType.None,
      int PotentialLevel02 = 0,
      Schale.FlatData.PotentialStatBonusRateType PotentialType03 = Schale.FlatData.PotentialStatBonusRateType.None,
  ...
  public static void AddPotentialType01(FlatBufferBuilder builder, Schale.FlatData.PotentialStatBonusRateType potentialType01) { builder.AddInt(27, (int)potentialType01, 0); }
  ...
  public static void AddPotentialType02(FlatBufferBuilder builder, Schale.FlatData.PotentialStatBonusRateType potentialType02) { builder.AddInt(29, (int)potentialType02, 0); }
  ...
  public static void AddPotentialType03(FlatBufferBuilder builder, Schale.FlatData.PotentialStatBonusRateType potentialType03) { builder.AddInt(31, (int)potentialType03, 0); }
  ...
  public static Offset<Schale.FlatData.PresetCharacterGroupExcel> EndPresetCharacterGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.PresetCharacterGroupExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.PresetCharacterGroupExcel> Pack(FlatBufferBuilder builder, PresetCharacterGroupExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.PresetCharacterGroupExcel>);
...
public class PresetCharacterGroupExcelT
{
  ...
  public Schale.FlatData.PotentialStatBonusRateType PotentialType01 { get; set; }
  public int PotentialLevel01 { get; set; }
  public Schale.FlatData.PotentialStatBonusRateType PotentialType02 { get; set; }
  public int PotentialLevel02 { get; set; }
  public Schale.FlatData.PotentialStatBonusRateType PotentialType03 { get; set; }
  ...
  public PresetCharacterGroupExcelT() {
    ...
    this.PotentialType01 = Schale.FlatData.PotentialStatBonusRateType.None;
    this.PotentialLevel01 = 0;
    this.PotentialType02 = Schale.FlatData.PotentialStatBonusRateType.None;
    this.PotentialLevel02 = 0;
    this.PotentialType03 = Schale.FlatData.PotentialStatBonusRateType.None;
...
static public class PresetCharacterGroupExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 58 /*PotentialType01*/, 4 /*Schale.FlatData.PotentialStatBonusRateType*/, 4, false)
      && verifier.VerifyField(tablePos, 60 /*PotentialLevel01*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 62 /*PotentialType02*/, 4 /*Schale.FlatData.PotentialStatBonusRateType*/, 4, false)
      && verifier.VerifyField(tablePos, 64 /*PotentialLevel02*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 66 /*PotentialType03*/, 4 /*Schale.FlatData.PotentialStatBonusRateType*/, 4, false)
