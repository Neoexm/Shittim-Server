...
public struct FieldContentStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.FieldContentStageRewardExcel> CreateFieldContentStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Schale.FlatData.FieldContentStageRewardExcel> EndFieldContentStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.FieldContentStageRewardExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.FieldContentStageRewardExcel> Pack(FlatBufferBuilder builder, FieldContentStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.FieldContentStageRewardExcel>);
