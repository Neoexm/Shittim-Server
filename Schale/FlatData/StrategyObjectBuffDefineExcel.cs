...
public struct StrategyObjectBuffDefineExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.StrategyObjectBuffDefineExcel> CreateStrategyObjectBuffDefineExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.StrategyObjectBuffDefineExcel> EndStrategyObjectBuffDefineExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.StrategyObjectBuffDefineExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.StrategyObjectBuffDefineExcel> Pack(FlatBufferBuilder builder, StrategyObjectBuffDefineExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.StrategyObjectBuffDefineExcel>);
