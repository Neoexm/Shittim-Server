...
public struct ConquestErosionExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ConquestErosionType ErosionType { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.ConquestErosionType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ConquestErosionType.None; } }
  ...
  public Schale.FlatData.ConquestConditionType PhaseStartConditionType(int j) { int o = __p.__offset(16); return o != 0 ? (Schale.FlatData.ConquestConditionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.ConquestConditionType)0; }
  public int PhaseStartConditionTypeLength { get { int o = __p.__offset(16); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.ConquestConditionType> GetPhaseStartConditionTypeBytes() { return __p.__vector_as_span<Schale.FlatData.ConquestConditionType>(16, 4); }
#else
  public ArraySegment<byte>? GetPhaseStartConditionTypeBytes() { return __p.__vector_as_arraysegment(16); }
#endif
  public Schale.FlatData.ConquestConditionType[] GetPhaseStartConditionTypeArray() { int o = __p.__offset(16); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.ConquestConditionType[] a = new Schale.FlatData.ConquestConditionType[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.ConquestConditionType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Schale.FlatData.ConquestConditionType PhaseBeforeExposeConditionType(int j) { int o = __p.__offset(20); return o != 0 ? (Schale.FlatData.ConquestConditionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.ConquestConditionType)0; }
  public int PhaseBeforeExposeConditionTypeLength { get { int o = __p.__offset(20); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.ConquestConditionType> GetPhaseBeforeExposeConditionTypeBytes() { return __p.__vector_as_span<Schale.FlatData.ConquestConditionType>(20, 4); }
#else
  ...
  public Schale.FlatData.ParcelType ErosionBattleConditionParcelType { get { int o = __p.__offset(24); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.ConquestErosionExcel> CreateConquestErosionExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long Id = 0,
      Schale.FlatData.ConquestErosionType ErosionType = Schale.FlatData.ConquestErosionType.None,
      int Phase = 0,
      ...
      Schale.FlatData.ParcelType ErosionBattleConditionParcelType = Schale.FlatData.ParcelType.None,
  ...
  public static void AddErosionType(FlatBufferBuilder builder, Schale.FlatData.ConquestErosionType erosionType) { builder.AddInt(2, (int)erosionType, 0); }
  ...
  public static VectorOffset CreatePhaseStartConditionTypeVector(FlatBufferBuilder builder, Schale.FlatData.ConquestConditionType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreatePhaseStartConditionTypeVectorBlock(FlatBufferBuilder builder, Schale.FlatData.ConquestConditionType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreatePhaseStartConditionTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.ConquestConditionType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreatePhaseStartConditionTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.ConquestConditionType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreatePhaseBeforeExposeConditionTypeVector(FlatBufferBuilder builder, Schale.FlatData.ConquestConditionType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreatePhaseBeforeExposeConditionTypeVectorBlock(FlatBufferBuilder builder, Schale.FlatData.ConquestConditionType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreatePhaseBeforeExposeConditionTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Schale.FlatData.ConquestConditionType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreatePhaseBeforeExposeConditionTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Schale.FlatData.ConquestConditionType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddErosionBattleConditionParcelType(FlatBufferBuilder builder, Schale.FlatData.ParcelType erosionBattleConditionParcelType) { builder.AddInt(10, (int)erosionBattleConditionParcelType, 0); }
  ...
  public static Offset<Schale.FlatData.ConquestErosionExcel> EndConquestErosionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ConquestErosionExcel>(o);
  }
  ...
  public void UnPackTo(ConquestErosionExcelT _o) {
    ...
    _o.PhaseStartConditionType = new List<Schale.FlatData.ConquestConditionType>();
    ...
    _o.PhaseBeforeExposeConditionType = new List<Schale.FlatData.ConquestConditionType>();
  ...
  public static Offset<Schale.FlatData.ConquestErosionExcel> Pack(FlatBufferBuilder builder, ConquestErosionExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ConquestErosionExcel>);
...
public class ConquestErosionExcelT
{
  ...
  public Schale.FlatData.ConquestErosionType ErosionType { get; set; }
  public int Phase { get; set; }
  public bool PhaseAlarm { get; set; }
  public int StepIndex { get; set; }
  public List<Schale.FlatData.ConquestConditionType> PhaseStartConditionType { get; set; }
  public List<string> PhaseStartConditionParameter { get; set; }
  public List<Schale.FlatData.ConquestConditionType> PhaseBeforeExposeConditionType { get; set; }
  public List<string> PhaseBeforeExposeConditionParameter { get; set; }
  public Schale.FlatData.ParcelType ErosionBattleConditionParcelType { get; set; }
  ...
  public ConquestErosionExcelT() {
    ...
    this.Id = 0;
    this.ErosionType = Schale.FlatData.ConquestErosionType.None;
    this.Phase = 0;
    ...
    this.ErosionBattleConditionParcelType = Schale.FlatData.ParcelType.None;
...
static public class ConquestErosionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ErosionType*/, 4 /*Schale.FlatData.ConquestErosionType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 16 /*PhaseStartConditionType*/, 4 /*Schale.FlatData.ConquestConditionType*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 18 /*PhaseStartConditionParameter*/, false)
      && verifier.VerifyVectorOfData(tablePos, 20 /*PhaseBeforeExposeConditionType*/, 4 /*Schale.FlatData.ConquestConditionType*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 22 /*PhaseBeforeExposeConditionParameter*/, false)
      && verifier.VerifyField(tablePos, 24 /*ErosionBattleConditionParcelType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
