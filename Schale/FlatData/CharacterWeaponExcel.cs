...
public struct CharacterWeaponExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.StatLevelUpType StatLevelUpType { get { int o = __p.__offset(10); return o != 0 ? (Schale.FlatData.StatLevelUpType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.StatLevelUpType.Standard; } }
  ...
  public Schale.FlatData.Tag Tags(int j) { int o = __p.__offset(24); return o != 0 ? (Schale.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(24); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.Tag> GetTagsBytes() { return __p.__vector_as_span<Schale.FlatData.Tag>(24, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(24); }
#endif
  public Schale.FlatData.Tag[] GetTagsArray() { int o = __p.__offset(24); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Schale.FlatData.Tag[] a = new Schale.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Schale.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Schale.FlatData.EquipmentOptionType StatType(int j) { int o = __p.__offset(34); return o != 0 ? (Schale.FlatData.EquipmentOptionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Schale.FlatData.EquipmentOptionType)0; }
  public int StatTypeLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Schale.FlatData.EquipmentOptionType> GetStatTypeBytes() { return __p.__vector_as_span<Schale.FlatData.EquipmentOptionType>(34, 4); }
#else
  ...
  public static Offset<Schale.FlatData.CharacterWeaponExcel> CreateCharacterWeaponExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddStatLevelUpType(FlatBufferBuilder builder, Schale.FlatData.StatLevelUpType statLevelUpType) { builder.AddInt(3, (int)statLevelUpType, 0); }
  ...
  public static Offset<Schale.FlatData.CharacterWeaponExcel> EndCharacterWeaponExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CharacterWeaponExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.CharacterWeaponExcel> Pack(FlatBufferBuilder builder, CharacterWeaponExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.CharacterWeaponExcel>);
...
static public class CharacterWeaponExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*StatLevelUpType*/, 4 /*Schale.FlatData.StatLevelUpType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 24 /*Tags*/, 4 /*Schale.FlatData.Tag*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 34 /*StatType*/, 4 /*Schale.FlatData.EquipmentOptionType*/, false)
