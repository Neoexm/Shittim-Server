...
public struct EventContentExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.EventContentExcel> CreateEventContentExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Schale.FlatData.EventContentExcel> EndEventContentExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.EventContentExcel> Pack(FlatBufferBuilder builder, EventContentExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.EventContentExcel>);
