...
public struct CharacterIllustCoordinateExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.CharacterIllustCoordinateExcel> CreateCharacterIllustCoordinateExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Schale.FlatData.CharacterIllustCoordinateExcel> EndCharacterIllustCoordinateExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CharacterIllustCoordinateExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.CharacterIllustCoordinateExcel> Pack(FlatBufferBuilder builder, CharacterIllustCoordinateExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.CharacterIllustCoordinateExcel>);
