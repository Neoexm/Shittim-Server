...
public struct MinigameTBGEncounterOptionExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.MinigameTBGEncounterOptionExcel> CreateMinigameTBGEncounterOptionExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.MinigameTBGEncounterOptionExcel> EndMinigameTBGEncounterOptionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.MinigameTBGEncounterOptionExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.MinigameTBGEncounterOptionExcel> Pack(FlatBufferBuilder builder, MinigameTBGEncounterOptionExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.MinigameTBGEncounterOptionExcel>);
