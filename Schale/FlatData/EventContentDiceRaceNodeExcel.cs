...
public struct EventContentDiceRaceNodeExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.EventContentDiceRaceNodeType EventContentDiceRaceNodeType { get { int o = __p.__offset(8); return o != 0 ? (Schale.FlatData.EventContentDiceRaceNodeType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.EventContentDiceRaceNodeType.StartNode; } }
  ...
  public static Offset<Schale.FlatData.EventContentDiceRaceNodeExcel> CreateEventContentDiceRaceNodeExcel(FlatBufferBuilder builder,
  ...
  public static void AddEventContentDiceRaceNodeType(FlatBufferBuilder builder, Schale.FlatData.EventContentDiceRaceNodeType eventContentDiceRaceNodeType) { builder.AddInt(2, (int)eventContentDiceRaceNodeType, 0); }
  ...
  public static Offset<Schale.FlatData.EventContentDiceRaceNodeExcel> EndEventContentDiceRaceNodeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.EventContentDiceRaceNodeExcel>(o);
  }
...
public class EventContentDiceRaceNodeExcelT
{
  ...
  public Schale.FlatData.EventContentDiceRaceNodeType EventContentDiceRaceNodeType { get; set; }
  ...
  public EventContentDiceRaceNodeExcelT() {
    ...
    this.NodeId = 0;
    this.EventContentDiceRaceNodeType = Schale.FlatData.EventContentDiceRaceNodeType.StartNode;
...
static public class EventContentDiceRaceNodeExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*EventContentDiceRaceNodeType*/, 4 /*Schale.FlatData.EventContentDiceRaceNodeType*/, 4, false)
