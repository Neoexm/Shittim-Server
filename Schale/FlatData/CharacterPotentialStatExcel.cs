...
public struct CharacterPotentialStatExcel : IFlatbufferObject
{
  ...
  public static Offset<Schale.FlatData.CharacterPotentialStatExcel> CreateCharacterPotentialStatExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Schale.FlatData.CharacterPotentialStatExcel> EndCharacterPotentialStatExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.CharacterPotentialStatExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.CharacterPotentialStatExcel> Pack(FlatBufferBuilder builder, CharacterPotentialStatExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.CharacterPotentialStatExcel>);
