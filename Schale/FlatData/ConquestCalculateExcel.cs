...
public struct ConquestCalculateExcel : IFlatbufferObject
{
  ...
  public Schale.FlatData.ParcelType CalculateConditionParcelType { get { int o = __p.__offset(6); return o != 0 ? (Schale.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Schale.FlatData.ParcelType.None; } }
  ...
  public static Offset<Schale.FlatData.ConquestCalculateExcel> CreateConquestCalculateExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      Schale.FlatData.ParcelType CalculateConditionParcelType = Schale.FlatData.ParcelType.None,
  ...
  public static void AddCalculateConditionParcelType(FlatBufferBuilder builder, Schale.FlatData.ParcelType calculateConditionParcelType) { builder.AddInt(1, (int)calculateConditionParcelType, 0); }
  ...
  public static Offset<Schale.FlatData.ConquestCalculateExcel> EndConquestCalculateExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Schale.FlatData.ConquestCalculateExcel>(o);
  }
  ...
  public static Offset<Schale.FlatData.ConquestCalculateExcel> Pack(FlatBufferBuilder builder, ConquestCalculateExcelT _o) {
    if (_o == null) return default(Offset<Schale.FlatData.ConquestCalculateExcel>);
...
public class ConquestCalculateExcelT
{
  ...
  public Schale.FlatData.ParcelType CalculateConditionParcelType { get; set; }
  ...
  public ConquestCalculateExcelT() {
    ...
    this.CalculateConditionParcelType = Schale.FlatData.ParcelType.None;
...
static public class ConquestCalculateExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*CalculateConditionParcelType*/, 4 /*Schale.FlatData.ParcelType*/, 4, false)
