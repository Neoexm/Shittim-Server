...
public struct BattlePassInfoExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.BattlePassInfoExcel> CreateBattlePassInfoExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.BattlePassInfoExcel> EndBattlePassInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.BattlePassInfoExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.BattlePassInfoExcel> Pack(FlatBufferBuilder builder, BattlePassInfoExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.BattlePassInfoExcel>);
