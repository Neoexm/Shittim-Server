...
public struct GrowthScoreCalculationExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.GrowthFactor IncludeGrowthFactor { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.GrowthFactor)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.GrowthFactor.CharacterLevel; } }
  public long ConversionCoefficient { get { int o = __p.__offset(8); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }

  public static Offset<Plana.FlatData.GrowthScoreCalculationExcel> CreateGrowthScoreCalculationExcel(FlatBufferBuilder builder,
      long Id = 0,
      Plana.FlatData.GrowthFactor IncludeGrowthFactor = Plana.FlatData.GrowthFactor.CharacterLevel,
  ...
  public static void AddIncludeGrowthFactor(FlatBufferBuilder builder, Plana.FlatData.GrowthFactor includeGrowthFactor) { builder.AddInt(1, (int)includeGrowthFactor, 0); }
  ...
  public static Offset<Plana.FlatData.GrowthScoreCalculationExcel> EndGrowthScoreCalculationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.GrowthScoreCalculationExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.GrowthScoreCalculationExcel> Pack(FlatBufferBuilder builder, GrowthScoreCalculationExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.GrowthScoreCalculationExcel>);
...
public class GrowthScoreCalculationExcelT
{
  ...
  public Plana.FlatData.GrowthFactor IncludeGrowthFactor { get; set; }
  public long ConversionCoefficient { get; set; }

  public GrowthScoreCalculationExcelT() {
    this.Id = 0;
    this.IncludeGrowthFactor = Plana.FlatData.GrowthFactor.CharacterLevel;
...
static public class GrowthScoreCalculationExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*IncludeGrowthFactor*/, 4 /*Plana.FlatData.GrowthFactor*/, 4, false)
