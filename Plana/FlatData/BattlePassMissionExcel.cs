...
public struct BattlePassMissionExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.MissionResetType ResetType { get { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.MissionResetType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MissionResetType.None; } }
  public Plana.FlatData.MissionToastDisplayConditionType ToastDisplayType { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.MissionToastDisplayConditionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MissionToastDisplayConditionType.Always; } }
  ...
  public Plana.FlatData.MissionCompleteConditionType CompleteConditionType { get { int o = __p.__offset(28); return o != 0 ? (Plana.FlatData.MissionCompleteConditionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MissionCompleteConditionType.None; } }
  ...
  public Plana.FlatData.Tag CompleteConditionParameterTag(int j) { int o = __p.__offset(34); return o != 0 ? (Plana.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.Tag)0; }
  public int CompleteConditionParameterTagLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.Tag> GetCompleteConditionParameterTagBytes() { return __p.__vector_as_span<Plana.FlatData.Tag>(34, 4); }
#else
  public ArraySegment<byte>? GetCompleteConditionParameterTagBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public Plana.FlatData.Tag[] GetCompleteConditionParameterTagArray() { int o = __p.__offset(34); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.Tag[] a = new Plana.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  public int BattlePassExpAmount { get { int o = __p.__offset(36); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }

  public static Offset<Plana.FlatData.BattlePassMissionExcel> CreateBattlePassMissionExcel(FlatBufferBuilder builder,
      long BattlePassId = 0,
      long Id = 0,
  ...
  public static void AddResetType(FlatBufferBuilder builder, Plana.FlatData.MissionResetType resetType) { builder.AddInt(5, (int)resetType, 0); }
  public static void AddToastDisplayType(FlatBufferBuilder builder, Plana.FlatData.MissionToastDisplayConditionType toastDisplayType) { builder.AddInt(6, (int)toastDisplayType, 0); }
  ...
  public static void AddCompleteConditionType(FlatBufferBuilder builder, Plana.FlatData.MissionCompleteConditionType completeConditionType) { builder.AddInt(12, (int)completeConditionType, 0); }
  ...
  public static Offset<Plana.FlatData.BattlePassMissionExcel> EndBattlePassMissionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.BattlePassMissionExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.BattlePassMissionExcel> Pack(FlatBufferBuilder builder, BattlePassMissionExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.BattlePassMissionExcel>);
...
static public class BattlePassMissionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*ResetType*/, 4 /*Plana.FlatData.MissionResetType*/, 4, false)
      && verifier.VerifyField(tablePos, 16 /*ToastDisplayType*/, 4 /*Plana.FlatData.MissionToastDisplayConditionType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 28 /*CompleteConditionType*/, 4 /*Plana.FlatData.MissionCompleteConditionType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 34 /*CompleteConditionParameterTag*/, 4 /*Plana.FlatData.Tag*/, false)
