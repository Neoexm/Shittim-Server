...
public struct BattlePassLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.BattlePassLevelExcel> CreateBattlePassLevelExcel(FlatBufferBuilder builder,
      long BattlePassId = 0,
      long Level = 0,
  ...
  public static Offset<Plana.FlatData.BattlePassLevelExcel> EndBattlePassLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.BattlePassLevelExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.BattlePassLevelExcel> Pack(FlatBufferBuilder builder, BattlePassLevelExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.BattlePassLevelExcel>);
