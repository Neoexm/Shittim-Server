...
public struct MinigameCCGRewardItemExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MinigameCCGRewardItemExcel> CreateMinigameCCGRewardItemExcel(FlatBufferBuilder builder,
      long Id = 0,
      long CCGId = 0,
      int MinPoint = 0,
  ...
  public static Offset<Plana.FlatData.MinigameCCGRewardItemExcel> EndMinigameCCGRewardItemExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MinigameCCGRewardItemExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MinigameCCGRewardItemExcel> Pack(FlatBufferBuilder builder, MinigameCCGRewardItemExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MinigameCCGRewardItemExcel>);
