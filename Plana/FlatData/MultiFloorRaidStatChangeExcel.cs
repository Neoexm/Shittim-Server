...
public struct MultiFloorRaidStatChangeExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.StatType StatType(int j) { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.StatType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.StatType)0; }
  public int StatTypeLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.StatType> GetStatTypeBytes() { return __p.__vector_as_span<Plana.FlatData.StatType>(6, 4); }
#else
  public ArraySegment<byte>? GetStatTypeBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public Plana.FlatData.StatType[] GetStatTypeArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.StatType[] a = new Plana.FlatData.StatType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.StatType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static VectorOffset CreateStatTypeVector(FlatBufferBuilder builder, Plana.FlatData.StatType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateStatTypeVectorBlock(FlatBufferBuilder builder, Plana.FlatData.StatType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStatTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.StatType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStatTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.StatType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public void UnPackTo(MultiFloorRaidStatChangeExcelT _o) {
    ...
    _o.StatType = new List<Plana.FlatData.StatType>();
...
public class MultiFloorRaidStatChangeExcelT
{
  ...
  public List<Plana.FlatData.StatType> StatType { get; set; }
...
static public class MultiFloorRaidStatChangeExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*StatType*/, 4 /*Plana.FlatData.StatType*/, false)
