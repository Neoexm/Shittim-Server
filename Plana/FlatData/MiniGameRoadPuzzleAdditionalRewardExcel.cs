...
public struct MiniGameRoadPuzzleAdditionalRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MiniGameRoadPuzzleAdditionalRewardExcel> CreateMiniGameRoadPuzzleAdditionalRewardExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.MiniGameRoadPuzzleAdditionalRewardExcel> EndMiniGameRoadPuzzleAdditionalRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MiniGameRoadPuzzleAdditionalRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MiniGameRoadPuzzleAdditionalRewardExcel> Pack(FlatBufferBuilder builder, MiniGameRoadPuzzleAdditionalRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MiniGameRoadPuzzleAdditionalRewardExcel>);
