...
public struct SkillSelectExTooltipExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.SkillSelectExTooltipExcel> CreateSkillSelectExTooltipExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Plana.FlatData.SkillSelectExTooltipExcel> EndSkillSelectExTooltipExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.SkillSelectExTooltipExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.SkillSelectExTooltipExcel> Pack(FlatBufferBuilder builder, SkillSelectExTooltipExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.SkillSelectExTooltipExcel>);
