...
public struct KeyMappingPopupExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.KeyMappingPopupExcel> CreateKeyMappingPopupExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.KeyMappingPopupExcel> EndKeyMappingPopupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.KeyMappingPopupExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.KeyMappingPopupExcel> Pack(FlatBufferBuilder builder, KeyMappingPopupExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.KeyMappingPopupExcel>);
