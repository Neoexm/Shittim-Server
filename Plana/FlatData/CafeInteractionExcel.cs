...
public struct CafeInteractionExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.BubbleType BubbleType(int j) { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.BubbleType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.BubbleType)0; }
  public int BubbleTypeLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.BubbleType> GetBubbleTypeBytes() { return __p.__vector_as_span<Plana.FlatData.BubbleType>(12, 4); }
#else
  public ArraySegment<byte>? GetBubbleTypeBytes() { return __p.__vector_as_arraysegment(12); }
#endif
  public Plana.FlatData.BubbleType[] GetBubbleTypeArray() { int o = __p.__offset(12); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.BubbleType[] a = new Plana.FlatData.BubbleType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.BubbleType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static VectorOffset CreateBubbleTypeVector(FlatBufferBuilder builder, Plana.FlatData.BubbleType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateBubbleTypeVectorBlock(FlatBufferBuilder builder, Plana.FlatData.BubbleType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateBubbleTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.BubbleType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateBubbleTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.BubbleType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public void UnPackTo(CafeInteractionExcelT _o) {
    ...
    _o.BubbleType = new List<Plana.FlatData.BubbleType>();
...
public class CafeInteractionExcelT
{
  ...
  public List<Plana.FlatData.BubbleType> BubbleType { get; set; }
...
static public class CafeInteractionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 12 /*BubbleType*/, 4 /*Plana.FlatData.BubbleType*/, false)
