...
public struct ProductSelectionGroupExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ParcelType ParcelType { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public Plana.FlatData.ParcelType ConditionParcelType { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  public long ConditionParcelId { get { int o = __p.__offset(18); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }

  public static Offset<Plana.FlatData.ProductSelectionGroupExcel> CreateProductSelectionGroupExcel(FlatBufferBuilder builder,
      ...
      long ParcelId = 0,
      long ResultAmount = 0,
      Plana.FlatData.ParcelType ConditionParcelType = Plana.FlatData.ParcelType.None,
  ...
  public static void AddParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType parcelType) { builder.AddInt(3, (int)parcelType, 0); }
  ...
  public static void AddConditionParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType conditionParcelType) { builder.AddInt(6, (int)conditionParcelType, 0); }
  ...
  public static Offset<Plana.FlatData.ProductSelectionGroupExcel> EndProductSelectionGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ProductSelectionGroupExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ProductSelectionGroupExcel> Pack(FlatBufferBuilder builder, ProductSelectionGroupExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ProductSelectionGroupExcel>);
...
public class ProductSelectionGroupExcelT
{
  ...
  public Plana.FlatData.ParcelType ConditionParcelType { get; set; }
  ...
  public ProductSelectionGroupExcelT() {
    ...
    this.ParcelId = 0;
    this.ResultAmount = 0;
    this.ConditionParcelType = Plana.FlatData.ParcelType.None;
...
static public class ProductSelectionGroupExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*ParcelId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 14 /*ResultAmount*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 16 /*ConditionParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
