...
public struct KeyMappingExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.KeyMappingExcel> CreateKeyMappingExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.KeyMappingExcel> EndKeyMappingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.KeyMappingExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.KeyMappingExcel> Pack(FlatBufferBuilder builder, KeyMappingExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.KeyMappingExcel>);
