...
public struct GachaSelectPickupGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.GachaSelectPickupGroupExcel> CreateGachaSelectPickupGroupExcel(FlatBufferBuilder builder,
      long Id = 0,
      long GachaGroupId = 0,
      long CharacterId = 0) {
  ...
  public static Offset<Plana.FlatData.GachaSelectPickupGroupExcel> EndGachaSelectPickupGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.GachaSelectPickupGroupExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.GachaSelectPickupGroupExcel> Pack(FlatBufferBuilder builder, GachaSelectPickupGroupExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.GachaSelectPickupGroupExcel>);
