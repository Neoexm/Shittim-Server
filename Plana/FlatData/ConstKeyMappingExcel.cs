...
public struct ConstKeyMappingExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.ConstKeyMappingExcel> CreateConstKeyMappingExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.ConstKeyMappingExcel> EndConstKeyMappingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ConstKeyMappingExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ConstKeyMappingExcel> Pack(FlatBufferBuilder builder, ConstKeyMappingExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ConstKeyMappingExcel>);
