...
public struct MinigameCCGLogicEffectExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MinigameCCGLogicEffectExcel> CreateMinigameCCGLogicEffectExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.MinigameCCGLogicEffectExcel> EndMinigameCCGLogicEffectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MinigameCCGLogicEffectExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MinigameCCGLogicEffectExcel> Pack(FlatBufferBuilder builder, MinigameCCGLogicEffectExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MinigameCCGLogicEffectExcel>);
