...
public struct BattlePassExpLimitExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.BattlePassExpLimitExcel> CreateBattlePassExpLimitExcel(FlatBufferBuilder builder,
      long BattlePassId = 0,
  ...
  public static Offset<Plana.FlatData.BattlePassExpLimitExcel> EndBattlePassExpLimitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.BattlePassExpLimitExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.BattlePassExpLimitExcel> Pack(FlatBufferBuilder builder, BattlePassExpLimitExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.BattlePassExpLimitExcel>);
