...
public struct EventContentStageExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.StageTopography StageTopography { get { int o = __p.__offset(56); return o != 0 ? (Plana.FlatData.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StageTopography.Street; } }
  ...
  public Plana.FlatData.StrategyEnvironment StrategyEnvironment { get { int o = __p.__offset(62); return o != 0 ? (Plana.FlatData.StrategyEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StrategyEnvironment.None; } }
  public long GroundID { get { int o = __p.__offset(64); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Plana.FlatData.ContentType ContentType { get { int o = __p.__offset(66); return o != 0 ? (Plana.FlatData.ContentType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ContentType.None; } }
  ...
  public Plana.FlatData.EchelonExtensionType EchelonExtensionType { get { int o = __p.__offset(86); return o != 0 ? (Plana.FlatData.EchelonExtensionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EchelonExtensionType.Base; } }
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, Plana.FlatData.StageTopography stageTopography) { builder.AddInt(26, (int)stageTopography, 0); }
  ...
  public static void AddStrategyEnvironment(FlatBufferBuilder builder, Plana.FlatData.StrategyEnvironment strategyEnvironment) { builder.AddInt(29, (int)strategyEnvironment, 0); }
  public static void AddGroundID(FlatBufferBuilder builder, long groundID) { builder.AddLong(30, groundID, 0); }
  public static void AddContentType(FlatBufferBuilder builder, Plana.FlatData.ContentType contentType) { builder.AddInt(31, (int)contentType, 0); }
  ...
  public static void AddEchelonExtensionType(FlatBufferBuilder builder, Plana.FlatData.EchelonExtensionType echelonExtensionType) { builder.AddInt(41, (int)echelonExtensionType, 0); }
...
static public class EventContentStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 56 /*StageTopography*/, 4 /*Plana.FlatData.StageTopography*/, 4, false)
      && verifier.VerifyField(tablePos, 58 /*RecommandLevel*/, 4 /*int*/, 4, false)
      && verifier.VerifyString(tablePos, 60 /*BgmId*/, false)
      && verifier.VerifyField(tablePos, 62 /*StrategyEnvironment*/, 4 /*Plana.FlatData.StrategyEnvironment*/, 4, false)
      && verifier.VerifyField(tablePos, 64 /*GroundID*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 66 /*ContentType*/, 4 /*Plana.FlatData.ContentType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 86 /*EchelonExtensionType*/, 4 /*Plana.FlatData.EchelonExtensionType*/, 4, false)
