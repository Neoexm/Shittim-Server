...
public struct MinigameCCGLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MinigameCCGLevelExcel> CreateMinigameCCGLevelExcel(FlatBufferBuilder builder,
      long LevelId = 0,
      long CCGId = 0,
      int FloorIndex = 0,
  ...
  public static Offset<Plana.FlatData.MinigameCCGLevelExcel> EndMinigameCCGLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MinigameCCGLevelExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MinigameCCGLevelExcel> Pack(FlatBufferBuilder builder, MinigameCCGLevelExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MinigameCCGLevelExcel>);
