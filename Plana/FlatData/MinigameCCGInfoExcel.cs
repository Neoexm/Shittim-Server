...
public struct MinigameCCGInfoExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ParcelType CostParcelType { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public Plana.FlatData.ParcelType PerkCostParcelType { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  public long PerkCostParcelId { get { int o = __p.__offset(18); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }

  public static Offset<Plana.FlatData.MinigameCCGInfoExcel> CreateMinigameCCGInfoExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.ParcelType PerkCostParcelType = Plana.FlatData.ParcelType.None,
  ...
  public static void AddCostParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType costParcelType) { builder.AddInt(2, (int)costParcelType, 0); }
  ...
  public static void AddPerkCostParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType perkCostParcelType) { builder.AddInt(6, (int)perkCostParcelType, 0); }
  ...
  public static Offset<Plana.FlatData.MinigameCCGInfoExcel> EndMinigameCCGInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MinigameCCGInfoExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MinigameCCGInfoExcel> Pack(FlatBufferBuilder builder, MinigameCCGInfoExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MinigameCCGInfoExcel>);
...
public class MinigameCCGInfoExcelT
{
  ...
  public Plana.FlatData.ParcelType PerkCostParcelType { get; set; }
  ...
  public MinigameCCGInfoExcelT() {
    ...
    this.PerkCostParcelType = Plana.FlatData.ParcelType.None;
...
static public class MinigameCCGInfoExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CostParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 16 /*PerkCostParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
