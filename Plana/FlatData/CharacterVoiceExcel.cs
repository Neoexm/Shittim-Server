...
public struct CharacterVoiceExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Nation Nation(int j) { int o = __p.__offset(24); return o != 0 ? (Plana.FlatData.Nation)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.Nation)0; }
  public int NationLength { get { int o = __p.__offset(24); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.Nation> GetNationBytes() { return __p.__vector_as_span<Plana.FlatData.Nation>(24, 4); }
#else
  public ArraySegment<byte>? GetNationBytes() { return __p.__vector_as_arraysegment(24); }
#endif
  public Plana.FlatData.Nation[] GetNationArray() { int o = __p.__offset(24); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.Nation[] a = new Plana.FlatData.Nation[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.Nation)__p.bb.GetInt(p + i * 4); } return a; }
...
static public class CharacterVoiceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 24 /*Nation*/, 4 /*Plana.FlatData.Nation*/, false)
