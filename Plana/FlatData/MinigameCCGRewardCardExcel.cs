...
public struct MinigameCCGRewardCardExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.CCGEntityType EntityType { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.CCGEntityType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.CCGEntityType.None; } }
  ...
  public static Offset<Plana.FlatData.MinigameCCGRewardCardExcel> CreateMinigameCCGRewardCardExcel(FlatBufferBuilder builder,
      long Id = 0,
      long GroupId = 0,
      Plana.FlatData.CCGEntityType EntityType = Plana.FlatData.CCGEntityType.None,
      long CardId = 0,
      int CardRarity = 0) {
  ...
  public static void AddEntityType(FlatBufferBuilder builder, Plana.FlatData.CCGEntityType entityType) { builder.AddInt(2, (int)entityType, 0); }
  ...
  public static Offset<Plana.FlatData.MinigameCCGRewardCardExcel> EndMinigameCCGRewardCardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MinigameCCGRewardCardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MinigameCCGRewardCardExcel> Pack(FlatBufferBuilder builder, MinigameCCGRewardCardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MinigameCCGRewardCardExcel>);
...
public class MinigameCCGRewardCardExcelT
{
  ...
  public Plana.FlatData.CCGEntityType EntityType { get; set; }
  ...
  public MinigameCCGRewardCardExcelT() {
    this.Id = 0;
    this.GroupId = 0;
    this.EntityType = Plana.FlatData.CCGEntityType.None;
    this.CardId = 0;
    this.CardRarity = 0;
  }
}
...
static public class MinigameCCGRewardCardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*EntityType*/, 4 /*Plana.FlatData.CCGEntityType*/, 4, false)
