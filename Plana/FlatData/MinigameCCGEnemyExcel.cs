...
public struct MinigameCCGEnemyExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.CCGCharacterType CharacterType { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.CCGCharacterType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.CCGCharacterType.None; } }
  ...
  public static Offset<Plana.FlatData.MinigameCCGEnemyExcel> CreateMinigameCCGEnemyExcel(FlatBufferBuilder builder,
      long Id = 0,
      long GroupId = 0,
      Plana.FlatData.CCGCharacterType CharacterType = Plana.FlatData.CCGCharacterType.None,
      int Order = 0,
      long CharacterId = 0) {
  ...
  public static void AddCharacterType(FlatBufferBuilder builder, Plana.FlatData.CCGCharacterType characterType) { builder.AddInt(2, (int)characterType, 0); }
  ...
  public static Offset<Plana.FlatData.MinigameCCGEnemyExcel> EndMinigameCCGEnemyExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MinigameCCGEnemyExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MinigameCCGEnemyExcel> Pack(FlatBufferBuilder builder, MinigameCCGEnemyExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MinigameCCGEnemyExcel>);
...
public class MinigameCCGEnemyExcelT
{
  ...
  public Plana.FlatData.CCGCharacterType CharacterType { get; set; }
  ...
  public MinigameCCGEnemyExcelT() {
    this.Id = 0;
    this.GroupId = 0;
    this.CharacterType = Plana.FlatData.CCGCharacterType.None;
    this.Order = 0;
    this.CharacterId = 0;
  }
}
...
static public class MinigameCCGEnemyExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CharacterType*/, 4 /*Plana.FlatData.CCGCharacterType*/, 4, false)
