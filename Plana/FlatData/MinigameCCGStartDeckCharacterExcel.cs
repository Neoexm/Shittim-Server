...
public struct MinigameCCGStartDeckCharacterExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MinigameCCGStartDeckCharacterExcel> CreateMinigameCCGStartDeckCharacterExcel(FlatBufferBuilder builder,
      long CCGId = 0,
      long CharacterId = 0) {
  ...
  public static Offset<Plana.FlatData.MinigameCCGStartDeckCharacterExcel> EndMinigameCCGStartDeckCharacterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MinigameCCGStartDeckCharacterExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MinigameCCGStartDeckCharacterExcel> Pack(FlatBufferBuilder builder, MinigameCCGStartDeckCharacterExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MinigameCCGStartDeckCharacterExcel>);
