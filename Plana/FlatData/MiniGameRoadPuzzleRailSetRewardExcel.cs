...
public struct MiniGameRoadPuzzleRailSetRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MiniGameRoadPuzzleRailSetRewardExcel> CreateMiniGameRoadPuzzleRailSetRewardExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.MiniGameRoadPuzzleRailSetRewardExcel> EndMiniGameRoadPuzzleRailSetRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MiniGameRoadPuzzleRailSetRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MiniGameRoadPuzzleRailSetRewardExcel> Pack(FlatBufferBuilder builder, MiniGameRoadPuzzleRailSetRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MiniGameRoadPuzzleRailSetRewardExcel>);
