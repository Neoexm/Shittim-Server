...
public struct EmblemExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EmblemDisplayType DisplayType { get { int o = __p.__offset(40); return o != 0 ? (Plana.FlatData.EmblemDisplayType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EmblemDisplayType.Always; } }
  ...
  public Plana.FlatData.EmblemCheckPassType CheckPassType { get { int o = __p.__offset(48); return o != 0 ? (Plana.FlatData.EmblemCheckPassType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EmblemCheckPassType.None; } }
  ...
  public static void AddDisplayType(FlatBufferBuilder builder, Plana.FlatData.EmblemDisplayType displayType) { builder.AddInt(18, (int)displayType, 0); }
  ...
  public static void AddCheckPassType(FlatBufferBuilder builder, Plana.FlatData.EmblemCheckPassType checkPassType) { builder.AddInt(22, (int)checkPassType, 0); }
...
static public class EmblemExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 40 /*DisplayType*/, 4 /*Plana.FlatData.EmblemDisplayType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 48 /*CheckPassType*/, 4 /*Plana.FlatData.EmblemCheckPassType*/, 4, false)
