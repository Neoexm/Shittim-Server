...
public struct MiniGameRoadPuzzleInfoExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ParcelType EventUseCostType { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static Offset<Plana.FlatData.MiniGameRoadPuzzleInfoExcel> CreateMiniGameRoadPuzzleInfoExcel(FlatBufferBuilder builder,
  ...
  public static void AddEventUseCostType(FlatBufferBuilder builder, Plana.FlatData.ParcelType eventUseCostType) { builder.AddInt(1, (int)eventUseCostType, 0); }
  ...
  public static Offset<Plana.FlatData.MiniGameRoadPuzzleInfoExcel> EndMiniGameRoadPuzzleInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MiniGameRoadPuzzleInfoExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MiniGameRoadPuzzleInfoExcel> Pack(FlatBufferBuilder builder, MiniGameRoadPuzzleInfoExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MiniGameRoadPuzzleInfoExcel>);
...
static public class MiniGameRoadPuzzleInfoExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*EventUseCostType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
