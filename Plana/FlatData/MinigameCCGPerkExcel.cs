...
public struct MinigameCCGPerkExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MinigameCCGPerkExcel> CreateMinigameCCGPerkExcel(FlatBufferBuilder builder,
      long Id = 0,
      long CCGId = 0,
  ...
  public static Offset<Plana.FlatData.MinigameCCGPerkExcel> EndMinigameCCGPerkExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MinigameCCGPerkExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MinigameCCGPerkExcel> Pack(FlatBufferBuilder builder, MinigameCCGPerkExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MinigameCCGPerkExcel>);
