...
public struct MinigameCCGEnemyGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MinigameCCGEnemyGroupExcel> CreateMinigameCCGEnemyGroupExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Plana.FlatData.MinigameCCGEnemyGroupExcel> EndMinigameCCGEnemyGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MinigameCCGEnemyGroupExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MinigameCCGEnemyGroupExcel> Pack(FlatBufferBuilder builder, MinigameCCGEnemyGroupExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MinigameCCGEnemyGroupExcel>);
