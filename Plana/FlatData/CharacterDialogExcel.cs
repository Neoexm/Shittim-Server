...
public struct CharacterDialogExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.CVCollectionType CVCollectionType { get { int o = __p.__offset(54); return o != 0 ? (Plana.FlatData.CVCollectionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.CVCollectionType.CVNormal; } }
  ...
  public static void AddCVCollectionType(FlatBufferBuilder builder, Plana.FlatData.CVCollectionType cVCollectionType) { builder.AddInt(25, (int)cVCollectionType, 0); }
...
static public class CharacterDialogExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 54 /*CVCollectionType*/, 4 /*Plana.FlatData.CVCollectionType*/, 4, false)
