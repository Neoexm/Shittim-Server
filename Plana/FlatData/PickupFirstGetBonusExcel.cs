...
public struct PickupFirstGetBonusExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.PickupFirstGetBonusExcel> CreatePickupFirstGetBonusExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.PickupFirstGetBonusExcel> EndPickupFirstGetBonusExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.PickupFirstGetBonusExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.PickupFirstGetBonusExcel> Pack(FlatBufferBuilder builder, PickupFirstGetBonusExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.PickupFirstGetBonusExcel>);
