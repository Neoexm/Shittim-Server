...
public struct ShopInfoExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ShopRefresherType ShopRefresherType { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.ShopRefresherType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ShopRefresherType.None; } }
  public Plana.FlatData.ShopRefreshPeriodType ShopRefreshPeriodType { get { int o = __p.__offset(18); return o != 0 ? (Plana.FlatData.ShopRefreshPeriodType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ShopRefreshPeriodType.None; } }
  ...
  public Plana.FlatData.ParcelType DisplayParcelType { get { int o = __p.__offset(32); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static Offset<Plana.FlatData.ShopInfoExcel> CreateShopInfoExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.ShopRefresherType ShopRefresherType = Plana.FlatData.ShopRefresherType.None,
      Plana.FlatData.ShopRefreshPeriodType ShopRefreshPeriodType = Plana.FlatData.ShopRefreshPeriodType.None,
  ...
  public static void AddShopRefresherType(FlatBufferBuilder builder, Plana.FlatData.ShopRefresherType shopRefresherType) { builder.AddInt(6, (int)shopRefresherType, 0); }
  public static void AddShopRefreshPeriodType(FlatBufferBuilder builder, Plana.FlatData.ShopRefreshPeriodType shopRefreshPeriodType) { builder.AddInt(7, (int)shopRefreshPeriodType, 0); }
  ...
  public static void AddDisplayParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType displayParcelType) { builder.AddInt(14, (int)displayParcelType, 0); }
...
public class ShopInfoExcelT
{
  ...
  public Plana.FlatData.ShopRefresherType ShopRefresherType { get; set; }
  public Plana.FlatData.ShopRefreshPeriodType ShopRefreshPeriodType { get; set; }
  ...
  public ShopInfoExcelT() {
    ...
    this.ShopRefresherType = Plana.FlatData.ShopRefresherType.None;
    this.ShopRefreshPeriodType = Plana.FlatData.ShopRefreshPeriodType.None;
...
static public class ShopInfoExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*ShopRefresherType*/, 4 /*Plana.FlatData.ShopRefresherType*/, 4, false)
      && verifier.VerifyField(tablePos, 18 /*ShopRefreshPeriodType*/, 4 /*Plana.FlatData.ShopRefreshPeriodType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 32 /*DisplayParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
