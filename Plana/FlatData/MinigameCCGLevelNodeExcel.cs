...
public struct MinigameCCGLevelNodeExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.CCGLevelNodeIcon NodeIcon { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.CCGLevelNodeIcon)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.CCGLevelNodeIcon.None; } }
  ...
  public static Offset<Plana.FlatData.MinigameCCGLevelNodeExcel> CreateMinigameCCGLevelNodeExcel(FlatBufferBuilder builder,
      long LevelId = 0,
      long NodeId = 0,
      Plana.FlatData.CCGLevelNodeIcon NodeIcon = Plana.FlatData.CCGLevelNodeIcon.None,
      long StageGroupId = 0,
  ...
  public static void AddNodeIcon(FlatBufferBuilder builder, Plana.FlatData.CCGLevelNodeIcon nodeIcon) { builder.AddInt(2, (int)nodeIcon, 0); }
  ...
  public static Offset<Plana.FlatData.MinigameCCGLevelNodeExcel> EndMinigameCCGLevelNodeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MinigameCCGLevelNodeExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MinigameCCGLevelNodeExcel> Pack(FlatBufferBuilder builder, MinigameCCGLevelNodeExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MinigameCCGLevelNodeExcel>);
...
public class MinigameCCGLevelNodeExcelT
{
  ...
  public Plana.FlatData.CCGLevelNodeIcon NodeIcon { get; set; }
  ...
  public MinigameCCGLevelNodeExcelT() {
    this.LevelId = 0;
    this.NodeId = 0;
    this.NodeIcon = Plana.FlatData.CCGLevelNodeIcon.None;
    this.StageGroupId = 0;
...
static public class MinigameCCGLevelNodeExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*NodeIcon*/, 4 /*Plana.FlatData.CCGLevelNodeIcon*/, 4, false)
