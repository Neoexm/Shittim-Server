...
public struct AccountLevelRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.AccountLevelRewardExcel> CreateAccountLevelRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
      long Level = 0,
  ...
  public static Offset<Plana.FlatData.AccountLevelRewardExcel> EndAccountLevelRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.AccountLevelRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.AccountLevelRewardExcel> Pack(FlatBufferBuilder builder, AccountLevelRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.AccountLevelRewardExcel>);
