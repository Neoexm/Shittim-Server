...
public struct MinigameCCGSkillExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MinigameCCGSkillExcel> CreateMinigameCCGSkillExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.MinigameCCGSkillExcel> EndMinigameCCGSkillExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MinigameCCGSkillExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MinigameCCGSkillExcel> Pack(FlatBufferBuilder builder, MinigameCCGSkillExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MinigameCCGSkillExcel>);
