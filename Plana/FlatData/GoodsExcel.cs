...
public struct GoodsExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ConsumeCondition ConsumeCondition(int j) { int o = __p.__offset(18); return o != 0 ? (Plana.FlatData.ConsumeCondition)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.ConsumeCondition)0; }
  public int ConsumeConditionLength { get { int o = __p.__offset(18); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.ConsumeCondition> GetConsumeConditionBytes() { return __p.__vector_as_span<Plana.FlatData.ConsumeCondition>(18, 4); }
#else
  public ArraySegment<byte>? GetConsumeConditionBytes() { return __p.__vector_as_arraysegment(18); }
#endif
  public Plana.FlatData.ConsumeCondition[] GetConsumeConditionArray() { int o = __p.__offset(18); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.ConsumeCondition[] a = new Plana.FlatData.ConsumeCondition[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.ConsumeCondition)__p.bb.GetInt(p + i * 4); } return a; }
  public Plana.FlatData.GachaTicketType ConsumeGachaTicketType(int j) { int o = __p.__offset(20); return o != 0 ? (Plana.FlatData.GachaTicketType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.GachaTicketType)0; }
  public int ConsumeGachaTicketTypeLength { get { int o = __p.__offset(20); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.GachaTicketType> GetConsumeGachaTicketTypeBytes() { return __p.__vector_as_span<Plana.FlatData.GachaTicketType>(20, 4); }
#else
  public ArraySegment<byte>? GetConsumeGachaTicketTypeBytes() { return __p.__vector_as_arraysegment(20); }
#endif
  public Plana.FlatData.GachaTicketType[] GetConsumeGachaTicketTypeArray() { int o = __p.__offset(20); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.GachaTicketType[] a = new Plana.FlatData.GachaTicketType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.GachaTicketType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Plana.FlatData.ParcelType ParcelType(int j) { int o = __p.__offset(40); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.ParcelType)0; }
  public int ParcelTypeLength { get { int o = __p.__offset(40); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.ParcelType> GetParcelTypeBytes() { return __p.__vector_as_span<Plana.FlatData.ParcelType>(40, 4); }
#else
  public ArraySegment<byte>? GetParcelTypeBytes() { return __p.__vector_as_arraysegment(40); }
#endif
  public Plana.FlatData.ParcelType[] GetParcelTypeArray() { int o = __p.__offset(40); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.ParcelType[] a = new Plana.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static VectorOffset CreateConsumeConditionVector(FlatBufferBuilder builder, Plana.FlatData.ConsumeCondition[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateConsumeConditionVectorBlock(FlatBufferBuilder builder, Plana.FlatData.ConsumeCondition[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeConditionVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.ConsumeCondition> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeConditionVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.ConsumeCondition>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateConsumeGachaTicketTypeVector(FlatBufferBuilder builder, Plana.FlatData.GachaTicketType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateConsumeGachaTicketTypeVectorBlock(FlatBufferBuilder builder, Plana.FlatData.GachaTicketType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeGachaTicketTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.GachaTicketType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeGachaTicketTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.GachaTicketType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public void UnPackTo(GoodsExcelT _o) {
    ...
    _o.ConsumeCondition = new List<Plana.FlatData.ConsumeCondition>();
    ...
    _o.ConsumeGachaTicketType = new List<Plana.FlatData.GachaTicketType>();
...
public class GoodsExcelT
{
  ...
  public List<Plana.FlatData.ConsumeCondition> ConsumeCondition { get; set; }
  public List<Plana.FlatData.GachaTicketType> ConsumeGachaTicketType { get; set; }
...
static public class GoodsExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 18 /*ConsumeCondition*/, 4 /*Plana.FlatData.ConsumeCondition*/, false)
      && verifier.VerifyVectorOfData(tablePos, 20 /*ConsumeGachaTicketType*/, 4 /*Plana.FlatData.GachaTicketType*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 40 /*ParcelType*/, 4 /*Plana.FlatData.ParcelType*/, false)
