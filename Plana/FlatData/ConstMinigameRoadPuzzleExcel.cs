...
public struct ConstMinigameRoadPuzzleExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.ConstMinigameRoadPuzzleExcel> CreateConstMinigameRoadPuzzleExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.ConstMinigameRoadPuzzleExcel> EndConstMinigameRoadPuzzleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ConstMinigameRoadPuzzleExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ConstMinigameRoadPuzzleExcel> Pack(FlatBufferBuilder builder, ConstMinigameRoadPuzzleExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ConstMinigameRoadPuzzleExcel>);
