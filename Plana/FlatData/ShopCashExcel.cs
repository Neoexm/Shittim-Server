...
public struct ShopCashExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.PurchaseSourceType PackageClientType { get { int o = __p.__offset(38); return o != 0 ? (Plana.FlatData.PurchaseSourceType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.PurchaseSourceType.None; } }
  ...
  public static void AddPackageClientType(FlatBufferBuilder builder, Plana.FlatData.PurchaseSourceType packageClientType) { builder.AddInt(17, (int)packageClientType, 0); }
...
static public class ShopCashExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 38 /*PackageClientType*/, 4 /*Plana.FlatData.PurchaseSourceType*/, 4, false)
