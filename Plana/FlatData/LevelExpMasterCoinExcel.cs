...
public struct LevelExpMasterCoinExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.LevelExpMasterCoinExcel> CreateLevelExpMasterCoinExcel(FlatBufferBuilder builder,
      long Id = 0,
      int MinLevel = 0,
      int MaxLevel = 0,
      int Ratio = 0) {
  ...
  public static Offset<Plana.FlatData.LevelExpMasterCoinExcel> EndLevelExpMasterCoinExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.LevelExpMasterCoinExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.LevelExpMasterCoinExcel> Pack(FlatBufferBuilder builder, LevelExpMasterCoinExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.LevelExpMasterCoinExcel>);
