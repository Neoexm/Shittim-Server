...
public struct PossessionCheckExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ParcelType DefaultParcelType { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public Plana.FlatData.ParcelType ReplaceParcelType { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static Offset<Plana.FlatData.PossessionCheckExcel> CreatePossessionCheckExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      Plana.FlatData.ParcelType DefaultParcelType = Plana.FlatData.ParcelType.None,
      long DefaultParcelId = 0,
      int DefaultParcelAmount = 0,
      Plana.FlatData.ParcelType ReplaceParcelType = Plana.FlatData.ParcelType.None,
  ...
  public static void AddDefaultParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType defaultParcelType) { builder.AddInt(1, (int)defaultParcelType, 0); }
  ...
  public static void AddReplaceParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType replaceParcelType) { builder.AddInt(4, (int)replaceParcelType, 0); }
  ...
  public static Offset<Plana.FlatData.PossessionCheckExcel> EndPossessionCheckExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.PossessionCheckExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.PossessionCheckExcel> Pack(FlatBufferBuilder builder, PossessionCheckExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.PossessionCheckExcel>);
...
public class PossessionCheckExcelT
{
  ...
  public Plana.FlatData.ParcelType DefaultParcelType { get; set; }
  public long DefaultParcelId { get; set; }
  public int DefaultParcelAmount { get; set; }
  public Plana.FlatData.ParcelType ReplaceParcelType { get; set; }
  public long ReplaceParcelId { get; set; }
  public int ReplaceParcelAmount { get; set; }

  public PossessionCheckExcelT() {
    this.UniqueId = 0;
    this.DefaultParcelType = Plana.FlatData.ParcelType.None;
    this.DefaultParcelId = 0;
    this.DefaultParcelAmount = 0;
    this.ReplaceParcelType = Plana.FlatData.ParcelType.None;
...
static public class PossessionCheckExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*DefaultParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 12 /*ReplaceParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
