...
public struct MinigameRoadPuzzleRailTileExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.RoadPuzzleRailTileType RailTileType { get { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.RoadPuzzleRailTileType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.RoadPuzzleRailTileType.None; } }

  public static Offset<Plana.FlatData.MinigameRoadPuzzleRailTileExcel> CreateMinigameRoadPuzzleRailTileExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long UniqueId = 0,
      long GroupId = 0,
      bool OriginalTile = false,
      StringOffset PrefabNameOffset = default(StringOffset),
      Plana.FlatData.RoadPuzzleRailTileType RailTileType = Plana.FlatData.RoadPuzzleRailTileType.None) {
  ...
  public static void AddRailTileType(FlatBufferBuilder builder, Plana.FlatData.RoadPuzzleRailTileType railTileType) { builder.AddInt(5, (int)railTileType, 0); }
  public static Offset<Plana.FlatData.MinigameRoadPuzzleRailTileExcel> EndMinigameRoadPuzzleRailTileExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MinigameRoadPuzzleRailTileExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MinigameRoadPuzzleRailTileExcel> Pack(FlatBufferBuilder builder, MinigameRoadPuzzleRailTileExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MinigameRoadPuzzleRailTileExcel>);
...
public class MinigameRoadPuzzleRailTileExcelT
{
  ...
  public Plana.FlatData.RoadPuzzleRailTileType RailTileType { get; set; }
  ...
  public MinigameRoadPuzzleRailTileExcelT() {
    ...
    this.RailTileType = Plana.FlatData.RoadPuzzleRailTileType.None;
  }
}
...
static public class MinigameRoadPuzzleRailTileExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*RailTileType*/, 4 /*Plana.FlatData.RoadPuzzleRailTileType*/, 4, false)
