...
public struct ConquestGroupBuffExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.School School(int j) { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.School)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.School)0; }
  public int SchoolLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.School> GetSchoolBytes() { return __p.__vector_as_span<Plana.FlatData.School>(6, 4); }
#else
  public ArraySegment<byte>? GetSchoolBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public Plana.FlatData.School[] GetSchoolArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.School[] a = new Plana.FlatData.School[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.School)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static VectorOffset CreateSchoolVector(FlatBufferBuilder builder, Plana.FlatData.School[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateSchoolVectorBlock(FlatBufferBuilder builder, Plana.FlatData.School[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSchoolVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.School> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSchoolVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.School>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public void UnPackTo(ConquestGroupBuffExcelT _o) {
    ...
    _o.School = new List<Plana.FlatData.School>();
...
public class ConquestGroupBuffExcelT
{
  ...
  public List<Plana.FlatData.School> School { get; set; }
...
static public class ConquestGroupBuffExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*School*/, 4 /*Plana.FlatData.School*/, false)
