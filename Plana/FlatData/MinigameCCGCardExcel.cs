...
public struct MinigameCCGCardExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.CCGCardType Type { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.CCGCardType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.CCGCardType.None; } }
  ...
  public static Offset<Plana.FlatData.MinigameCCGCardExcel> CreateMinigameCCGCardExcel(FlatBufferBuilder builder,
      long Id = 0,
      Plana.FlatData.CCGCardType Type = Plana.FlatData.CCGCardType.None,
  ...
  public static void AddType(FlatBufferBuilder builder, Plana.FlatData.CCGCardType type) { builder.AddInt(1, (int)type, 0); }
  ...
  public static Offset<Plana.FlatData.MinigameCCGCardExcel> EndMinigameCCGCardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MinigameCCGCardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MinigameCCGCardExcel> Pack(FlatBufferBuilder builder, MinigameCCGCardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MinigameCCGCardExcel>);
...
public class MinigameCCGCardExcelT
{
  ...
  public Plana.FlatData.CCGCardType Type { get; set; }
  ...
  public MinigameCCGCardExcelT() {
    this.Id = 0;
    this.Type = Plana.FlatData.CCGCardType.None;
...
static public class MinigameCCGCardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*Type*/, 4 /*Plana.FlatData.CCGCardType*/, 4, false)
