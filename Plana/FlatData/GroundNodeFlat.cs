...
public struct GroundNodeFlat : IFlatbufferObject
{
  ...
  public Plana.FlatData.GroundVector3? PositionOffset { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.GroundVector3?)(new Plana.FlatData.GroundVector3()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  ...
  public static Offset<Plana.FlatData.GroundNodeFlat> CreateGroundNodeFlat(FlatBufferBuilder builder,
      ...
      Offset<Plana.FlatData.GroundVector3> PositionOffsetOffset = default(Offset<Plana.FlatData.GroundVector3>),
  ...
  public static void AddPositionOffset(FlatBufferBuilder builder, Offset<Plana.FlatData.GroundVector3> positionOffsetOffset) { builder.AddOffset(3, positionOffsetOffset.Value, 0); }
  ...
  public static Offset<Plana.FlatData.GroundNodeFlat> Pack(FlatBufferBuilder builder, GroundNodeFlatT _o) {
    ...
    var _PositionOffset = _o.PositionOffset == null ? default(Offset<Plana.FlatData.GroundVector3>) : Plana.FlatData.GroundVector3.Pack(builder, _o.PositionOffset);
...
public class GroundNodeFlatT
{
  ...
  public Plana.FlatData.GroundVector3T PositionOffset { get; set; }
...
static public class GroundNodeFlatVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyTable(tablePos, 10 /*PositionOffset*/, Plana.FlatData.GroundVector3Verify.Verify, false)
