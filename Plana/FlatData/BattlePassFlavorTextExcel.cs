...
public struct BattlePassFlavorTextExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.BattlePassFlavorTextExcel> CreateBattlePassFlavorTextExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.BattlePassFlavorTextExcel> EndBattlePassFlavorTextExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.BattlePassFlavorTextExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.BattlePassFlavorTextExcel> Pack(FlatBufferBuilder builder, BattlePassFlavorTextExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.BattlePassFlavorTextExcel>);
