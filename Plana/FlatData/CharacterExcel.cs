...
public struct CharacterExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Tag Tags(int j) { int o = __p.__offset(122); return o != 0 ? (Plana.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(122); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.Tag> GetTagsBytes() { return __p.__vector_as_span<Plana.FlatData.Tag>(122, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(122); }
#endif
  public Plana.FlatData.Tag[] GetTagsArray() { int o = __p.__offset(122); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.Tag[] a = new Plana.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
...
static public class CharacterExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 122 /*Tags*/, 4 /*Plana.FlatData.Tag*/, false)
