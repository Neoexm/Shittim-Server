...
public struct MinigameCCGOpenDialogExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MinigameCCGOpenDialogExcel> CreateMinigameCCGOpenDialogExcel(FlatBufferBuilder builder,
      long DialogId = 0,
      int PlayOrder = 0,
  ...
  public static Offset<Plana.FlatData.MinigameCCGOpenDialogExcel> EndMinigameCCGOpenDialogExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MinigameCCGOpenDialogExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MinigameCCGOpenDialogExcel> Pack(FlatBufferBuilder builder, MinigameCCGOpenDialogExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MinigameCCGOpenDialogExcel>);
