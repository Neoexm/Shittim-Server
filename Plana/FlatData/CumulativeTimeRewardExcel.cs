...
public struct CumulativeTimeRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.CumulativeTimeRewardExcel> CreateCumulativeTimeRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.CumulativeTimeRewardExcel> EndCumulativeTimeRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CumulativeTimeRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CumulativeTimeRewardExcel> Pack(FlatBufferBuilder builder, CumulativeTimeRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CumulativeTimeRewardExcel>);
