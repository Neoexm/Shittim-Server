...
public struct EventContentCharacterBonusExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EventContentItemType EventContentItemType(int j) { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.EventContentItemType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.EventContentItemType)0; }
  public int EventContentItemTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.EventContentItemType> GetEventContentItemTypeBytes() { return __p.__vector_as_span<Plana.FlatData.EventContentItemType>(8, 4); }
#else
  public ArraySegment<byte>? GetEventContentItemTypeBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public Plana.FlatData.EventContentItemType[] GetEventContentItemTypeArray() { int o = __p.__offset(8); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.EventContentItemType[] a = new Plana.FlatData.EventContentItemType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.EventContentItemType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static VectorOffset CreateEventContentItemTypeVector(FlatBufferBuilder builder, Plana.FlatData.EventContentItemType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateEventContentItemTypeVectorBlock(FlatBufferBuilder builder, Plana.FlatData.EventContentItemType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEventContentItemTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.EventContentItemType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEventContentItemTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.EventContentItemType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public void UnPackTo(EventContentCharacterBonusExcelT _o) {
    ...
    _o.EventContentItemType = new List<Plana.FlatData.EventContentItemType>();
...
public class EventContentCharacterBonusExcelT
{
  ...
  public List<Plana.FlatData.EventContentItemType> EventContentItemType { get; set; }
...
static public class EventContentCharacterBonusExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 8 /*EventContentItemType*/, 4 /*Plana.FlatData.EventContentItemType*/, false)
