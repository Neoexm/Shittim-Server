...
public struct BattlePassRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.BattlePassRewardExcel> CreateBattlePassRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.BattlePassRewardExcel> EndBattlePassRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.BattlePassRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.BattlePassRewardExcel> Pack(FlatBufferBuilder builder, BattlePassRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.BattlePassRewardExcel>);
