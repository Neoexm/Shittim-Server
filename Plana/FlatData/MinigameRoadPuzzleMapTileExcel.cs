...
public struct MinigameRoadPuzzleMapTileExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.RoadPuzzleMapTileType MapTileType { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.RoadPuzzleMapTileType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.RoadPuzzleMapTileType.None; } }

  public static Offset<Plana.FlatData.MinigameRoadPuzzleMapTileExcel> CreateMinigameRoadPuzzleMapTileExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long UniqueId = 0,
      StringOffset PrefabNameOffset = default(StringOffset),
      Plana.FlatData.RoadPuzzleMapTileType MapTileType = Plana.FlatData.RoadPuzzleMapTileType.None) {
  ...
  public static void AddMapTileType(FlatBufferBuilder builder, Plana.FlatData.RoadPuzzleMapTileType mapTileType) { builder.AddInt(3, (int)mapTileType, 0); }
  public static Offset<Plana.FlatData.MinigameRoadPuzzleMapTileExcel> EndMinigameRoadPuzzleMapTileExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MinigameRoadPuzzleMapTileExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MinigameRoadPuzzleMapTileExcel> Pack(FlatBufferBuilder builder, MinigameRoadPuzzleMapTileExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MinigameRoadPuzzleMapTileExcel>);
...
public class MinigameRoadPuzzleMapTileExcelT
{
  ...
  public Plana.FlatData.RoadPuzzleMapTileType MapTileType { get; set; }

  public MinigameRoadPuzzleMapTileExcelT() {
    this.EventContentId = 0;
    this.UniqueId = 0;
    this.PrefabName = null;
    this.MapTileType = Plana.FlatData.RoadPuzzleMapTileType.None;
  }
}
...
static public class MinigameRoadPuzzleMapTileExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*MapTileType*/, 4 /*Plana.FlatData.RoadPuzzleMapTileType*/, 4, false)
