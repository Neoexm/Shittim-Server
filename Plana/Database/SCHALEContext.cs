...
using Plana.Database.Models;
using Microsoft.EntityFrameworkCore.ChangeTracking;
using Plana.Database.GameModel;
using System.Collections.Concurrent;

namespace Plana.Database
{
    public class SCHALEContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AccountDBServer>()
            ...
            modelBuilder.Entity<AccountDBServer>()
                ...
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.Echelons)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.EchelonPresets)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.EchelonPresetGroups)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
            ...
            modelBuilder.Entity<AccountDBServer>()
                ...
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.IdCardBackgrounds)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.Costumes)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                ...
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.AccountAttachments)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.AccountLevelRewards)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            ...
            modelBuilder.Entity<AccountDBServer>()
                ...
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.AttendanceHistories)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.Academies)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.AcademyLocations)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.CampaignMainStageSaves)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.CampaignChapterClearRewardHistories)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.StrategyObjectHistories)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.ScenarioHistories)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.ScenarioGroupHistories)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
            ...
            modelBuilder.Entity<AccountDBServer>()
                ...
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.MomoTalkOutLines)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.MomoTalkChoices)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.EventContentPermanents)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.StickerBooks)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.SingleRaidLobbyInfos)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.EliminateRaidLobbyInfos)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                ...
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.RaidBattles)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.TimeAttackDungeonRooms)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.TimeAttackDungeonBattleHistories)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                ...
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.WorldRaidLocalBosses)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.WorldRaidClearHistories)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();

            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.BattleSummaries)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
            modelBuilder.Entity<AccountDBServer>()
                .HasMany(x => x.RaidSummaries)
                .WithOne(x => x.Account)
                .HasForeignKey(x => x.AccountServerId)
                .IsRequired();
    ...
    public class SCHALESqliteContext : SCHALEContext
    {
        ...
        {
            optionsBuilder.UseSqlite("Data Source=plana.sqlite3");
        }
    }
