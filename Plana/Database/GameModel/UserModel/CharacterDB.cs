...
namespace Plana.Database.GameModel
{
    public class CharacterDBServer : ParcelBase
    {
        ...
        public CharacterDBServer(long accountId)
        {
            this.AccountServerId = accountId;
        }

        public CharacterDBServer(long accountId, long uniqueId)
        {
            this.AccountServerId = accountId;
    ...
    {
        public static IQueryable<CharacterDBServer> GetAccountCharacters(this SCHALEContext context, long accountId)
        {
        ...
        public static List<CharacterDBServer> AddCharacters(this SCHALEContext context, long accountId, params CharacterDBServer[] characters)
        {
            if (characters == null || characters.Length == 0)
                return new List<CharacterDBServer>();
