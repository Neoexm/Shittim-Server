...
using Plana.MX.Campaign.HexaTileMapEvent.HexaTileMapCondition;
using Plana.MX.Campaign.HexaTileMapEvent.HexaTileMapCommand;
using Plana.MX.GameLogic.DBModel;
using Plana.MX.GameLogic.Parcel;
using System.Text.Json.Serialization;

namespace Plana.MX.Campaign.HexaTileMapEvent
{
