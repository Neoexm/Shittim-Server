namespace Plana.MX.Core.Math
{
    ...
    public struct BasisPoint : IEquatable<BasisPoint>, IComparable<BasisPoint>
    {
        ...
        {
            return new BasisPoint(System.Math.Clamp(value.RawValue, min.RawValue, max.RawValue));
        }

        public static BasisPoint FromFloat(float value)
        {
            return new BasisPoint((long)(value * Multiplier));
        }
        ...
        {
            return new BasisPoint(value * Multiplier);
        }

        public double ToDouble()
        {
            return RawValue * OneOver10_4;
        }

        public float ToFloat()
        {
            return (float)(RawValue * OneOver10_4);
        }
